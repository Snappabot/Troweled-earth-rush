...
`),r=Math.round(i*.045),a=s.length*r+24,l=i*.45-a/2,c=t*.85,h=(t-c)/2;this.roundRect(e,h,l,c,a,16),e.fill(),e.fillStyle="#fff",e.shadowColor="rgba(0,0,0,0.6)",e.shadowBlur=8,s.forEach((u,d)=>{e.fillText(u,t/2,l+22+d*r)}),e.restore()}finish(){if(this.done)return;this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.sctx&&this.scratch&&(this.revealed=Rc(this.sctx,this.scratch.width,this.scratch.height));const e=Math.round(this.revealed*100),t=Math.max(20,e),i=t/100,n=this.photo,s=g1(n.id),r=Gs().length,a=Hh();this.showResultScreen(t,n,s,r,a,i)}showResultScreen(e,t,i,n,s,r){const a=this.ctx,l=this.canvas;if(!a||!l)return;const c=l.width,h=l.height;a.clearRect(0,0,c,h),this.imgLoaded&&this.img&&this.img.naturalWidth>0?Pc(a,this.img,c,h):(a.fillStyle="#2a2a20",a.fillRect(0,0,c,h)),this.scratch&&a.drawImage(this.scratch,0,0),a.fillStyle="rgba(0,0,0,0.65)",a.fillRect(0,0,c,h);const u=e>=85?"#5EDB7D":e>=60?"#F7C948":"#F07070";a.font=`900 ${Math.round(h*.15)}px system-ui`,a.textAlign="center",a.fillStyle=u,a.shadowColor="rgba(0,0,0,0.8)",a.shadowBlur=20,a.fillText(`${e}%`,c/2,h*.35),a.font=`bold ${Math.round(h*.04)}px system-ui`,a.fillStyle="#fff",a.shadowBlur=10,a.fillText(`📸 ${t.name}`,c/2,h*.47);let d;s?d="🏆 FULL TEM COLLECTION!":i?d="✨ NEW PHOTO UNLOCKED!":d="Already in your collection",a.font=`bold ${Math.round(h*.032)}px system-ui`,a.fillStyle=s?"#FFD700":i?"#5EDB7D":"#aaa",a.shadowBlur=8,a.fillText(d,c/2,h*.56),a.font=`${Math.round(h*.026)}px system-ui`,a.fillStyle="rgba(255,255,255,0.75)",a.shadowBlur=4,a.fillText(`Collection: ${n} / ${_n.length}`,c/2,h*.64),a.shadowBlur=0;const f=s?"🏆 Full TEM Collection complete!":i?`📸 New photo unlocked: ${t.name}`:`${t.name} — already in collection`,g={score:e,qualityPct:r,message:f};setTimeout(()=>{var v;return(v=this.onComplete)==null?void 0:v.call(this,g)},2800)}unmount(){this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.rafId&&cancelAnimationFrame(this.rafId),this.canvas&&(this.canvas.removeEventListener("mousemove",this._onMouseMove),this.canvas.removeEventListener("mousedown",this._onMouseDown),this.canvas.removeEventListener("touchstart",this._onTouchStart),this.canvas.removeEventListener("touchmove",this._onTouchMove),this.canvas.removeEventListener("touchend",this._onTouchEnd),this.canvas.remove()),window.removeEventListener("mouseup",this._onMouseUp),this.canvas=null,this.ctx=null,this.scratch=null,this.sctx=null,this.container=null,this.onComplete=null,this.img=null}}const nt=5,Ao=8,jt=Ao*nt,w1=[-8,8],Ic=20,go=5.5,Lc=14,Dc=11,Bc=4,Fc=-30,on=.4,M1=2.1;class T1{constructor(){y(this,"overlay");y(this,"renderer");y(this,"scene");y(this,"camera");y(this,"rafId",0);y(this,"lastTs",0);y(this,"px",0);y(this,"py",0);y(this,"vx",0);y(this,"vy",0);y(this,"onGround",!1);y(this,"jumpsLeft",2);y(this,"climbPole",null);y(this,"swingBar",null);y(this,"swingAngle",0);y(this,"swingOmega",0);y(this,"char");y(this,"charGroup");y(this,"facingRight",!0);y(this,"platforms",[]);y(this,"poles",[]);y(this,"swingBars",[]);y(this,"globs",[]);y(this,"globSpawnTimer",3.5);y(this,"connTopX",0);y(this,"connTopDir",1);y(this,"CONN_TOP_SPD",2.8);y(this,"connTopMesh",null);y(this,"warnT",0);y(this,"warningEl",null);y(this,"throwCount",0);y(this,"bionichipActive",!1);y(this,"bionichipBurstLeft",0);y(this,"CONNIE_TAUNTS",["🪣 Watch the silicone!","⚡ Metal hip, no miss!","🦾 Bionic arm activated!","💀 Duck, Jarrad!","🪣 Plasterin' from above!","😈 Try me, hardhat!"]);y(this,"BIONIC_WARNING","⚡⚡ BIONIC BURST!!");y(this,"heartsEl");y(this,"timerEl");y(this,"lives",3);y(this,"timer",120);y(this,"gameOver",!1);y(this,"delivered",!1);y(this,"keys",{left:!1,right:!1,up:!1,down:!1});y(this,"jumpTap",!1);y(this,"onCompleteFn")}start(e){this.onCompleteFn=e,this._createOverlay(),this._createScene(),this._buildBackground(),this._buildLevel(),this._buildHUD(),this._buildControls(),this.px=0,this.py=.5,this.lastTs=performance.now(),this.rafId=requestAnimationFrame(t=>this._loop(t))}_createOverlay(){this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `,this.overlay.appendChild(s);const r=document.createElement("div");r.id="gallery-encourage",r.style.cssText=`
      ...
      padding: 0 20px 40px;
      box-sizing: border-box;
    `,this.overlay.appendChild(r),this.overlay.addEventListener("click",a=>{a.target===this.overlay&&this.hide()}),document.body.appendChild(this.overlay),this.refresh()}refresh(){if(!this.overlay)return;const e=Gs(),t=e.length,i=_n.length,n=this.overlay.querySelector("#gallery-progress-wrap");if(n){n.innerHTML="";const a=document.createElement("div");a.style.cssText=`
      ...
      `,l.appendChild(c),n.appendChild(l)}const s=this.overlay.querySelector("#gallery-grid");s&&(s.innerHTML="",_n.forEach(a=>{const l=e.includes(a.id),c=document.createElement("div");if(c.style.cssText=`
...
//# sourceMappingURL=index-CU4Gbvkv.js.map
