...
`].filter(hs).join(`
`)),o=Xo(o),o=gl(o,t),o=_l(o,t),a=Xo(a),a=gl(a,t),a=_l(a,t),o=vl(o),a=vl(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+p);const w=M+m+o,v=M+p+a,R=fl(i,i.VERTEX_SHADER,w),T=fl(i,i.FRAGMENT_SHADER,v);i.attachShader(_,R),i.attachShader(_,T),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(C){if(s.debug.checkShaderErrors){const G=i.getProgramInfoLog(_).trim(),z=i.getShaderInfoLog(R).trim(),W=i.getShaderInfoLog(T).trim();let J=!0,q=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(J=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,R,T);else{const Q=ml(i,R,"vertex"),O=ml(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,n.textContent="GAS",document.body.appendChild(n),n.addEventListener("touchstart",r=>{r.preventDefault(),this.accelerating=!0,n.style.background="rgba(50, 200, 50, 0.9)"},{passive:!1}),n.addEventListener("touchend",r=>{r.preventDefault(),this.accelerating=!1,n.style.background="rgba(50, 200, 50, 0.6)"},{passive:!1});const i=document.createElement("div");i.style.cssText=`
      ...
      touch-action: none;
      user-select: none;
    `,i.textContent="📯",document.body.appendChild(i),i.addEventListener("touchstart",r=>{r.preventDefault(),this.triggerHorn(),i.style.background="rgba(255, 200, 50, 0.95)",i.style.transform="scale(1.1)"},{passive:!1}),i.addEventListener("touchend",r=>{r.preventDefault(),i.style.background="rgba(255, 200, 50, 0.6)",i.style.transform="scale(1.0)"},{passive:!1})}get forward(){return this.keys.ArrowUp||this.keys.KeyW||this.accelerating}get backward(){return this.keys.ArrowDown||this.keys.KeyS}get left(){return this.keys.ArrowLeft||this.keys.KeyA||this.steerAxis<-.2}get right(){return this.keys.ArrowRight||this.keys.KeyD||this.steerAxis>.2}get brake(){return this.keys.Space||this.braking}get honk(){return this.horn}}class hg{constructor(){I(this,"level",0);I(this,"spillRateMultiplier",1);I(this,"onSpill");I(this,"container");I(this,"fill");I(this,"bucketEl");I(this,"isShaking",!1);I(this,"spillFlashing",!1);if(!document.getElementById("spill-meter-styles")){const i=document.createElement("style");i.id="spill-meter-styles",i.textContent=`
...
`),o=Math.round(n*.045),a=r.length*o+24,l=n*.45-a/2,c=t*.85,h=(t-c)/2;this.roundRect(e,h,l,c,a,16),e.fill(),e.fillStyle="#fff",e.shadowColor="rgba(0,0,0,0.6)",e.shadowBlur=8,r.forEach((u,d)=>{e.fillText(u,t/2,l+22+d*o)}),e.restore()}finish(){if(this.done)return;this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.sctx&&this.scratch&&(this.revealed=Gl(this.sctx,this.scratch.width,this.scratch.height));const e=Math.round(this.revealed*100),t=Math.max(20,e),n=t/100,i=this.photo,r=yg(i.id),o=bs().length,a=Mg();this.showResultScreen(t,i,r,o,a,n)}showResultScreen(e,t,n,i,r,o){const a=this.ctx,l=this.canvas;if(!a||!l)return;const c=l.width,h=l.height;a.clearRect(0,0,c,h),this.imgLoaded&&this.img&&this.img.naturalWidth>0?Hl(a,this.img,c,h):(a.fillStyle="#2a2a20",a.fillRect(0,0,c,h)),this.scratch&&a.drawImage(this.scratch,0,0),a.fillStyle="rgba(0,0,0,0.65)",a.fillRect(0,0,c,h);const u=e>=85?"#5EDB7D":e>=60?"#F7C948":"#F07070";a.font=`900 ${Math.round(h*.15)}px system-ui`,a.textAlign="center",a.fillStyle=u,a.shadowColor="rgba(0,0,0,0.8)",a.shadowBlur=20,a.fillText(`${e}%`,c/2,h*.35),a.font=`bold ${Math.round(h*.04)}px system-ui`,a.fillStyle="#fff",a.shadowBlur=10,a.fillText(`📸 ${t.name}`,c/2,h*.47);let d;r?d="🏆 FULL TEM COLLECTION!":n?d="✨ NEW PHOTO UNLOCKED!":d="Already in your collection",a.font=`bold ${Math.round(h*.032)}px system-ui`,a.fillStyle=r?"#FFD700":n?"#5EDB7D":"#aaa",a.shadowBlur=8,a.fillText(d,c/2,h*.56),a.font=`${Math.round(h*.026)}px system-ui`,a.fillStyle="rgba(255,255,255,0.75)",a.shadowBlur=4,a.fillText(`Collection: ${i} / ${ri.length}`,c/2,h*.64),a.shadowBlur=0;const f=r?"🏆 Full TEM Collection complete!":n?`📸 New photo unlocked: ${t.name}`:`${t.name} — already in collection`,g={score:e,qualityPct:o,message:f};setTimeout(()=>{var _;return(_=this.onComplete)==null?void 0:_.call(this,g)},2800)}unmount(){this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.rafId&&cancelAnimationFrame(this.rafId),this.canvas&&(this.canvas.removeEventListener("mousemove",this._onMouseMove),this.canvas.removeEventListener("mousedown",this._onMouseDown),this.canvas.removeEventListener("touchstart",this._onTouchStart),this.canvas.removeEventListener("touchmove",this._onTouchMove),this.canvas.removeEventListener("touchend",this._onTouchEnd),this.canvas.remove()),window.removeEventListener("mouseup",this._onMouseUp),this.canvas=null,this.ctx=null,this.scratch=null,this.sctx=null,this.container=null,this.onComplete=null,this.img=null}}const De=400,ft=700,Ag=800,Vl=-420,Js=140,Wl=100,Cg=600,Rg=.5,Gt=44,$s=22,Pg=.6,Ig=180,Dg=-200,Xl=60,Lg=80,Fg=.8,Ug=100,Bg=1.15,rs=3,Ng=100,os=200,Ei=80,hn=270,Og=[{id:"lv1",baseX:80,y:540,width:100,height:8,level:1,type:"normal"},{id:"lv2",baseX:140,y:450,width:120,height:8,level:2,type:"normal"},{id:"lv3a",baseX:80,y:360,width:100,height:8,level:3,type:"normal"},{id:"lv3b",baseX:220,y:360,width:100,height:8,level:3,type:"normal"},{id:"lv4",baseX:125,y:270,width:140,height:8,level:4,type:"moving"},{id:"lv5a",baseX:80,y:185,width:100,height:8,level:5,type:"crumbling"},{id:"lv5b",baseX:220,y:185,width:100,height:8,level:5,type:"normal"},{id:"lv6",baseX:80,y:100,width:240,height:8,level:6,type:"win"}],On={x:190,y:420,w:40,h:30};class kg{constructor(){I(this,"canvas",null);I(this,"ctx",null);I(this,"animFrame",null);I(this,"onComplete",null);I(this,"phase","playing");I(this,"platforms",[]);I(this,"jarrad");I(this,"pigeon");I(this,"gameTime",0);I(this,"tsuyoshiSpeech","I GOT IT!");I(this,"tsuyoshiTimer",0);I(this,"resultTimer",0);I(this,"retried",!1);I(this,"movingPlatTime",0);I(this,"movingPlatX",125);I(this,"crumble5ATimer",0);I(this,"crumble5AState","solid");I(this,"crumble5ARespawn",0);I(this,"ropeAngle",0);I(this,"ropeAngVel",0);I(this,"ropeGrabbed",!1);I(this,"windCycleTimer",0);I(this,"windActive",!1);I(this,"windAlpha",0);I(this,"showGapHint",!0);I(this,"gapHintTimer",8);I(this,"shakeNoise",0);I(this,"comboPhase",0);I(this,"comboTimer",0);I(this,"comboFlashTimer",0);I(this,"vaultFlashTimer",0);I(this,"rewindFlashTimer",0);I(this,"splatParticles",[]);I(this,"frameCount",0);I(this,"prevJarradY",0);I(this,"wallDustParticles",[]);I(this,"hasShimmied",!1);I(this,"keys",{});I(this,"prevKeys",{});I(this,"keyHandler");I(this,"keyUpHandler");I(this,"mobileLeft",!1);I(this,"mobileRight",!1);I(this,"mobileJump",!1);I(this,"mobileDrop",!1);I(this,"mobileRewind",!1);I(this,"mobileRewindFired",!1);I(this,"mobileContainer",null);I(this,"lastTimestamp",0)}mount(e,t){this.onComplete=t,this.platforms=Og.map(i=>({...i})),this.canvas=document.createElement("canvas"),this.canvas.width=De,this.canvas.height=ft,this.canvas.style.cssText=`
    ...
    `,t.addEventListener("click",()=>{this.stop(),e({score:75,qualityPct:.75,message:"Job done!"})}),this.overlay.appendChild(t),this.safetyTimer=setTimeout(()=>{this.active&&(this.stop(),e({score:50,qualityPct:.5,message:"Time up on the scaffold!"}))},9e4),setTimeout(()=>{if(this.active)try{this.scaffoldGame=new kg,this.scaffoldGame.mount(this.overlay,n=>{this.safetyTimer&&clearTimeout(this.safetyTimer),this.stop(),e(n)})}catch(n){console.error("ScaffoldGame init failed:",n);const i=document.createElement("div");i.style.cssText=`
        ...
        `,i.innerHTML=`
          ...
          <div style="font-size:16px; opacity:0.7;">Tap DONE to collect your pay</div>
        `,this.overlay.appendChild(i)}},120)}startRandom(e){Math.random()<.5?this.startTroweling(e):this.startScaffold(e)}stop(){this.safetyTimer&&(clearTimeout(this.safetyTimer),this.safetyTimer=null),this.trowelingGame&&(this.trowelingGame.unmount(),this.trowelingGame=null),this.scaffoldGame&&(this.scaffoldGame.unmount(),this.scaffoldGame=null),this.overlay.style.display="none",this.overlay.innerHTML="",this.active=!1}}class Gg{constructor(){I(this,"overlay",null)}show(){if(this.overlay){this.refresh(),this.overlay.style.display="flex";return}this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `,this.overlay.appendChild(o),this.overlay.addEventListener("click",a=>{a.target===this.overlay&&this.hide()}),document.body.appendChild(this.overlay),this.refresh()}refresh(){if(!this.overlay)return;const e=bs(),t=e.length,n=ri.length,i=this.overlay.querySelector("#gallery-progress-wrap");if(i){i.innerHTML="";const a=document.createElement("div");a.style.cssText=`
      ...
      `,l.appendChild(c),i.appendChild(l)}const r=this.overlay.querySelector("#gallery-grid");r&&(r.innerHTML="",ri.forEach(a=>{const l=e.includes(a.id),c=document.createElement("div");if(c.style.cssText=`
        ...
        `,l){const h=document.createElement("img");h.src=a.file,h.alt=a.name,h.style.cssText=`
          ...
          `,c.appendChild(h)}r.appendChild(c)}));const o=this.overlay.querySelector("#gallery-encourage");o&&(t>=n?o.textContent="🏆 You've scraped them all. Matt's proud. Sort of.":t>=6?o.textContent="🔥 Almost there — keep scraping!":t>=3?o.textContent="💪 Nice collection forming. More plastering to do!":t===0?o.textContent="🪣 No photos yet — complete jobs to reveal TEM work!":o.textContent="✨ Keep scraping to unlock all 8 TEM photos!")}hide(){this.overlay&&(this.overlay.style.display="none")}}const ql=[15087942,2201331,16757504,5025616,10233776,16739125];function Hg(s){const e=new Ne,t=new K({color:s}),n=new N(new te(3.5,1.2,6.5),t);n.position.set(0,.6,0),n.castShadow=!0,e.add(n);const i=new K({color:s}),r=new N(new te(2.5,.9,3.5),i);r.position.set(0,1.65,0),r.castShadow=!0,e.add(r);const o=new K({color:1118481}),a=[[-1.8,.4,2.2],[1.8,.4,2.2],[-1.8,.4,-2.2],[1.8,.4,-2.2]];for(const[u,d,f]of a){const g=new N(new Ke(.5,.5,.4,8),o);g.rotation.z=Math.PI/2,g.position.set(u,d,f),g.castShadow=!0,e.add(g)}const l=new K({color:3359829}),c=new N(new te(2.3,.7,.1),l);c.position.set(0,1.4,-3.3),e.add(c);const h=new N(new te(2.3,.7,.1),l);return h.position.set(0,1.4,3.3),e.add(h),e}function Vg(s,e){return s==="x"?e===1?-Math.PI/2:Math.PI/2:e===1?Math.PI:0}class Wg{constructor(e){I(this,"cars",[]);I(this,"scene");this.scene=e,this._spawn()}_spawn(){const e=[-200,-160,-120,-80,-40,0,40,80,120,160,200],t=n=>{const i=ql[Math.floor(Math.random()*ql.length)],r=Hg(i),o=e[Math.floor(Math.random()*e.length)],a=Math.random()>.5?2:-2,l=10+Math.random()*10,c=Math.random()>.5?1:-1,h=-200+Math.random()*400;r.rotation.y=Vg(n,c);const u={group:r,axis:n,roadPos:o,laneOffset:a,speed:l,dir:c,pos:h};this.cars.push(u),this.scene.add(r),this._applyPosition(u)};for(let n=0;n<14;n++)t("z");for(let n=0;n<14;n++)t("x")}_applyPosition(e){e.axis==="x"?e.group.position.set(e.pos,0,e.roadPos+e.laneOffset):e.group.position.set(e.roadPos+e.laneOffset,0,e.pos)}update(e,t,n){for(const i of this.cars)i.pos+=i.dir*i.speed*e,i.pos>235&&(i.pos=-235),i.pos<-235&&(i.pos=235),this._applyPosition(i)}resolveVan(e,t,n=1.8){let i=e,r=t,o=!1;for(const a of this.cars){const l=a.group.position.x,c=a.group.position.z,h=(a.axis==="x"?3.25:1.75)+n,u=(a.axis==="x"?1.75:3.25)+n,d=i-l,f=r-c;if(Math.abs(d)<h&&Math.abs(f)<u){const g=h-Math.abs(d),_=u-Math.abs(f);g<_?i+=d<0?-g:g:r+=f<0?-_:_,o=!0}}return{x:i,z:r,hit:o}}checkVanCollision(e,t){const n=this.resolveVan(e,t);return{hit:n.hit,pushX:n.x-e,pushZ:n.z-t}}}const Yl=[16032353,15167313,2792847,2508371,15320170,11066076,16739179,7029286],Xg=16767916,qg=40,jl=8;function Yg(s){const e=new Ne,t=new K({color:s}),n=new K({color:Xg}),i=new K({color:s}),r=new N(new Ke(.3,.35,1.1,7),t);r.position.set(0,.55,0),e.add(r);const o=new N(new wt(.28,6,5),n);o.position.set(0,1.28,0),e.add(o);const a=new N(new te(.15,.65,.15),t);a.position.set(-.45,.75,0),a.rotation.z=.15,e.add(a);const l=new N(new te(.15,.65,.15),t);l.position.set(.45,.75,0),l.rotation.z=-.15,e.add(l);const c=new N(new te(.18,.55,.18),i);c.position.set(-.18,0,.05),e.add(c);const h=new N(new te(.18,.55,.18),i);return h.position.set(.18,0,-.05),e.add(h),{group:e,leftArm:a,rightArm:l,leftLeg:c,rightLeg:h}}class jg{constructor(e){I(this,"pedestrians",[]);I(this,"scene");this.scene=e,this._spawn()}_spawn(){const e=[];for(let n=-200;n<=200;n+=40)e.push(n);const t=n=>{const i=Yl[Math.floor(Math.random()*Yl.length)],{group:r,leftArm:o,rightArm:a,leftLeg:l,rightLeg:c}=Yg(i),h=e[Math.floor(Math.random()*e.length)],u=Math.random()>.5?5:-5,d=h+u,f=[];for(let R=-240;R<240;R+=40)f.push(R);const g=f[Math.floor(Math.random()*f.length)],_=g+jl/2,m=g+qg-jl/2,p=_+Math.random()*(m-_),M=Math.random()>.5?1:-1,w=2+Math.random()*1.5,v={group:r,axis:n,roadPos:d,segStart:_,segEnd:m,pos:p,dir:M,speed:w,scattering:!1,scatterTimer:0,scatterDirX:0,scatterDirZ:0,walkCycle:Math.random()*Math.PI*2,leftArm:o,rightArm:a,leftLeg:l,rightLeg:c};this.pedestrians.push(v),this.scene.add(r),this._applyPosition(v),this._applyFacing(v)};for(let n=0;n<20;n++)t("x");for(let n=0;n<20;n++)t("z")}_applyPosition(e){e.axis==="x"?e.group.position.set(e.pos,0,e.roadPos):e.group.position.set(e.roadPos,0,e.pos)}_applyFacing(e){if(e.scattering){e.group.rotation.y=Math.atan2(e.scatterDirX,e.scatterDirZ);return}e.axis==="x"?e.group.rotation.y=e.dir===1?-Math.PI/2:Math.PI/2:e.group.rotation.y=e.dir===1?Math.PI:0}update(e,t,n){for(const i of this.pedestrians){const r=i.group.position.x,o=i.group.position.z,a=r-t,l=o-n,c=Math.sqrt(a*a+l*l);if(!i.scattering&&c<7){i.scattering=!0,i.scatterTimer=2.5;const d=Math.max(c,.01);i.scatterDirX=a/d,i.scatterDirZ=l/d}i.scattering?(i.group.position.x+=i.scatterDirX*12*e,i.group.position.z+=i.scatterDirZ*12*e,i.scatterTimer-=e,i.scatterTimer<=0&&(i.scattering=!1,i.axis==="x"?i.pos=Math.max(i.segStart,Math.min(i.segEnd,i.group.position.x)):i.pos=Math.max(i.segStart,Math.min(i.segEnd,i.group.position.z)),this._applyPosition(i))):(i.pos+=i.dir*i.speed*e,i.pos>=i.segEnd?(i.pos=i.segEnd,i.dir=-1):i.pos<=i.segStart&&(i.pos=i.segStart,i.dir=1),this._applyPosition(i)),this._applyFacing(i);const h=i.scattering?12:i.speed;i.walkCycle+=h*e*2;const u=Math.sin(i.walkCycle);i.leftArm.rotation.z=u*.4+.15,i.rightArm.rotation.z=-u*.4-.15,i.leftLeg.rotation.x=u*.5,i.rightLeg.rotation.x=-u*.5}}}const bn=class bn{constructor(e){I(this,"indicator");I(this,"scene");I(this,"lastVisit",-30);this.scene=e,this.indicator=new N(new wt(1.5,10,8),new K({color:13918762,emissive:new ye(10498064),emissiveIntensity:.8})),this.indicator.position.set(bn.POS.x,10,bn.POS.z),this.scene.add(this.indicator)}update(e){this.indicator.position.y=10+Math.sin(Date.now()*.002)*.5,this.indicator.rotation.y+=e*1.5}isNearby(e,t){const n=e-bn.POS.x,i=t-bn.POS.z;return Math.sqrt(n*n+i*i)<bn.TRIGGER_RADIUS}tryVisit(e,t){if(!this.isNearby(e,t))return!1;const n=Date.now()/1e3;return n-this.lastVisit<20?!1:(this.lastVisit=n,!0)}};I(bn,"POS",{x:-60,z:-100}),I(bn,"TRIGGER_RADIUS",12);let Jo=bn;class Jg{constructor(){I(this,"level",0);I(this,"isUrgent",!1);I(this,"lastUrgentToast",0);I(this,"caffeinated",!1);I(this,"caffeineTimer",0)}update(e,t){this.caffeinated&&(this.caffeineTimer-=e,this.caffeineTimer<=0&&(this.caffeinated=!1));const n=this.caffeinated?.018:.012;Math.abs(t)>2?this.level=Math.min(1,this.level+e*n):this.level=Math.max(0,this.level-e*.005),this.isUrgent=this.level>.8}drinkCoffee(){this.level=Math.min(1,this.level+.4),this.caffeinated=!0,this.caffeineTimer=30,this.isUrgent=this.level>.8}tryRelief(e,t){const n=e-100,i=t-60;return Math.sqrt(n*n+i*i)>14||this.level===0?!1:(this.level=0,this.isUrgent=!1,this.caffeinated=!1,this.caffeineTimer=0,!0)}get spillMultiplier(){return this.isUrgent?1.8:1}}const as={x:30,z:28},Jl=["Got a dollar, mate? 💸","You got a light? 🚬","Nice van. Does it leak?","My brother Jarrad says I'm not qualified. He's right but I don't like it.","These boots were not made for plastering. Yet here we are.","Jump in? No seriously, I need a lift.","Jarrad says he's read the TDS. He hasn't. I've lived with him.","You look like you need a coffee and a toilet. In that order.","Phil owes me fifty bucks. Pass it on.","I plastered that wall. Don't tell Jarrad.","Matt left the primer lid off again. Just letting you know."],fs=class fs{constructor(e){I(this,"wrapper");I(this,"character");I(this,"ropeRing");I(this,"ropePivot");I(this,"lastDialogue",0);I(this,"cooldown",9e3);this.character=new vr(zi.Mikayla),this.character.group.scale.set(2,2,2);const t=this.character.buildJumpRopeClip();this.character.mixer.stopAllAction(),this.character.mixer.clipAction(t).play(),this.ropePivot=new Ne,this.ropePivot.position.set(0,1.3,0),this.ropePivot.rotation.y=Math.PI/2,this.character.group.add(this.ropePivot),this.ropeRing=new N(new fa(1.35,.05,7,28),new K({color:8079902})),this.ropePivot.add(this.ropeRing);const n=this._makeNameBoard();n.position.set(0,8.8,0);const i=new N(new li(1.2,1.7,32),new jt({color:14501e3,side:Ht}));i.rotation.x=-Math.PI/2,i.position.y=.05,this.wrapper=new Ne,this.wrapper.add(this.character.group),this.wrapper.add(n),this.wrapper.add(i),this.wrapper.position.set(as.x,0,as.z),e.add(this.wrapper)}_makeNameBoard(){const e=document.createElement("canvas");e.width=256,e.height=64;const t=e.getContext("2d");t.fillStyle="rgba(190, 40, 90, 0.88)",t.roundRect?t.roundRect(2,2,252,60,8):t.rect(2,2,252,60),t.fill(),t.fillStyle="#fff",t.font="bold 30px Arial",t.textAlign="center",t.textBaseline="middle",t.fillText("MIKAYLA",128,32);const n=new ys(e);return new N(new pt(2.4,.6),new jt({map:n,transparent:!0,depthWrite:!1}))}update(e,t,n,i){this.character.update(e),this.ropeRing.rotation.z+=e*(2*Math.PI/Wc);const r=t-as.x,o=n-as.z;this.character.group.rotation.y=Math.atan2(r,o);const a=Math.sqrt(r*r+o*o),l=Date.now();if(a<fs.TRIGGER_RADIUS&&l-this.lastDialogue>this.cooldown){const c=Jl[Math.floor(Math.random()*Jl.length)];return i.show(zi.Mikayla,c),this.lastDialogue=l,!0}return!1}dispose(e){e.remove(this.wrapper)}};I(fs,"POS",as),I(fs,"TRIGGER_RADIUS",15);let ei=fs;const ls={x:-4,z:-6},$l=["Ha ha ha HA HA! You picked up ze buckets! Love it!","I mix ze plaster by hand. Za gloves are for ze weak.","In Germany, zis would be a warm-up. But I like Australia. Ze mud here is good.","I have mud wrestled ze entire Brunswick football club. Zey lost. Badly.","Ze mixing ratio is one part water, two parts product, one part pure power.","Last Saturday I wrestled a man twice my size. Sunday I mixed 50 buckets. Your turn.","Don't let ze hair fool you. I once arm wrestled Phil. He is still talking about it.","Ha HA! You are funny. Not as funny as ze last guy. But funny."],ps=class ps{constructor(e){I(this,"wrapper");I(this,"character");I(this,"lastDialogue",0);I(this,"cooldown",1e4);I(this,"audioCtx",null);this.character=new vr(zi.Connie),this.character.group.scale.set(2,2.35,2);const t=new K({color:15789544}),n=new N(new wt(.16,8,6),t);n.position.set(-.12,1.55,-.19);const i=new N(new wt(.16,8,6),t);i.position.set(.12,1.55,-.19),this.character.group.add(n),this.character.group.add(i);const r=this._makeNameBoard();r.position.set(0,8.8,0);const o=new N(new li(1.2,1.7,32),new jt({color:16109664,side:Ht}));o.rotation.x=-Math.PI/2,o.position.y=.05,this.wrapper=new Ne,this.wrapper.add(this.character.group),this.wrapper.add(r),this.wrapper.add(o),this.wrapper.position.set(ls.x,0,ls.z),e.add(this.wrapper)}_makeNameBoard(){const e=document.createElement("canvas");e.width=256,e.height=64;const t=e.getContext("2d");return t.fillStyle="rgba(200, 150, 20, 0.88)",t.roundRect?t.roundRect(2,2,252,60,8):t.rect(2,2,252,60),t.fill(),t.fillStyle="#fff",t.font="bold 30px Arial",t.textAlign="center",t.textBaseline="middle",t.fillText("CONNIE",128,32),new N(new pt(2.4,.6),new jt({map:new ys(e),transparent:!0,depthWrite:!1}))}playLaugh(){try{this.audioCtx||(this.audioCtx=new(window.AudioContext||window.webkitAudioContext));const e=this.audioCtx,t=7;for(let n=0;n<t;n++){const i=e.currentTime+n*.16,r=e.createOscillator(),o=e.createGain(),a=480+n*18+Math.random()*60;r.frequency.setValueAtTime(a,i),r.frequency.exponentialRampToValueAtTime(a*.48,i+.13),o.gain.setValueAtTime(0,i),o.gain.linearRampToValueAtTime(.35,i+.03),o.gain.exponentialRampToValueAtTime(.001,i+.15),r.connect(o),o.connect(e.destination),r.start(i),r.stop(i+.17)}}catch{}}update(e,t,n,i){this.character.update(e);const r=t-ls.x,o=n-ls.z;this.character.group.rotation.y=Math.atan2(r,o);const a=Math.sqrt(r*r+o*o),l=Date.now();if(a<ps.TRIGGER_RADIUS&&l-this.lastDialogue>this.cooldown){const c=$l[Math.floor(Math.random()*$l.length)];return i.show(zi.Connie,c),this.lastDialogue=l,!0}return!1}dispose(e){var t;e.remove(this.wrapper),(t=this.audioCtx)==null||t.close()}};I(ps,"POS",ls),I(ps,"TRIGGER_RADIUS",16);let us=ps;class $g{constructor(){I(this,"renderer");I(this,"scene");I(this,"camera");I(this,"canvas");I(this,"cache",new Map);this.canvas=document.createElement("canvas"),this.canvas.width=160,this.canvas.height=160,this.renderer=new Fc({canvas:this.canvas,antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),this.renderer.setSize(160,160),this.renderer.setClearColor(0,0),this.scene=new Uc;const e=new Gc(16777215,.7);this.scene.add(e);const t=new hr(16774624,1);t.position.set(2,4,5),this.scene.add(t);const n=new hr(14741759,.4);n.position.set(-3,2,3),this.scene.add(n),this.camera=new Nt(38,1,.1,100),this.camera.position.set(1.2,5,5.5),this.camera.lookAt(.1,3.8,0)}renderPortrait(e){if(this.cache.has(e.name))return this.cache.get(e.name);this.scene.children.filter(r=>!(r instanceof Ms)).forEach(r=>this.scene.remove(r));const n=new vr(e);n.group.scale.set(2,2,2),n.group.rotation.y=-Math.PI*.18,this.scene.add(n.group),this.renderer.render(this.scene,this.camera);const i=this.canvas.toDataURL("image/png");return this.cache.set(e.name,i),this.scene.remove(n.group),i}dispose(){this.renderer.dispose()}}class Kg{constructor(){I(this,"container");I(this,"portrait");I(this,"nameEl");I(this,"textEl");I(this,"portraitRenderer");I(this,"hideTimeout",null);I(this,"visible",!1);this.portraitRenderer=new $g,this._injectStyles(),this._buildDOM()}_injectStyles(){if(document.getElementById("speech-bubble-styles"))return;const e=document.createElement("style");e.id="speech-bubble-styles",e.textContent=`
      #tem-speech-bubble {
        position: fixed;
        left: 0;
        top: 0;
...
//# sourceMappingURL=index-C6uwWRt2.js.map
