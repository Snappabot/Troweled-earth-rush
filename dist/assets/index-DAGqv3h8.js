...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function rl(){return new Rt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ca(),fragmentShader:`
		...
		`,blending:En,depthTest:!1,depthWrite:!1})}function ol(){return new Rt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ca(),fragmentShader:`
	...
	`}function tp(s){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===po||l===mo,h=l===Fi||l===Bi;if(c||h){let d=e.get(a);const u=d!==void 0?d.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==u)return t===null&&(t=new il(s)),d=c?t.fromEquirectangular(a,d):t.fromCubemap(a,d),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),d.texture;if(d!==void 0)return d.texture;{const f=a.image;return c&&f&&f.height>0||h&&f&&i(f)?(t===null&&(t=new il(s)),d=c?t.fromEquirectangular(a):t.fromCubemap(a),d.texture.pmremVersion=a.pmremVersion,e.set(a,d),a.addEventListener("dispose",r),d.texture):null}}}return a}function i(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function np(s){const e={};function t(n){if(e[n]!==void 0)return e[n];let i;switch(n){case"WEBGL_depth_texture":i=s.getExtension("WEBGL_depth_texture")||s.getExtension("MOZ_WEBGL_depth_texture")||s.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=s.getExtension("EXT_texture_filter_anisotropic")||s.getExtension("MOZ_EXT_texture_filter_anisotropic")||s.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=s.getExtension("WEBGL_compressed_texture_s3tc")||s.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=s.getExtension("WEBGL_compressed_texture_pvrtc")||s.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=s.getExtension(n)}return e[n]=i,i}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const i=t(n);return i===null&&ds("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function ip(s,e,t,n){const i={},r=new WeakMap;function o(d){const u=d.target;u.index!==null&&e.remove(u.index);for(const g in u.attributes)e.remove(u.attributes[g]);for(const g in u.morphAttributes){const _=u.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)e.remove(_[m])}u.removeEventListener("dispose",o),delete i[u.id];const f=r.get(u);f&&(e.remove(f),r.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function a(d,u){return i[u.id]===!0||(u.addEventListener("dispose",o),i[u.id]=!0,t.memory.geometries++),u}function l(d){const u=d.attributes;for(const g in u)e.update(u[g],s.ARRAY_BUFFER);const f=d.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)e.update(_[m],s.ARRAY_BUFFER)}}function c(d){const u=[],f=d.index,g=d.attributes.position;let _=0;if(f!==null){const b=f.array;_=f.version;for(let S=0,v=b.length;S<v;S+=3){const P=b[S+0],T=b[S+1],A=b[S+2];u.push(P,T,T,A,A,P)}}else if(g!==void 0){const b=g.array;_=g.version;for(let S=0,v=b.length/3-1;S<v;S+=3){const P=S+0,T=S+1,A=S+2;u.push(P,T,T,A,A,P)}}else return;const m=new(vc(u)?Ec:Sc)(u,1);m.version=_;const p=r.get(d);p&&e.remove(p),r.set(d,m)}function h(d){const u=r.get(d);if(u){const f=d.index;f!==null&&u.version<f.version&&c(d)}else c(d);return r.get(d)}return{get:a,update:l,getWireframeAttribute:h}}function sp(s,e,t){let n;function i(u){n=u}let r,o;function a(u){r=u.type,o=u.bytesPerElement}function l(u,f){s.drawElements(n,f,r,u*o),t.update(f,n,1)}function c(u,f,g){g!==0&&(s.drawElementsInstanced(n,f,r,u*o,g),t.update(f,n,g))}function h(u,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,u,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function d(u,f,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<u.length;p++)c(u[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,u,0,_,0,g);let p=0;for(let b=0;b<g;b++)p+=f[b]*_[b];t.update(p,n,1)}}this.setMode=i,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=d}function rp(s){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case s.TRIANGLES:t.triangles+=a*(r/3);break;case s.LINES:t.lines+=a*(r/2);break;case s.LINE_STRIP:t.lines+=a*(r-1);break;case s.LINE_LOOP:t.lines+=a*r;break;case s.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function i(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:i,update:n}}function op(s,e,t){const n=new WeakMap,i=new it;function r(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,d=h!==void 0?h.length:0;let u=n.get(a);if(u===void 0||u.count!==d){let x=function(){I.dispose(),n.delete(a),a.removeEventListener("dispose",x)};var f=x;u!==void 0&&u.texture.dispose();const g=a.morphAttributes.position!==void 0,_=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],b=a.morphAttributes.normal||[],S=a.morphAttributes.color||[];let v=0;g===!0&&(v=1),_===!0&&(v=2),m===!0&&(v=3);let P=a.attributes.position.count*v,T=1;P>e.maxTextureSize&&(T=Math.ceil(P/e.maxTextureSize),P=e.maxTextureSize);const A=new Float32Array(P*T*4*d),I=new yc(A,P,T,d);I.type=wn,I.needsUpdate=!0;const M=v*4;for(let R=0;R<d;R++){const z=p[R],k=b[R],W=S[R],$=P*T*4*R;for(let q=0;q<z.count;q++){const ee=q*M;g===!0&&(i.fromBufferAttribute(z,q),A[$+ee+0]=i.x,A[$+ee+1]=i.y,A[$+ee+2]=i.z,A[$+ee+3]=0),_===!0&&(i.fromBufferAttribute(k,q),A[$+ee+4]=i.x,A[$+ee+5]=i.y,A[$+ee+6]=i.z,A[$+ee+7]=0),m===!0&&(i.fromBufferAttribute(W,q),A[$+ee+8]=i.x,A[$+ee+9]=i.y,A[$+ee+10]=i.z,A[$+ee+11]=W.itemSize===4?i.w:1)}}u={count:d,texture:I,size:new Ie(P,T)},n.set(a,u),a.addEventListener("dispose",x)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(s,"morphTexture",o.morphTexture,t);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const _=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(s,"morphTargetBaseInfluence",_),l.getUniforms().setValue(s,"morphTargetInfluences",c)}l.getUniforms().setValue(s,"morphTargetsTexture",u.texture,t),l.getUniforms().setValue(s,"morphTargetsTextureSize",u.size)}return{update:r}}function ap(s,e,t,n){let i=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,d=e.get(l,h);if(i.get(d)!==c&&(e.update(d),i.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),i.get(l)!==c&&(t.update(l.instanceMatrix,s.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,s.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const u=l.skeleton;i.get(u)!==c&&(u.update(),i.set(u,c))}return d}function o(){i=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}class Pc extends It{constructor(e,t,n,i,r,o,a,l,c,h=Ii){if(h!==Ii&&h!==Ni)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Ii&&(n=oi),n===void 0&&h===Ni&&(n=Ui),super(null,i,r,o,a,l,h,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:rn,this.minFilter=l!==void 0?l:rn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Ic=new It,al=new Pc(1,1),Dc=new yc,Lc=new Yh,Fc=new Cc,ll=[],cl=[],hl=new Float32Array(16),dl=new Float32Array(9),ul=new Float32Array(4);function Wi(s,e,t){const n=s[0];if(n<=0||n>0)return s;const i=e*t;let r=ll[i];if(r===void 0&&(r=new Float32Array(i),ll[i]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,s[o].toArray(r,a)}return r}function xt(s,e){if(s.length!==e.length)return!1;for(let t=0,n=s.length;t<n;t++)if(s[t]!==e[t])return!1;return!0}function yt(s,e){for(let t=0,n=e.length;t<n;t++)s[t]=e[t]}function _r(s,e){let t=cl[e];t===void 0&&(t=new Int32Array(e),cl[e]=t);for(let n=0;n!==e;++n)t[n]=s.allocateTextureUnit();return t}function lp(s,e){const t=this.cache;t[0]!==e&&(s.uniform1f(this.addr,e),t[0]=e)}function cp(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;s.uniform2fv(this.addr,e),yt(t,e)}}function hp(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(s.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(xt(t,e))return;s.uniform3fv(this.addr,e),yt(t,e)}}function dp(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;s.uniform4fv(this.addr,e),yt(t,e)}}function up(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;s.uniformMatrix2fv(this.addr,!1,e),yt(t,e)}else{if(xt(t,n))return;ul.set(n),s.uniformMatrix2fv(this.addr,!1,ul),yt(t,n)}}function fp(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;s.uniformMatrix3fv(this.addr,!1,e),yt(t,e)}else{if(xt(t,n))return;dl.set(n),s.uniformMatrix3fv(this.addr,!1,dl),yt(t,n)}}function pp(s,e){const t=this.cache,n=e.elements;if(n===void 0){if(xt(t,e))return;s.uniformMatrix4fv(this.addr,!1,e),yt(t,e)}else{if(xt(t,n))return;hl.set(n),s.uniformMatrix4fv(this.addr,!1,hl),yt(t,n)}}function mp(s,e){const t=this.cache;t[0]!==e&&(s.uniform1i(this.addr,e),t[0]=e)}function gp(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;s.uniform2iv(this.addr,e),yt(t,e)}}function _p(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;s.uniform3iv(this.addr,e),yt(t,e)}}function vp(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;s.uniform4iv(this.addr,e),yt(t,e)}}function xp(s,e){const t=this.cache;t[0]!==e&&(s.uniform1ui(this.addr,e),t[0]=e)}function yp(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(s.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(xt(t,e))return;s.uniform2uiv(this.addr,e),yt(t,e)}}function Mp(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(s.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(xt(t,e))return;s.uniform3uiv(this.addr,e),yt(t,e)}}function bp(s,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(s.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(xt(t,e))return;s.uniform4uiv(this.addr,e),yt(t,e)}}function wp(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i);let r;this.type===s.SAMPLER_2D_SHADOW?(al.compareFunction=_c,r=al):r=Ic,t.setTexture2D(e||r,i)}function Sp(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture3D(e||Lc,i)}function Ep(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTextureCube(e||Fc,i)}function Tp(s,e,t){const n=this.cache,i=t.allocateTextureUnit();n[0]!==i&&(s.uniform1i(this.addr,i),n[0]=i),t.setTexture2DArray(e||Dc,i)}function Ap(s){switch(s){case 5126:return lp;case 35664:return cp;case 35665:return hp;case 35666:return dp;case 35674:return up;case 35675:return fp;case 35676:return pp;case 5124:case 35670:return mp;case 35667:case 35671:return gp;case 35668:case 35672:return _p;case 35669:case 35673:return vp;case 5125:return xp;case 36294:return yp;case 36295:return Mp;case 36296:return bp;case 35678:case 36198:case 36298:case 36306:case 35682:return wp;case 35679:case 36299:case 36307:return Sp;case 35680:case 36300:case 36308:case 36293:return Ep;case 36289:case 36303:case 36311:case 36292:return Tp}}function Cp(s,e){s.uniform1fv(this.addr,e)}function Rp(s,e){const t=Wi(e,this.size,2);s.uniform2fv(this.addr,t)}function Pp(s,e){const t=Wi(e,this.size,3);s.uniform3fv(this.addr,t)}function Ip(s,e){const t=Wi(e,this.size,4);s.uniform4fv(this.addr,t)}function Dp(s,e){const t=Wi(e,this.size,4);s.uniformMatrix2fv(this.addr,!1,t)}function Lp(s,e){const t=Wi(e,this.size,9);s.uniformMatrix3fv(this.addr,!1,t)}function Fp(s,e){const t=Wi(e,this.size,16);s.uniformMatrix4fv(this.addr,!1,t)}function Bp(s,e){s.uniform1iv(this.addr,e)}function Up(s,e){s.uniform2iv(this.addr,e)}function Np(s,e){s.uniform3iv(this.addr,e)}function Op(s,e){s.uniform4iv(this.addr,e)}function kp(s,e){s.uniform1uiv(this.addr,e)}function zp(s,e){s.uniform2uiv(this.addr,e)}function Gp(s,e){s.uniform3uiv(this.addr,e)}function Hp(s,e){s.uniform4uiv(this.addr,e)}function Vp(s,e,t){const n=this.cache,i=e.length,r=_r(t,i);xt(n,r)||(s.uniform1iv(this.addr,r),yt(n,r));for(let o=0;o!==i;++o)t.setTexture2D(e[o]||Ic,r[o])}function Wp(s,e,t){const n=this.cache,i=e.length,r=_r(t,i);xt(n,r)||(s.uniform1iv(this.addr,r),yt(n,r));for(let o=0;o!==i;++o)t.setTexture3D(e[o]||Lc,r[o])}function Xp(s,e,t){const n=this.cache,i=e.length,r=_r(t,i);xt(n,r)||(s.uniform1iv(this.addr,r),yt(n,r));for(let o=0;o!==i;++o)t.setTextureCube(e[o]||Fc,r[o])}function qp(s,e,t){const n=this.cache,i=e.length,r=_r(t,i);xt(n,r)||(s.uniform1iv(this.addr,r),yt(n,r));for(let o=0;o!==i;++o)t.setTexture2DArray(e[o]||Dc,r[o])}function Yp(s){switch(s){case 5126:return Cp;case 35664:return Rp;case 35665:return Pp;case 35666:return Ip;case 35674:return Dp;case 35675:return Lp;case 35676:return Fp;case 5124:case 35670:return Bp;case 35667:case 35671:return Up;case 35668:case 35672:return Np;case 35669:case 35673:return Op;case 5125:return kp;case 36294:return zp;case 36295:return Gp;case 36296:return Hp;case 35678:case 36198:case 36298:case 36306:case 35682:return Vp;case 35679:case 36299:case 36307:return Wp;case 35680:case 36300:case 36308:case 36293:return Xp;case 36289:case 36303:case 36311:case 36292:return qp}}class jp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Ap(t.type)}}class Jp{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Yp(t.type)}}class $p{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const i=this.seq;for(let r=0,o=i.length;r!==o;++r){const a=i[r];a.setValue(e,t[a.id],n)}}}const $r=/(\w+)(\])?(\[|\.)?/g;function fl(s,e){s.seq.push(e),s.map[e.id]=e}function Kp(s,e,t){const n=s.name,i=n.length;for($r.lastIndex=0;;){const r=$r.exec(n),o=$r.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===i){fl(t,c===void 0?new jp(a,s,e):new Jp(a,s,e));break}else{let d=t.map[a];d===void 0&&(d=new $p(a),fl(t,d)),t=d}}}class ir{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const r=e.getActiveUniform(t,i),o=e.getUniformLocation(t,r.name);Kp(r,o,this)}}setValue(e,t,n,i){const r=this.map[t];r!==void 0&&r.setValue(e,n,i)}setOptional(e,t,n){const i=t[n];i!==void 0&&this.setValue(e,n,i)}static upload(e,t,n,i){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,i)}}static seqWithValue(e,t){const n=[];for(let i=0,r=e.length;i!==r;++i){const o=e[i];o.id in t&&n.push(o)}return n}}function pl(s,e,t){const n=s.createShader(e);return s.shaderSource(n,t),s.compileShader(n),n}const Zp=37297;let Qp=0;function e0(s,e){const t=s.split(`
`),n=[],i=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=i;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const ml=new ze;function t0(s){qe._getMatrix(ml,qe.workingColorSpace,s);const e=`mat3( ${ml.elements.map(t=>t.toFixed(4))} )`;switch(qe.getTransfer(s)){case mr:return[e,"LinearTransferOETF"];case tt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",s),[e,"LinearTransferOETF"]}}function gl(s,e,t){const n=s.getShaderParameter(e,s.COMPILE_STATUS),i=s.getShaderInfoLog(e).trim();if(n&&i==="")return"";const r=/ERROR: 0:(\d+)/.exec(i);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+i+`

`+e0(s.getShaderSource(e),o)}else return i}function n0(s,e){const t=t0(e);return[`vec4 ${s}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function i0(s,e){let t;switch(e){case ec:t="Linear";break;case tc:t="Reinhard";break;case nc:t="Cineon";break;case Qo:t="ACESFilmic";break;case ic:t="AgX";break;case sc:t="Neutral";break;case bh:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+s+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const qs=new D;function s0(){qe.getLuminanceCoefficients(qs);const s=qs.x.toFixed(4),e=qs.y.toFixed(4),t=qs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function r0(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(us).join(`
`)}function o0(s){const e=[];for(const t in s){const n=s[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function a0(s,e){const t={},n=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const r=s.getActiveAttrib(e,i),o=r.name;let a=1;r.type===s.FLOAT_MAT2&&(a=2),r.type===s.FLOAT_MAT3&&(a=3),r.type===s.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:s.getAttribLocation(e,o),locationSize:a}}return t}function us(s){return s!==""}function _l(s,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function vl(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const l0=/^[ \t]*#include +<([\w\d./]+)>/gm;function qo(s){return s.replace(l0,h0)}const c0=new Map;function h0(s,e){let t=He[e];if(t===void 0){const n=c0.get(e);if(n!==void 0)t=He[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return qo(t)}const d0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function xl(s){return s.replace(d0,u0)}function u0(s,e,t,n){let i="";for(let r=parseInt(e);r<parseInt(t);r++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return i}function yl(s){let e=`precision ${s.precision} float;
...
#define LOW_PRECISION`),e}function f0(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===Zl?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===Ql?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Mn&&(e="SHADOWMAP_TYPE_VSM"),e}function p0(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Fi:case Bi:e="ENVMAP_TYPE_CUBE";break;case pr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function m0(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Bi:e="ENVMAP_MODE_REFRACTION";break}return e}function g0(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Zo:e="ENVMAP_BLENDING_MULTIPLY";break;case yh:e="ENVMAP_BLENDING_MIX";break;case Mh:e="ENVMAP_BLENDING_ADD";break}return e}function _0(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function v0(s,e,t,n){const i=s.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=f0(t),c=p0(t),h=m0(t),d=g0(t),u=_0(t),f=r0(t),g=o0(r),_=i.createProgram();let m,p,b=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const S=b+m+o,v=b+p+a,P=pl(i,i.VERTEX_SHADER,S),T=pl(i,i.FRAGMENT_SHADER,v);i.attachShader(_,P),i.attachShader(_,T),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function A(R){if(s.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),k=i.getShaderInfoLog(P).trim(),W=i.getShaderInfoLog(T).trim();let $=!0,q=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if($=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,P,T);else{const ee=gl(i,P,"vertex"),V=gl(i,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};class ji{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const Cm=new la(-1,1,1,-1,0,1);class Rm extends Dt{constructor(){super(),this.setAttribute("position",new st([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new st([0,2,0,0,2,0],2))}}const Pm=new Rm;class va{constructor(e){this._mesh=new N(Pm,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Cm)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Im extends ji{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof Rt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=xs.clone(e.uniforms),this.material=new Rt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new va(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Ll extends ji{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const i=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let o,a;this.inverse?(o=0,a=1):(o=1,a=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(i.REPLACE,i.REPLACE,i.REPLACE),r.buffers.stencil.setFunc(i.ALWAYS,o,4294967295),r.buffers.stencil.setClear(a),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(i.EQUAL,1,4294967295),r.buffers.stencil.setOp(i.KEEP,i.KEEP,i.KEEP),r.buffers.stencil.setLocked(!0)}}class Dm extends ji{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class Lm{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new Ie);this._width=n.width,this._height=n.height,t=new on(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:Tn}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Im(Vc),this.copyPass.material.blending=En,this.clock=new pm}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let i=0,r=this.passes.length;i<r;i++){const o=this.passes[i];if(o.enabled!==!1){if(o.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(i),o.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),o.needsSwap){if(n){const a=this.renderer.getContext(),l=this.renderer.state.buffers.stencil;l.setFunc(a.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),l.setFunc(a.EQUAL,1,4294967295)}this.swapBuffers()}Ll!==void 0&&(o instanceof Ll?n=!0:o instanceof Dm&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new Ie);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,i=this._height*this._pixelRatio;this.renderTarget1.setSize(n,i),this.renderTarget2.setSize(n,i);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,i)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class Fm extends ji{constructor(e,t,n=null,i=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=i,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new ye}render(e,t,n){const i=e.autoClear;e.autoClear=!1;let r,o;this.overrideMaterial!==null&&(o=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=o),e.autoClear=i}}const Bm={uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new ye(0)},defaultOpacity:{value:0}},vertexShader:`
      ...
      z-index: 100;
      touch-action: none;
    `,document.body.appendChild(e),this.joystickManager=cg.create({zone:e,mode:"static",position:{left:"75px",bottom:"75px"},color:"rgba(255, 255, 255, 0.6)",size:120,restOpacity:.5}),this.joystickManager.on("move",(r,o)=>{o.vector&&(this.steerAxis=o.vector.x)}),this.joystickManager.on("end",()=>{this.steerAxis=0});const t=document.createElement("div");t.style.cssText=`
      position: fixed;
      bottom: 30px;
      right: 30px;
      width: 90px;
...
`),o=Math.round(n*.045),a=r.length*o+24,l=n*.45-a/2,c=t*.85,h=(t-c)/2;this.roundRect(e,h,l,c,a,16),e.fill(),e.fillStyle="#fff",e.shadowColor="rgba(0,0,0,0.6)",e.shadowBlur=8,r.forEach((d,u)=>{e.fillText(d,t/2,l+22+u*o)}),e.restore()}finish(){if(this.done)return;this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.sctx&&this.scratch&&(this.revealed=Hl(this.sctx,this.scratch.width,this.scratch.height));const e=Math.round(this.revealed*100),t=Math.max(20,e),n=t/100,i=this.photo,r=Mg(i.id),o=ws().length,a=bg();this.showResultScreen(t,i,r,o,a,n)}showResultScreen(e,t,n,i,r,o){const a=this.ctx,l=this.canvas;if(!a||!l)return;const c=l.width,h=l.height;a.clearRect(0,0,c,h),this.imgLoaded&&this.img&&this.img.naturalWidth>0?Vl(a,this.img,c,h):(a.fillStyle="#2a2a20",a.fillRect(0,0,c,h)),this.scratch&&a.drawImage(this.scratch,0,0),a.fillStyle="rgba(0,0,0,0.65)",a.fillRect(0,0,c,h);const d=e>=85?"#5EDB7D":e>=60?"#F7C948":"#F07070";a.font=`900 ${Math.round(h*.15)}px system-ui`,a.textAlign="center",a.fillStyle=d,a.shadowColor="rgba(0,0,0,0.8)",a.shadowBlur=20,a.fillText(`${e}%`,c/2,h*.35),a.font=`bold ${Math.round(h*.04)}px system-ui`,a.fillStyle="#fff",a.shadowBlur=10,a.fillText(`📸 ${t.name}`,c/2,h*.47);let u;r?u="🏆 FULL TEM COLLECTION!":n?u="✨ NEW PHOTO UNLOCKED!":u="Already in your collection",a.font=`bold ${Math.round(h*.032)}px system-ui`,a.fillStyle=r?"#FFD700":n?"#5EDB7D":"#aaa",a.shadowBlur=8,a.fillText(u,c/2,h*.56),a.font=`${Math.round(h*.026)}px system-ui`,a.fillStyle="rgba(255,255,255,0.75)",a.shadowBlur=4,a.fillText(`Collection: ${i} / ${ri.length}`,c/2,h*.64),a.shadowBlur=0;const f=r?"🏆 Full TEM Collection complete!":n?`📸 New photo unlocked: ${t.name}`:`${t.name} — already in collection`,g={score:e,qualityPct:o,message:f};setTimeout(()=>{var _;return(_=this.onComplete)==null?void 0:_.call(this,g)},2800)}unmount(){this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.rafId&&cancelAnimationFrame(this.rafId),this.canvas&&(this.canvas.removeEventListener("mousemove",this._onMouseMove),this.canvas.removeEventListener("mousedown",this._onMouseDown),this.canvas.removeEventListener("touchstart",this._onTouchStart),this.canvas.removeEventListener("touchmove",this._onTouchMove),this.canvas.removeEventListener("touchend",this._onTouchEnd),this.canvas.remove()),window.removeEventListener("mouseup",this._onMouseUp),this.canvas=null,this.ctx=null,this.scratch=null,this.sctx=null,this.container=null,this.onComplete=null,this.img=null}}const De=400,ft=700,Cg=800,Wl=-420,$s=140,Xl=100,Rg=600,Pg=.5,Gt=44,Ks=22,Ig=.6,Dg=180,Lg=-200,ql=60,Fg=80,Bg=.8,Ug=100,Ng=1.15,os=3,Og=100,as=200,Ei=80,hn=270,kg=[{id:"lv1",baseX:80,y:540,width:100,height:8,level:1,type:"normal"},{id:"lv2",baseX:140,y:450,width:120,height:8,level:2,type:"normal"},{id:"lv3a",baseX:80,y:360,width:100,height:8,level:3,type:"normal"},{id:"lv3b",baseX:220,y:360,width:100,height:8,level:3,type:"normal"},{id:"lv4",baseX:125,y:270,width:140,height:8,level:4,type:"moving"},{id:"lv5a",baseX:80,y:185,width:100,height:8,level:5,type:"crumbling"},{id:"lv5b",baseX:220,y:185,width:100,height:8,level:5,type:"normal"},{id:"lv6",baseX:80,y:100,width:240,height:8,level:6,type:"win"}],On={x:190,y:420,w:40,h:30};class zg{constructor(){C(this,"canvas",null);C(this,"ctx",null);C(this,"animFrame",null);C(this,"onComplete",null);C(this,"phase","playing");C(this,"platforms",[]);C(this,"jarrad");C(this,"pigeon");C(this,"gameTime",0);C(this,"tsuyoshiSpeech","I GOT IT!");C(this,"tsuyoshiTimer",0);C(this,"resultTimer",0);C(this,"retried",!1);C(this,"movingPlatTime",0);C(this,"movingPlatX",125);C(this,"crumble5ATimer",0);C(this,"crumble5AState","solid");C(this,"crumble5ARespawn",0);C(this,"ropeAngle",0);C(this,"ropeAngVel",0);C(this,"ropeGrabbed",!1);C(this,"windCycleTimer",0);C(this,"windActive",!1);C(this,"windAlpha",0);C(this,"showGapHint",!0);C(this,"gapHintTimer",8);C(this,"shakeNoise",0);C(this,"comboPhase",0);C(this,"comboTimer",0);C(this,"comboFlashTimer",0);C(this,"vaultFlashTimer",0);C(this,"rewindFlashTimer",0);C(this,"splatParticles",[]);C(this,"frameCount",0);C(this,"prevJarradY",0);C(this,"wallDustParticles",[]);C(this,"hasShimmied",!1);C(this,"keys",{});C(this,"prevKeys",{});C(this,"keyHandler");C(this,"keyUpHandler");C(this,"mobileLeft",!1);C(this,"mobileRight",!1);C(this,"mobileJump",!1);C(this,"mobileDrop",!1);C(this,"mobileRewind",!1);C(this,"mobileRewindFired",!1);C(this,"mobileContainer",null);C(this,"lastTimestamp",0)}mount(e,t){this.onComplete=t,this.platforms=kg.map(i=>({...i})),this.canvas=document.createElement("canvas"),this.canvas.width=De,this.canvas.height=ft,this.canvas.style.cssText=`
    ...
    `,this.overlay.appendChild(r);const o=document.createElement("div");o.id="gallery-encourage",o.style.cssText=`
      ...
      padding: 0 20px 40px;
      box-sizing: border-box;
    `,this.overlay.appendChild(o),this.overlay.addEventListener("click",a=>{a.target===this.overlay&&this.hide()}),document.body.appendChild(this.overlay),this.refresh()}refresh(){if(!this.overlay)return;const e=ws(),t=e.length,n=ri.length,i=this.overlay.querySelector("#gallery-progress-wrap");if(i){i.innerHTML="";const a=document.createElement("div");a.style.cssText=`
      ...
      `,l.appendChild(c),i.appendChild(l)}const r=this.overlay.querySelector("#gallery-grid");r&&(r.innerHTML="",ri.forEach(a=>{const l=e.includes(a.id),c=document.createElement("div");if(c.style.cssText=`
        ...
        `,l){const h=document.createElement("img");h.src=a.file,h.alt=a.name,h.style.cssText=`
          ...
          `,c.appendChild(h)}r.appendChild(c)}));const o=this.overlay.querySelector("#gallery-encourage");o&&(t>=n?o.textContent="🏆 You've scraped them all. Matt's proud. Sort of.":t>=6?o.textContent="🔥 Almost there — keep scraping!":t>=3?o.textContent="💪 Nice collection forming. More plastering to do!":t===0?o.textContent="🪣 No photos yet — complete jobs to reveal TEM work!":o.textContent="✨ Keep scraping to unlock all 8 TEM photos!")}hide(){this.overlay&&(this.overlay.style.display="none")}}const Yl=[15087942,2201331,16757504,5025616,10233776,16739125];function Vg(s){const e=new Ne,t=new Z({color:s}),n=new N(new ne(3.5,1.2,6.5),t);n.position.set(0,.6,0),n.castShadow=!0,e.add(n);const i=new Z({color:s}),r=new N(new ne(2.5,.9,3.5),i);r.position.set(0,1.65,0),r.castShadow=!0,e.add(r);const o=new Z({color:1118481}),a=[[-1.8,.4,2.2],[1.8,.4,2.2],[-1.8,.4,-2.2],[1.8,.4,-2.2]];for(const[d,u,f]of a){const g=new N(new Ke(.5,.5,.4,8),o);g.rotation.z=Math.PI/2,g.position.set(d,u,f),g.castShadow=!0,e.add(g)}const l=new Z({color:3359829}),c=new N(new ne(2.3,.7,.1),l);c.position.set(0,1.4,-3.3),e.add(c);const h=new N(new ne(2.3,.7,.1),l);return h.position.set(0,1.4,3.3),e.add(h),e}function Wg(s,e){return s==="x"?e===1?-Math.PI/2:Math.PI/2:e===1?Math.PI:0}class Xg{constructor(e){C(this,"cars",[]);C(this,"scene");this.scene=e,this._spawn()}_spawn(){const e=[-200,-160,-120,-80,-40,0,40,80,120,160,200],t=n=>{const i=Yl[Math.floor(Math.random()*Yl.length)],r=Vg(i),o=e[Math.floor(Math.random()*e.length)],a=Math.random()>.5?2:-2,l=10+Math.random()*10,c=Math.random()>.5?1:-1,h=-200+Math.random()*400;r.rotation.y=Wg(n,c);const d={group:r,axis:n,roadPos:o,laneOffset:a,speed:l,dir:c,pos:h};this.cars.push(d),this.scene.add(r),this._applyPosition(d)};for(let n=0;n<14;n++)t("z");for(let n=0;n<14;n++)t("x")}_applyPosition(e){e.axis==="x"?e.group.position.set(e.pos,0,e.roadPos+e.laneOffset):e.group.position.set(e.roadPos+e.laneOffset,0,e.pos)}update(e,t,n){for(const i of this.cars)i.pos+=i.dir*i.speed*e,i.pos>235&&(i.pos=-235),i.pos<-235&&(i.pos=235),this._applyPosition(i)}resolveVan(e,t,n=1.8){let i=e,r=t,o=!1;for(const a of this.cars){const l=a.group.position.x,c=a.group.position.z,h=(a.axis==="x"?3.25:1.75)+n,d=(a.axis==="x"?1.75:3.25)+n,u=i-l,f=r-c;if(Math.abs(u)<h&&Math.abs(f)<d){const g=h-Math.abs(u),_=d-Math.abs(f);g<_?i+=u<0?-g:g:r+=f<0?-_:_,o=!0}}return{x:i,z:r,hit:o}}checkVanCollision(e,t){const n=this.resolveVan(e,t);return{hit:n.hit,pushX:n.x-e,pushZ:n.z-t}}}const jl=[16032353,15167313,2792847,2508371,15320170,11066076,16739179,7029286],qg=16767916,Yg=40,Jl=8;function jg(s){const e=new Ne,t=new Z({color:s}),n=new Z({color:qg}),i=new Z({color:s}),r=new N(new Ke(.3,.35,1.1,7),t);r.position.set(0,.55,0),e.add(r);const o=new N(new wt(.28,6,5),n);o.position.set(0,1.28,0),e.add(o);const a=new N(new ne(.15,.65,.15),t);a.position.set(-.45,.75,0),a.rotation.z=.15,e.add(a);const l=new N(new ne(.15,.65,.15),t);l.position.set(.45,.75,0),l.rotation.z=-.15,e.add(l);const c=new N(new ne(.18,.55,.18),i);c.position.set(-.18,0,.05),e.add(c);const h=new N(new ne(.18,.55,.18),i);return h.position.set(.18,0,-.05),e.add(h),{group:e,leftArm:a,rightArm:l,leftLeg:c,rightLeg:h}}class Jg{constructor(e){C(this,"pedestrians",[]);C(this,"scene");this.scene=e,this._spawn()}_spawn(){const e=[];for(let n=-200;n<=200;n+=40)e.push(n);const t=n=>{const i=jl[Math.floor(Math.random()*jl.length)],{group:r,leftArm:o,rightArm:a,leftLeg:l,rightLeg:c}=jg(i),h=e[Math.floor(Math.random()*e.length)],d=Math.random()>.5?5:-5,u=h+d,f=[];for(let P=-240;P<240;P+=40)f.push(P);const g=f[Math.floor(Math.random()*f.length)],_=g+Jl/2,m=g+Yg-Jl/2,p=_+Math.random()*(m-_),b=Math.random()>.5?1:-1,S=2+Math.random()*1.5,v={group:r,axis:n,roadPos:u,segStart:_,segEnd:m,pos:p,dir:b,speed:S,scattering:!1,scatterTimer:0,scatterDirX:0,scatterDirZ:0,walkCycle:Math.random()*Math.PI*2,leftArm:o,rightArm:a,leftLeg:l,rightLeg:c};this.pedestrians.push(v),this.scene.add(r),this._applyPosition(v),this._applyFacing(v)};for(let n=0;n<20;n++)t("x");for(let n=0;n<20;n++)t("z")}_applyPosition(e){e.axis==="x"?e.group.position.set(e.pos,0,e.roadPos):e.group.position.set(e.roadPos,0,e.pos)}_applyFacing(e){if(e.scattering){e.group.rotation.y=Math.atan2(e.scatterDirX,e.scatterDirZ);return}e.axis==="x"?e.group.rotation.y=e.dir===1?-Math.PI/2:Math.PI/2:e.group.rotation.y=e.dir===1?Math.PI:0}update(e,t,n){for(const i of this.pedestrians){const r=i.group.position.x,o=i.group.position.z,a=r-t,l=o-n,c=Math.sqrt(a*a+l*l);if(!i.scattering&&c<7){i.scattering=!0,i.scatterTimer=2.5;const u=Math.max(c,.01);i.scatterDirX=a/u,i.scatterDirZ=l/u}i.scattering?(i.group.position.x+=i.scatterDirX*12*e,i.group.position.z+=i.scatterDirZ*12*e,i.scatterTimer-=e,i.scatterTimer<=0&&(i.scattering=!1,i.axis==="x"?i.pos=Math.max(i.segStart,Math.min(i.segEnd,i.group.position.x)):i.pos=Math.max(i.segStart,Math.min(i.segEnd,i.group.position.z)),this._applyPosition(i))):(i.pos+=i.dir*i.speed*e,i.pos>=i.segEnd?(i.pos=i.segEnd,i.dir=-1):i.pos<=i.segStart&&(i.pos=i.segStart,i.dir=1),this._applyPosition(i)),this._applyFacing(i);const h=i.scattering?12:i.speed;i.walkCycle+=h*e*2;const d=Math.sin(i.walkCycle);i.leftArm.rotation.z=d*.4+.15,i.rightArm.rotation.z=-d*.4-.15,i.leftLeg.rotation.x=d*.5,i.rightLeg.rotation.x=-d*.5}}}const bn=class bn{constructor(e){C(this,"indicator");C(this,"scene");C(this,"lastVisit",-30);this.scene=e,this.indicator=new N(new wt(1.5,10,8),new Z({color:13918762,emissive:new ye(10498064),emissiveIntensity:.8})),this.indicator.position.set(bn.POS.x,10,bn.POS.z),this.scene.add(this.indicator)}update(e){this.indicator.position.y=10+Math.sin(Date.now()*.002)*.5,this.indicator.rotation.y+=e*1.5}isNearby(e,t){const n=e-bn.POS.x,i=t-bn.POS.z;return Math.sqrt(n*n+i*i)<bn.TRIGGER_RADIUS}tryVisit(e,t){if(!this.isNearby(e,t))return!1;const n=Date.now()/1e3;return n-this.lastVisit<20?!1:(this.lastVisit=n,!0)}};C(bn,"POS",{x:-60,z:-100}),C(bn,"TRIGGER_RADIUS",12);let $o=bn;class $g{constructor(){C(this,"level",0);C(this,"isUrgent",!1);C(this,"lastUrgentToast",0);C(this,"caffeinated",!1);C(this,"caffeineTimer",0)}update(e,t){this.caffeinated&&(this.caffeineTimer-=e,this.caffeineTimer<=0&&(this.caffeinated=!1));const n=this.caffeinated?.018:.012;Math.abs(t)>2?this.level=Math.min(1,this.level+e*n):this.level=Math.max(0,this.level-e*.005),this.isUrgent=this.level>.8}drinkCoffee(){this.level=Math.min(1,this.level+.4),this.caffeinated=!0,this.caffeineTimer=30,this.isUrgent=this.level>.8}tryRelief(e,t){const n=e-100,i=t-60;return Math.sqrt(n*n+i*i)>14||this.level===0?!1:(this.level=0,this.isUrgent=!1,this.caffeinated=!1,this.caffeineTimer=0,!0)}get spillMultiplier(){return this.isUrgent?1.8:1}}const ls={x:30,z:28},$l=["Got a dollar, mate? 💸","You got a light? 🚬","Nice van. Does it leak?","My brother Jarrad says I'm not qualified. He's right but I don't like it.","These boots were not made for plastering. Yet here we are.","Jump in? No seriously, I need a lift.","Jarrad says he's read the TDS. He hasn't. I've lived with him.","You look like you need a coffee and a toilet. In that order.","Phil owes me fifty bucks. Pass it on.","I plastered that wall. Don't tell Jarrad.","Matt left the primer lid off again. Just letting you know."],ms=class ms{constructor(e){C(this,"wrapper");C(this,"character");C(this,"ropeRing");C(this,"ropePivot");C(this,"lastDialogue",0);C(this,"cooldown",9e3);this.character=new xr(zi.Mikayla),this.character.group.scale.set(2,2,2);const t=this.character.buildJumpRopeClip();this.character.mixer.stopAllAction(),this.character.mixer.clipAction(t).play(),this.ropePivot=new Ne,this.ropePivot.position.set(0,1.3,0),this.ropePivot.rotation.y=Math.PI/2,this.character.group.add(this.ropePivot),this.ropeRing=new N(new pa(1.35,.05,7,28),new Z({color:8079902})),this.ropePivot.add(this.ropeRing);const n=this._makeNameBoard();n.position.set(0,8.8,0);const i=new N(new li(1.2,1.7,32),new jt({color:14501e3,side:Ht}));i.rotation.x=-Math.PI/2,i.position.y=.05,this.wrapper=new Ne,this.wrapper.add(this.character.group),this.wrapper.add(n),this.wrapper.add(i),this.wrapper.position.set(ls.x,0,ls.z),e.add(this.wrapper)}_makeNameBoard(){const e=document.createElement("canvas");e.width=256,e.height=64;const t=e.getContext("2d");t.fillStyle="rgba(190, 40, 90, 0.88)",t.roundRect?t.roundRect(2,2,252,60,8):t.rect(2,2,252,60),t.fill(),t.fillStyle="#fff",t.font="bold 30px Arial",t.textAlign="center",t.textBaseline="middle",t.fillText("MIKAYLA",128,32);const n=new Xi(e);return new N(new pt(2.4,.6),new jt({map:n,transparent:!0,depthWrite:!1}))}update(e,t,n,i){this.character.update(e),this.ropeRing.rotation.z+=e*(2*Math.PI/Xc);const r=t-ls.x,o=n-ls.z;this.character.group.rotation.y=Math.atan2(r,o);const a=Math.sqrt(r*r+o*o),l=Date.now();if(a<ms.TRIGGER_RADIUS&&l-this.lastDialogue>this.cooldown){const c=$l[Math.floor(Math.random()*$l.length)];return i.show(zi.Mikayla,c),this.lastDialogue=l,!0}return!1}dispose(e){e.remove(this.wrapper)}};C(ms,"POS",ls),C(ms,"TRIGGER_RADIUS",15);let ei=ms;function Kg(){const s=document.createElement("canvas");s.width=256,s.height=256;const e=s.getContext("2d");e.fillStyle="#F0EDE8",e.fillRect(0,0,256,256),e.strokeStyle="#111111",e.fillStyle="#111111",e.lineCap="round",e.lineWidth=10,e.beginPath(),e.moveTo(128,220),e.lineTo(128,150),e.stroke(),e.lineWidth=6,e.beginPath(),e.moveTo(128,150),e.lineTo(128,95),e.stroke();const t=[[128,175,78,148],[128,175,178,148],[128,158,68,132],[128,158,188,132],[128,140,80,115],[128,140,176,115],[128,122,90,98],[128,122,166,98],[128,108,100,84],[128,108,156,84],[128,97,112,70],[128,97,144,70],[128,88,120,58],[128,88,136,58]];e.lineWidth=4;for(const[n,i,r,o]of t)e.beginPath(),e.moveTo(n,i),e.lineTo(r,o),e.stroke(),e.beginPath(),e.arc(r,o,4.5,0,Math.PI*2),e.fill();return new Xi(s)}const cs={x:-4,z:-6},Kl=["Ha ha ha HA HA! You picked up ze buckets! Love it!","I mix ze plaster by hand. Za gloves are for ze weak.","In Germany, zis would be a warm-up. But I like Australia. Ze mud here is good.","I have mud wrestled ze entire Brunswick football club. Zey lost. Badly.","Ze mixing ratio is one part water, two parts product, one part pure power.","Last Saturday I wrestled a man twice my size. Sunday I mixed 50 buckets. Your turn.","Don't let ze hair fool you. I once arm wrestled Phil. He is still talking about it.","Ha HA! You are funny. Not as funny as ze last guy. But funny."],gs=class gs{constructor(e){C(this,"wrapper");C(this,"character");C(this,"lastDialogue",0);C(this,"cooldown",1e4);C(this,"audioCtx",null);this.character=new xr(zi.Connie),this.character.group.scale.set(2,2.35,2);const t=new Z({color:15789544}),n=new N(new wt(.16,8,6),t);n.position.set(-.12,1.55,.19);const i=new N(new wt(.16,8,6),t);i.position.set(.12,1.55,.19),this.character.group.add(n),this.character.group.add(i),this.character.setLogoTexture(Kg());const r=this._makeNameBoard();r.position.set(0,8.8,0);const o=new N(new li(1.2,1.7,32),new jt({color:16109664,side:Ht}));o.rotation.x=-Math.PI/2,o.position.y=.05,this.wrapper=new Ne,this.wrapper.add(this.character.group),this.wrapper.add(r),this.wrapper.add(o),this.wrapper.position.set(cs.x,0,cs.z),e.add(this.wrapper)}_makeNameBoard(){const e=document.createElement("canvas");e.width=256,e.height=64;const t=e.getContext("2d");return t.fillStyle="rgba(200, 150, 20, 0.88)",t.roundRect?t.roundRect(2,2,252,60,8):t.rect(2,2,252,60),t.fill(),t.fillStyle="#fff",t.font="bold 30px Arial",t.textAlign="center",t.textBaseline="middle",t.fillText("CONNIE",128,32),new N(new pt(2.4,.6),new jt({map:new Xi(e),transparent:!0,depthWrite:!1}))}playLaugh(){try{this.audioCtx||(this.audioCtx=new(window.AudioContext||window.webkitAudioContext));const e=this.audioCtx,t=7;for(let n=0;n<t;n++){const i=e.currentTime+n*.16,r=e.createOscillator(),o=e.createGain(),a=480+n*18+Math.random()*60;r.frequency.setValueAtTime(a,i),r.frequency.exponentialRampToValueAtTime(a*.48,i+.13),o.gain.setValueAtTime(0,i),o.gain.linearRampToValueAtTime(.35,i+.03),o.gain.exponentialRampToValueAtTime(.001,i+.15),r.connect(o),o.connect(e.destination),r.start(i),r.stop(i+.17)}}catch{}}update(e,t,n,i){this.character.update(e);const r=t-cs.x,o=n-cs.z;this.character.group.rotation.y=Math.atan2(r,o);const a=Math.sqrt(r*r+o*o),l=Date.now();if(a<gs.TRIGGER_RADIUS&&l-this.lastDialogue>this.cooldown){const c=Kl[Math.floor(Math.random()*Kl.length)];return i.show(zi.Connie,c),this.lastDialogue=l,!0}return!1}dispose(e){var t;e.remove(this.wrapper),(t=this.audioCtx)==null||t.close()}};C(gs,"POS",cs),C(gs,"TRIGGER_RADIUS",16);let ps=gs;class Zg{constructor(){C(this,"renderer");C(this,"scene");C(this,"camera");C(this,"canvas");C(this,"cache",new Map);this.canvas=document.createElement("canvas"),this.canvas.width=160,this.canvas.height=160,this.renderer=new Bc({canvas:this.canvas,antialias:!0,alpha:!0,preserveDrawingBuffer:!0}),this.renderer.setSize(160,160),this.renderer.setClearColor(0,0),this.scene=new Uc;const e=new Hc(16777215,.7);this.scene.add(e);const t=new dr(16774624,1);t.position.set(2,4,5),this.scene.add(t);const n=new dr(14741759,.4);n.position.set(-3,2,3),this.scene.add(n),this.camera=new Nt(38,1,.1,100),this.camera.position.set(1.2,5,5.5),this.camera.lookAt(.1,3.8,0)}renderPortrait(e){if(this.cache.has(e.name))return this.cache.get(e.name);this.scene.children.filter(r=>!(r instanceof bs)).forEach(r=>this.scene.remove(r));const n=new xr(e);n.group.scale.set(2,2,2),n.group.rotation.y=-Math.PI*.18,this.scene.add(n.group),this.renderer.render(this.scene,this.camera);const i=this.canvas.toDataURL("image/png");return this.cache.set(e.name,i),this.scene.remove(n.group),i}dispose(){this.renderer.dispose()}}class Qg{constructor(){C(this,"container");C(this,"portrait");C(this,"nameEl");C(this,"textEl");C(this,"portraitRenderer");C(this,"hideTimeout",null);C(this,"visible",!1);this.portraitRenderer=new Zg,this._injectStyles(),this._buildDOM()}_injectStyles(){if(document.getElementById("speech-bubble-styles"))return;const e=document.createElement("style");e.id="speech-bubble-styles",e.textContent=`
      #tem-speech-bubble {
        position: fixed;
        left: 0;
        top: 0;
    ...
    `,this.progressBar=document.createElement("div"),this.progressBar.style.cssText=`
      ...
      transition: none;
    `,i.appendChild(this.progressBar);const r=document.createElement("div");r.style.cssText="padding: 16px 20px 4px;",this.bodyEl=document.createElement("div"),this.bodyEl.style.cssText=`
      color: #EEE8E0;
      font-size: 14.5px;
      line-height: 1.65;
    ...
    `,o.textContent="▶  TAP GAS or REV to skip",t.appendChild(this.titleEl),t.appendChild(n),r.appendChild(this.bodyEl),e.appendChild(t),e.appendChild(i),e.appendChild(r),e.appendChild(o),this.overlay.appendChild(e),document.body.appendChild(this.overlay),this.overlay.addEventListener("touchstart",a=>{a.preventDefault(),this.tryResume()},{passive:!1}),this.overlay.addEventListener("click",()=>this.tryResume())}show(e,t,n){this._clearTimers(),this._active=!0,this._readyToResume=!1,this._resumeCallback=n,this._secondsLeft=hs,this.titleEl.textContent=e,this.bodyEl.textContent=t,this.hintEl.textContent=String(hs),this.overlay.style.display="flex",this.progressBar.style.transition="none",this.progressBar.style.width="100%",this.progressBar.offsetWidth,this.progressBar.style.transition=`width ${hs}s linear`,this.progressBar.style.width="0%",this._lockTimer=setTimeout(()=>{this._readyToResume=!0},380),this._countdownInterval=setInterval(()=>{this._secondsLeft=Math.max(0,this._secondsLeft-1),this.hintEl.textContent=String(this._secondsLeft)},1e3),this._autoTimer=setTimeout(()=>{this._forceResume()},hs*1e3)}tryResume(){!this._active||!this._readyToResume||this._doResume()}_forceResume(){this._active&&this._doResume()}_doResume(){this._active=!1,this._readyToResume=!1,this.overlay.style.display="none",this._clearTimers();const e=this._resumeCallback;this._resumeCallback=null,e==null||e()}_clearTimers(){this._lockTimer&&(clearTimeout(this._lockTimer),this._lockTimer=null),this._autoTimer&&(clearTimeout(this._autoTimer),this._autoTimer=null),this._countdownInterval&&(clearInterval(this._countdownInterval),this._countdownInterval=null)}get isActive(){return this._active}}const t_={Matt:`Matt folds himself into the back. "Took your time." He's already on his phone.`,Jose:'Jose appears from nowhere, bucket in hand. "Vámonos — I was getting bored."',Jarrad:`Jarrad adjusts his hard hat. "I've been standing here fifteen minutes." He has.`,Phil:`Phil sips the last of his tea, unhurried. "Right then. Let's go." He fastens his seatbelt twice.`,Tsuyoshi:"Tsuyoshi vaults in without opening the door. His mohawk grazes the roof lining.",Fabio:`Fabio loads in, trowel over his shoulder. "You're late." He's smiling though.`};async function n_(){const s=new zm;await s.init();const e=new Xm(s.scene);e.spawnCrewAtCityPositions();const t=new hg,n=new qm(s.scene),i=new dg,r=new yg,o=new e_,a=new fr,l=new Zm(n,t,M=>{a.activePhase>=2&&i.triggerBump(M)},s.collisionWorld,()=>{a.activePhase>=2&&i.triggerCrash()}),c=new Jo(s.scene),h=new gg(M=>{h.hide(),o.show(`📋 ${M.title}`,`Client: ${M.client}

${M.description}

💰 Pay: $${M.pay.toLocaleString()}

🏭 Head to the TEM workshop to collect supplies.`,()=>{a.acceptJob(M),c.setTarget(fr.WORKSHOP_POS),r.setActiveJob(M,1),r.updateCrewStatus([],[],!1)})});i.onSpill=M=>{a.money=Math.max(0,a.money-M),r.updateMoney(a.money),r.showSpillPenalty(M)};const d=document.createElement("button");d.textContent="📋 JOBS",d.style.cssText=`
    position: fixed;
    top: 16px;
    right: 16px;
  ...
  `,document.body.appendChild(I),s.onUpdate(M=>{const x=n.mesh.position.x,R=n.mesh.position.z;if(o.isActive){(t.forward||t.brake)&&o.tryResume(),e.updateAll(M),m.update(M,x,R,b),p.update(M,x,R,b),s.camera.follow(n.mesh.position,n.velocity,n.heading);{const J=S.clone().project(s.camera.camera),re=(J.x*.5+.5)*window.innerWidth,me=(-J.y*.5+.5)*window.innerHeight;b.setScreenPosition(re,me)}return}l.update(M),n.updateSuspension(M);const z=a.activeJob!==null&&a.activePhase>=2;if(i.setVisible(z),z?i.update(M):i.level=0,e.updateAll(M),g.update(M),g.tryVisit(x,R)&&(i.level=Math.max(0,i.level-.6),_.drinkCoffee(),_.isUrgent?r.showToast("☕ Coffeed up — now find a toilet, fast!",13918762):r.showToast("☕ Coffee hit! Plaster steady, bladder loading...",13918762)),_.update(M,a.activeJob?l.speed:0),_.tryRelief(x,R)&&r.showToast("🚽 Ahhh! Relief! Ready for the next coffee ☕",2201331),_.isUrgent&&a.activeJob){const J=Date.now();J-_.lastUrgentToast>15e3&&(_.lastUrgentToast=J,r.showToast("🚽 Bursting! Find the toilet before you spill!",16733986))}i.spillRateMultiplier=_.spillMultiplier,m.update(M,x,R,b)&&S.set(ei.POS.x,6,ei.POS.z),p.update(M,x,R,b)&&S.set(ps.POS.x,6,ps.POS.z);const k=e.checkProximityDialogue(x,R);k&&(S.set(k.pos.x,6,k.pos.z),b.show(zi[k.name],k.line));{const J=S.clone().project(s.camera.camera),re=(J.x*.5+.5)*window.innerWidth,me=(-J.y*.5+.5)*window.innerHeight;b.setScreenPosition(re,me)}u.update(M,x,R),f.update(M,x,R);const W=u.resolveVan(x,R);if(W.hit&&(n.mesh.position.x=W.x,n.mesh.position.z=W.z,l.applyImpulse(0,0),a.activePhase>=2&&i.triggerCrash()),c.update(M,x,R),a.activeJob){const J=a.tickTravel(M);r.updateTravelTimer(a.travelTimer),J!=null&&J.failed&&(i.level=0,c.setTarget(null),r.updateTravelTimer(null),r.showTimerFail(15e4),r.setActiveJob(null,1),r.updateMoney(a.money),r.updateCrewStatus([],[],!1),e.showAllCrew(),setTimeout(()=>h.show(a.getAvailableJobs()),3500))}else r.updateTravelTimer(null);if(a.activeJob!==null)if(a.activePhase===1)r.updateJobDistance(a.distanceToWorkshop(x,R));else if(a.activePhase===2){const J=a.nextCrewNeeded();if(J){const re=e.getCrewPosition(J);r.updateJobDistance(a.distanceToPoint(x,R,re.x,re.z))}}else r.updateJobDistance(a.distanceTo(x,R));if(a.activeJob&&a.activePhase===1&&!A&&a.checkPhase1Arrival(x,R)){A=!0,i.level=0,p.playLaugh();const J=a.crewToPickup.join(" + ");o.show("📦 Supplies Loaded!",`Connie's cackle echoes through the factory as the buckets go in.

Now go pick up the crew:
👷 ${J}

They're scattered around the city. Your waypoint will guide you.`,()=>{a.advanceToPhase2();const re=a.nextCrewNeeded();if(re){const me=e.getCrewPosition(re);c.setTarget(me)}r.showPhase1Complete(),r.setActiveJob(a.activeJob,2),r.updateCrewStatus(a.crewToPickup,a.crewPickedUp,!0),A=!1})}if(a.activeJob&&a.activePhase===2&&!A)for(const J of a.crewToPickup){if(a.crewPickedUp.includes(J))continue;const re=e.getCrewPosition(J);if(a.distanceToPoint(x,R,re.x,re.z)<10){A=!0,e.hideCrew(J);const Le=a.pickupCrew(J);r.updateCrewStatus(a.crewToPickup,a.crewPickedUp,!0);const Ye=t_[J]??`${J} hops in.`;if(Le)o.show(`🚐 ${J} aboard — Full crew!`,`${Ye}
...
//# sourceMappingURL=index-DAGqv3h8.js.map
