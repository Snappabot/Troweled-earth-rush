...
#define LOW_PRECISION`),t}function Hf(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===za?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===ka?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===cn&&(t="SHADOWMAP_TYPE_VSM"),t}function Vf(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ui:case fi:t="ENVMAP_TYPE_CUBE";break;case bs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Wf(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case fi:t="ENVMAP_MODE_REFRACTION";break}return t}function Xf(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case eo:t="ENVMAP_BLENDING_MULTIPLY";break;case qc:t="ENVMAP_BLENDING_MIX";break;case $c:t="ENVMAP_BLENDING_ADD";break}return t}function Yf(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),112)),texelHeight:n,maxMip:e}}function qf(i,t,e,n){const s=i.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const c=Hf(e),l=Vf(e),d=Wf(e),f=Xf(e),h=Yf(e),m=Uf(e),g=Bf(r),x=s.createProgram();let p,u,E=e.glslVersion?"#version "+e.glslVersion+`
...
void main() {
    ...
    `,n.textContent="GAS",document.body.appendChild(n),n.addEventListener("touchstart",r=>{r.preventDefault(),this.accelerating=!0,n.style.background="rgba(50, 200, 50, 0.9)"},{passive:!1}),n.addEventListener("touchend",r=>{r.preventDefault(),this.accelerating=!1,n.style.background="rgba(50, 200, 50, 0.6)"},{passive:!1});const s=document.createElement("div");s.style.cssText=`
      ...
      touch-action: none;
      user-select: none;
    `,s.textContent="📯",document.body.appendChild(s),s.addEventListener("touchstart",r=>{r.preventDefault(),this.triggerHorn(),s.style.background="rgba(255, 200, 50, 0.95)",s.style.transform="scale(1.1)"},{passive:!1}),s.addEventListener("touchend",r=>{r.preventDefault(),s.style.background="rgba(255, 200, 50, 0.6)",s.style.transform="scale(1.0)"},{passive:!1})}get forward(){return this.keys.ArrowUp||this.keys.KeyW||this.accelerating}get backward(){return this.keys.ArrowDown||this.keys.KeyS}get left(){return this.keys.ArrowLeft||this.keys.KeyA||this.steerAxis<-.2}get right(){return this.keys.ArrowRight||this.keys.KeyD||this.steerAxis>.2}get brake(){return this.keys.Space||this.braking}get honk(){return this.horn}}class e0{constructor(){$(this,"level",0);$(this,"onSpill");$(this,"container");$(this,"fill");$(this,"bucketEl");$(this,"isShaking",!1);$(this,"spillFlashing",!1);if(!document.getElementById("spill-meter-styles")){const s=document.createElement("style");s.id="spill-meter-styles",s.textContent=`
    ...
    `,e.addEventListener("click",()=>{this.stop(),t({score:75,qualityPct:.75,message:"Job done!"})}),this.overlay.appendChild(e),this.safetyTimer=setTimeout(()=>{this.active&&(this.stop(),t({score:70,qualityPct:.7,message:"Time up!"}))},6e4),setTimeout(()=>{if(this.active)try{this.trowelingGame=new h0,this.trowelingGame.mount(this.overlay,n=>{this.safetyTimer&&clearTimeout(this.safetyTimer),this.stop(),t(n)})}catch(n){console.error("TrowelingGame init failed:",n);const s=document.createElement("div");s.style.cssText=`
        ...
        `,this.overlay.appendChild(s)}},120)}stop(){this.safetyTimer&&(clearTimeout(this.safetyTimer),this.safetyTimer=null),this.trowelingGame&&(this.trowelingGame.unmount(),this.trowelingGame=null),this.overlay.style.display="none",this.overlay.innerHTML="",this.active=!1}}async function f0(){const i=new Up;await i.init();const t=new Bp(i.scene);t.spawnCrewAtCityPositions();const e=new t0,n=new Np(i.scene),s=new e0,r=new d0,o=new Hp(n,e,g=>{s.triggerBump(g)}),a=new Es,c=new Qr(i.scene),l=new o0(g=>{a.acceptJob(g),c.setTarget(Es.WORKSHOP_POS),l.hide(),r.setActiveJob(g,1),r.updateCrewStatus([],[],!1)});s.onSpill=g=>{a.money=Math.max(0,a.money-g),r.updateMoney(a.money),r.showSpillPenalty(g)};const d=document.createElement("button");d.textContent="📋 JOBS",d.style.cssText=`
    position: fixed;
    bottom: 20px;
    right: 20px;
    ...
    transition: background 0.15s, transform 0.1s;
    touch-action: manipulation;
  `,d.addEventListener("pointerenter",()=>{d.style.background="rgba(212, 120, 125, 0.95)",d.style.transform="translateY(-2px)"}),d.addEventListener("pointerleave",()=>{d.style.background="rgba(193, 102, 107, 0.9)",d.style.transform=""}),d.addEventListener("click",()=>{l.isVisible()?l.hide():l.show(a.getAvailableJobs())}),document.body.appendChild(d);const f=new u0;let h=!1;const m=document.createElement("div");m.style.cssText=`
...
//# sourceMappingURL=index-lu31qXrB.js.map
