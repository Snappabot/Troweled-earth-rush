...
`].filter(as).join(`
`)),o=ko(o),o=ul(o,t),o=fl(o,t),a=ko(a),a=ul(a,t),a=fl(a,t),o=pl(o),a=pl(a),t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+p);const S=w+m+o,y=w+p+a,D=cl(i,i.VERTEX_SHADER,S),A=cl(i,i.FRAGMENT_SHADER,y);i.attachShader(_,D),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function T(C){if(s.debug.checkShaderErrors){const G=i.getProgramInfoLog(_).trim(),z=i.getShaderInfoLog(D).trim(),q=i.getShaderInfoLog(A).trim();let $=!0,k=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if($=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,D,A);else{const j=dl(i,D,"vertex"),W=dl(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function C0(s,e,t){let n=new ta;const i=new Re,r=new Re,o=new st,a=new S0({depthPacking:Mh}),l=new E0,c={},h=t.maxTextureSize,u={[Hn]:Rt,[Rt]:Hn,[qt]:qt},d=new Ct({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Re},radius:{value:4}},vertexShader:T0,fragmentShader:A0}),f=d.clone();f.defines.HORIZONTAL_PASS=1;const g=new Pt;g.setAttribute("position",new on(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new N(g,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Xl;let p=this.type;this.render=function(A,T,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const M=s.getRenderTarget(),v=s.getActiveCubeFace(),C=s.getActiveMipmapLevel(),G=s.state;G.setBlending(En),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const z=p!==Mn&&this.type===Mn,q=p===Mn&&this.type!==Mn;for(let $=0,k=A.length;$<k;$++){const j=A[$],W=j.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;i.copy(W.mapSize);const re=W.getFrameExtents();if(i.multiply(re),r.copy(W.mapSize),(i.x>h||i.y>h)&&(i.x>h&&(r.x=Math.floor(h/re.x),i.x=r.x*re.x,W.mapSize.x=r.x),i.y>h&&(r.y=Math.floor(h/re.y),i.y=r.y*re.y,W.mapSize.y=r.y)),W.map===null||z===!0||q===!0){const xe=this.type!==Mn?{minFilter:sn,magFilter:sn}:{};W.map!==null&&W.map.dispose(),W.map=new rn(i.x,i.y,xe),W.map.texture.name=j.name+".shadowMap",W.camera.updateProjectionMatrix()}s.setRenderTarget(W.map),s.clear();const ce=W.getViewportCount();for(let xe=0;xe<ce;xe++){const ze=W.getViewport(xe);o.set(r.x*ze.x,r.y*ze.y,r.x*ze.z,r.y*ze.w),G.viewport(o),W.updateMatrices(j,xe),n=W.getFrustum(),y(T,I,W.camera,j,this.type)}W.isPointLightShadow!==!0&&this.type===Mn&&w(W,I),W.needsUpdate=!1}p=this.type,m.needsUpdate=!1,s.setRenderTarget(M,v,C)};function w(A,T){const I=e.update(_);d.defines.VSM_SAMPLES!==A.blurSamples&&(d.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,d.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new rn(i.x,i.y)),d.uniforms.shadow_pass.value=A.map.texture,d.uniforms.resolution.value=A.mapSize,d.uniforms.radius.value=A.radius,s.setRenderTarget(A.mapPass),s.clear(),s.renderBufferDirect(T,null,I,d,_,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,s.setRenderTarget(A.map),s.clear(),s.renderBufferDirect(T,null,I,f,_,null)}function S(A,T,I,M){let v=null;const C=I.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(C!==void 0)v=C;else if(v=I.isPointLight===!0?l:a,s.localClippingEnabled&&T.clipShadows===!0&&Array.isArray(T.clippingPlanes)&&T.clippingPlanes.length!==0||T.displacementMap&&T.displacementScale!==0||T.alphaMap&&T.alphaTest>0||T.map&&T.alphaTest>0){const G=v.uuid,z=T.uuid;let q=c[G];q===void 0&&(q={},c[G]=q);let $=q[z];$===void 0&&($=v.clone(),q[z]=$,T.addEventListener("dispose",D)),v=$}if(v.visible=T.visible,v.wireframe=T.wireframe,M===Mn?v.side=T.shadowSide!==null?T.shadowSide:T.side:v.side=T.shadowSide!==null?T.shadowSide:u[T.side],v.alphaMap=T.alphaMap,v.alphaTest=T.alphaTest,v.map=T.map,v.clipShadows=T.clipShadows,v.clippingPlanes=T.clippingPlanes,v.clipIntersection=T.clipIntersection,v.displacementMap=T.displacementMap,v.displacementScale=T.displacementScale,v.displacementBias=T.displacementBias,v.wireframeLinewidth=T.wireframeLinewidth,v.linewidth=T.linewidth,I.isPointLight===!0&&v.isMeshDistanceMaterial===!0){const G=s.properties.get(v);G.light=I}return v}function y(A,T,I,M,v){if(A.visible===!1)return;if(A.layers.test(T.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&v===Mn)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,A.matrixWorld);const z=e.update(A),q=A.material;if(Array.isArray(q)){const $=z.groups;for(let k=0,j=$.length;k<j;k++){const W=$[k],re=q[W.materialIndex];if(re&&re.visible){const ce=S(A,re,M,v);A.onBeforeShadow(s,A,T,I,z,ce,W),s.renderBufferDirect(I,null,z,ce,A,W),A.onAfterShadow(s,A,T,I,z,ce,W)}}}else if(q.visible){const $=S(A,q,M,v);A.onBeforeShadow(s,A,T,I,z,$,null),s.renderBufferDirect(I,null,z,$,A,null),A.onAfterShadow(s,A,T,I,z,$,null)}}const G=A.children;for(let z=0,q=G.length;z<q;z++)y(G[z],T,I,M,v)}function D(A){A.target.removeEventListener("dispose",D);for(const I in c){const M=c[I],v=A.target.uuid;v in M&&(M[v].dispose(),delete M[v])}}}const R0={[Qr]:eo,[to]:so,[no]:ro,[Ii]:io,[eo]:Qr,[so]:to,[ro]:no,[io]:Ii};function P0(s,e){function t(){let F=!1;const le=new st;let X=null;const Z=new st(0,0,0,0);return{setMask:function(fe){X!==fe&&!F&&(s.colorMask(fe,fe,fe,fe),X=fe)},setLocked:function(fe){F=fe},setClear:function(fe,de,Be,ft,Et){Et===!0&&(fe*=ft,de*=ft,Be*=ft),le.set(fe,de,Be,ft),Z.equals(le)===!1&&(s.clearColor(fe,de,Be,ft),Z.copy(le))},reset:function(){F=!1,X=null,Z.set(-1,0,0,0)}}}function n(){let F=!1,le=!1,X=null,Z=null,fe=null;return{setReversed:function(de){if(le!==de){const Be=e.get("EXT_clip_control");le?Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.ZERO_TO_ONE_EXT):Be.clipControlEXT(Be.LOWER_LEFT_EXT,Be.NEGATIVE_ONE_TO_ONE_EXT);const ft=fe;fe=null,this.setClear(ft)}le=de},getReversed:function(){return le},setTest:function(de){de?ae(s.DEPTH_TEST):Ae(s.DEPTH_TEST)},setMask:function(de){X!==de&&!F&&(s.depthMask(de),X=de)},setFunc:function(de){if(le&&(de=R0[de]),Z!==de){switch(de){case Qr:s.depthFunc(s.NEVER);break;case eo:s.depthFunc(s.ALWAYS);break;case to:s.depthFunc(s.LESS);break;case Ii:s.depthFunc(s.LEQUAL);break;case no:s.depthFunc(s.EQUAL);break;case io:s.depthFunc(s.GEQUAL);break;case so:s.depthFunc(s.GREATER);break;case ro:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}Z=de}},setLocked:function(de){F=de},setClear:function(de){fe!==de&&(le&&(de=1-de),s.clearDepth(de),fe=de)},reset:function(){F=!1,X=null,Z=null,fe=null,le=!1}}}function i(){let F=!1,le=null,X=null,Z=null,fe=null,de=null,Be=null,ft=null,Et=null;return{setTest:function(tt){F||(tt?ae(s.STENCIL_TEST):Ae(s.STENCIL_TEST))},setMask:function(tt){le!==tt&&!F&&(s.stencilMask(tt),le=tt)},setFunc:function(tt,Yt,pn){(X!==tt||Z!==Yt||fe!==pn)&&(s.stencilFunc(tt,Yt,pn),X=tt,Z=Yt,fe=pn)},setOp:function(tt,Yt,pn){(de!==tt||Be!==Yt||ft!==pn)&&(s.stencilOp(tt,Yt,pn),de=tt,Be=Yt,ft=pn)},setLocked:function(tt){F=tt},setClear:function(tt){Et!==tt&&(s.clearStencil(tt),Et=tt)},reset:function(){F=!1,le=null,X=null,Z=null,fe=null,de=null,Be=null,ft=null,Et=null}}}const r=new t,o=new n,a=new i,l=new WeakMap,c=new WeakMap;let h={},u={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,w=null,S=null,y=null,D=null,A=null,T=new ve(0,0,0),I=0,M=!1,v=null,C=null,G=null,z=null,q=null;const $=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,j=0;const W=s.getParameter(s.VERSION);W.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(W)[1]),k=j>=1):W.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),k=j>=2);let re=null,ce={};const xe=s.getParameter(s.SCISSOR_BOX),ze=s.getParameter(s.VIEWPORT),et=new st().fromArray(xe),Y=new st().fromArray(ze);function ie(F,le,X,Z){const fe=new Uint8Array(4),de=s.createTexture();s.bindTexture(F,de),s.texParameteri(F,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(F,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let Be=0;Be<X;Be++)F===s.TEXTURE_3D||F===s.TEXTURE_2D_ARRAY?s.texImage3D(le,0,s.RGBA,1,1,Z,0,s.RGBA,s.UNSIGNED_BYTE,fe):s.texImage2D(le+Be,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,fe);return de}const _e={};_e[s.TEXTURE_2D]=ie(s.TEXTURE_2D,s.TEXTURE_2D,1),_e[s.TEXTURE_CUBE_MAP]=ie(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),_e[s.TEXTURE_2D_ARRAY]=ie(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),_e[s.TEXTURE_3D]=ie(s.TEXTURE_3D,s.TEXTURE_3D,1,1),r.setClear(0,0,0,1),o.setClear(1),a.setClear(0),ae(s.DEPTH_TEST),o.setFunc(Ii),Ue(!1),Ge(wa),ae(s.CULL_FACE),P(En);function ae(F){h[F]!==!0&&(s.enable(F),h[F]=!0)}function Ae(F){h[F]!==!1&&(s.disable(F),h[F]=!1)}function Ie(F,le){return u[F]!==le?(s.bindFramebuffer(F,le),u[F]=le,F===s.DRAW_FRAMEBUFFER&&(u[s.FRAMEBUFFER]=le),F===s.FRAMEBUFFER&&(u[s.DRAW_FRAMEBUFFER]=le),!0):!1}function We(F,le){let X=f,Z=!1;if(F){X=d.get(le),X===void 0&&(X=[],d.set(le,X));const fe=F.textures;if(X.length!==fe.length||X[0]!==s.COLOR_ATTACHMENT0){for(let de=0,Be=fe.length;de<Be;de++)X[de]=s.COLOR_ATTACHMENT0+de;X.length=fe.length,Z=!0}}else X[0]!==s.BACK&&(X[0]=s.BACK,Z=!0);Z&&s.drawBuffers(X)}function lt(F){return g!==F?(s.useProgram(F),g=F,!0):!1}const Xe={[Zn]:s.FUNC_ADD,[Jc]:s.FUNC_SUBTRACT,[$c]:s.FUNC_REVERSE_SUBTRACT};Xe[Kc]=s.MIN,Xe[Zc]=s.MAX;const Le={[Qc]:s.ZERO,[eh]:s.ONE,[th]:s.SRC_COLOR,[Kr]:s.SRC_ALPHA,[ah]:s.SRC_ALPHA_SATURATE,[rh]:s.DST_COLOR,[ih]:s.DST_ALPHA,[nh]:s.ONE_MINUS_SRC_COLOR,[Zr]:s.ONE_MINUS_SRC_ALPHA,[oh]:s.ONE_MINUS_DST_COLOR,[sh]:s.ONE_MINUS_DST_ALPHA,[lh]:s.CONSTANT_COLOR,[ch]:s.ONE_MINUS_CONSTANT_COLOR,[hh]:s.CONSTANT_ALPHA,[dh]:s.ONE_MINUS_CONSTANT_ALPHA};function P(F,le,X,Z,fe,de,Be,ft,Et,tt){if(F===En){_===!0&&(Ae(s.BLEND),_=!1);return}if(_===!1&&(ae(s.BLEND),_=!0),F!==Yc){if(F!==m||tt!==M){if((p!==Zn||y!==Zn)&&(s.blendEquation(s.FUNC_ADD),p=Zn,y=Zn),tt)switch(F){case Ci:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case $r:s.blendFunc(s.ONE,s.ONE);break;case Sa:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Ea:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case Ci:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case $r:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case Sa:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Ea:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}w=null,S=null,D=null,A=null,T.set(0,0,0),I=0,m=F,M=tt}return}fe=fe||le,de=de||X,Be=Be||Z,(le!==p||fe!==y)&&(s.blendEquationSeparate(Xe[le],Xe[fe]),p=le,y=fe),(X!==w||Z!==S||de!==D||Be!==A)&&(s.blendFuncSeparate(Le[X],Le[Z],Le[de],Le[Be]),w=X,S=Z,D=de,A=Be),(ft.equals(T)===!1||Et!==I)&&(s.blendColor(ft.r,ft.g,ft.b,Et),T.copy(ft),I=Et),m=F,M=!1}function gt(F,le){F.side===qt?Ae(s.CULL_FACE):ae(s.CULL_FACE);let X=F.side===Rt;le&&(X=!X),Ue(X),F.blending===Ci&&F.transparent===!1?P(En):P(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),o.setFunc(F.depthFunc),o.setTest(F.depthTest),o.setMask(F.depthWrite),r.setMask(F.colorWrite);const Z=F.stencilWrite;a.setTest(Z),Z&&(a.setMask(F.stencilWriteMask),a.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),a.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),$e(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?ae(s.SAMPLE_ALPHA_TO_COVERAGE):Ae(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ue(F){v!==F&&(F?s.frontFace(s.CW):s.frontFace(s.CCW),v=F)}function Ge(F){F!==qc?(ae(s.CULL_FACE),F!==C&&(F===wa?s.cullFace(s.BACK):F===jc?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):Ae(s.CULL_FACE),C=F}function Te(F){F!==G&&(k&&s.lineWidth(F),G=F)}function $e(F,le,X){F?(ae(s.POLYGON_OFFSET_FILL),(z!==le||q!==X)&&(s.polygonOffset(le,X),z=le,q=X)):Ae(s.POLYGON_OFFSET_FILL)}function Ee(F){F?ae(s.SCISSOR_TEST):Ae(s.SCISSOR_TEST)}function E(F){F===void 0&&(F=s.TEXTURE0+$-1),re!==F&&(s.activeTexture(F),re=F)}function x(F,le,X){X===void 0&&(re===null?X=s.TEXTURE0+$-1:X=re);let Z=ce[X];Z===void 0&&(Z={type:void 0,texture:void 0},ce[X]=Z),(Z.type!==F||Z.texture!==le)&&(re!==X&&(s.activeTexture(X),re=X),s.bindTexture(F,le||_e[F]),Z.type=F,Z.texture=le)}function O(){const F=ce[re];F!==void 0&&F.type!==void 0&&(s.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function K(){try{s.compressedTexImage2D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ee(){try{s.compressedTexImage3D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function J(){try{s.texSubImage2D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function we(){try{s.texSubImage3D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function he(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function pe(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ye(){try{s.texStorage2D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ne(){try{s.texStorage3D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function me(){try{s.texImage2D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Ce(){try{s.texImage3D.apply(s,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function Pe(F){et.equals(F)===!1&&(s.scissor(F.x,F.y,F.z,F.w),et.copy(F))}function ge(F){Y.equals(F)===!1&&(s.viewport(F.x,F.y,F.z,F.w),Y.copy(F))}function qe(F,le){let X=c.get(le);X===void 0&&(X=new WeakMap,c.set(le,X));let Z=X.get(F);Z===void 0&&(Z=s.getUniformBlockIndex(le,F.name),X.set(F,Z))}function He(F,le){const Z=c.get(le).get(F);l.get(le)!==Z&&(s.uniformBlockBinding(le,Z,F.__bindingPointIndex),l.set(le,Z))}function ot(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),o.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),h={},re=null,ce={},u={},d=new WeakMap,f=[],g=null,_=!1,m=null,p=null,w=null,S=null,y=null,D=null,A=null,T=new ve(0,0,0),I=0,M=!1,v=null,C=null,G=null,z=null,q=null,et.set(0,0,s.canvas.width,s.canvas.height),Y.set(0,0,s.canvas.width,s.canvas.height),r.reset(),o.reset(),a.reset()}return{buffers:{color:r,depth:o,stencil:a},enable:ae,disable:Ae,bindFramebuffer:Ie,drawBuffers:We,useProgram:lt,setBlending:P,setMaterial:gt,setFlipSided:Ue,setCullFace:Ge,setLineWidth:Te,setPolygonOffset:$e,setScissorTest:Ee,activeTexture:E,bindTexture:x,unbindTexture:O,compressedTexImage2D:K,compressedTexImage3D:ee,texImage2D:me,texImage3D:Ce,updateUBOMapping:qe,uniformBlockBinding:He,texStorage2D:Ye,texStorage3D:ne,texSubImage2D:J,texSubImage3D:we,compressedTexSubImage2D:he,compressedTexSubImage3D:pe,scissor:Pe,viewport:ge,reset:ot}}function xl(s,e,t,n){const i=I0(n);switch(t){case nc:return s*e;case sc:return s*e;case rc:return s*e*2;case oc:return s*e/i.components*i.byteLength;case Ko:return s*e/i.components*i.byteLength;case ac:return s*e*2/i.components*i.byteLength;case Zo:return s*e*2/i.components*i.byteLength;case ic:return s*e*3/i.components*i.byteLength;case nn:return s*e*4/i.components*i.byteLength;case Qo:return s*e*4/i.components*i.byteLength;case Xs:case qs:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*8;case js:case Ys:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case uo:case po:return Math.max(s,16)*Math.max(e,8)/4;case ho:case fo:return Math.max(s,8)*Math.max(e,8)/2;case mo:case go:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*8;case _o:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case vo:return Math.floor((s+3)/4)*Math.floor((e+3)/4)*16;case xo:return Math.floor((s+4)/5)*Math.floor((e+3)/4)*16;case yo:return Math.floor((s+4)/5)*Math.floor((e+4)/5)*16;case Mo:return Math.floor((s+5)/6)*Math.floor((e+4)/5)*16;case bo:return Math.floor((s+5)/6)*Math.floor((e+5)/6)*16;case wo:return Math.floor((s+7)/8)*Math.floor((e+4)/5)*16;case So:return Math.floor((s+7)/8)*Math.floor((e+5)/6)*16;case Eo:return Math.floor((s+7)/8)*Math.floor((e+7)/8)*16;case To:return Math.floor((s+9)/10)*Math.floor((e+4)/5)*16;case Ao:return Math.floor((s+9)/10)*Math.floor((e+5)/6)*16;case Co:return Math.floor((s+9)/10)*Math.floor((e+7)/8)*16;case Ro:return Math.floor((s+9)/10)*Math.floor((e+9)/10)*16;case Po:return Math.floor((s+11)/12)*Math.floor((e+9)/10)*16;case Io:return Math.floor((s+11)/12)*Math.floor((e+11)/12)*16;case Js:case Do:case Lo:return Math.ceil(s/4)*Math.ceil(e/4)*16;case lc:case Fo:return Math.ceil(s/4)*Math.ceil(e/4)*8;case Uo:case Bo:return Math.ceil(s/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function I0(s){switch(s){case Cn:case Ql:return{byteLength:1,components:1};case ds:case ec:case Tn:return{byteLength:2,components:1};case Jo:case $o:return{byteLength:2,components:4};case ri:case Yo:case wn:return{byteLength:4,components:1};case tc:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${s}.`)}function D0(s,e,t,n,i,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Re,h=new WeakMap;let u;const d=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(E,x){return f?new OffscreenCanvas(E,x):tr("canvas")}function _(E,x,O){let K=1;const ee=Ee(E);if((ee.width>O||ee.height>O)&&(K=O/Math.max(ee.width,ee.height)),K<1)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap||typeof VideoFrame<"u"&&E instanceof VideoFrame){const J=Math.floor(K*ee.width),we=Math.floor(K*ee.height);u===void 0&&(u=g(J,we));const he=x?g(J,we):u;return he.width=J,he.height=we,he.getContext("2d").drawImage(E,0,0,J,we),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+J+"x"+we+")."),he}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),E;return E}function m(E){return E.generateMipmaps}function p(E){s.generateMipmap(E)}function w(E){return E.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:E.isWebGL3DRenderTarget?s.TEXTURE_3D:E.isWebGLArrayRenderTarget||E.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function S(E,x,O,K,ee=!1){if(E!==null){if(s[E]!==void 0)return s[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let J=x;if(x===s.RED&&(O===s.FLOAT&&(J=s.R32F),O===s.HALF_FLOAT&&(J=s.R16F),O===s.UNSIGNED_BYTE&&(J=s.R8)),x===s.RED_INTEGER&&(O===s.UNSIGNED_BYTE&&(J=s.R8UI),O===s.UNSIGNED_SHORT&&(J=s.R16UI),O===s.UNSIGNED_INT&&(J=s.R32UI),O===s.BYTE&&(J=s.R8I),O===s.SHORT&&(J=s.R16I),O===s.INT&&(J=s.R32I)),x===s.RG&&(O===s.FLOAT&&(J=s.RG32F),O===s.HALF_FLOAT&&(J=s.RG16F),O===s.UNSIGNED_BYTE&&(J=s.RG8)),x===s.RG_INTEGER&&(O===s.UNSIGNED_BYTE&&(J=s.RG8UI),O===s.UNSIGNED_SHORT&&(J=s.RG16UI),O===s.UNSIGNED_INT&&(J=s.RG32UI),O===s.BYTE&&(J=s.RG8I),O===s.SHORT&&(J=s.RG16I),O===s.INT&&(J=s.RG32I)),x===s.RGB_INTEGER&&(O===s.UNSIGNED_BYTE&&(J=s.RGB8UI),O===s.UNSIGNED_SHORT&&(J=s.RGB16UI),O===s.UNSIGNED_INT&&(J=s.RGB32UI),O===s.BYTE&&(J=s.RGB8I),O===s.SHORT&&(J=s.RGB16I),O===s.INT&&(J=s.RGB32I)),x===s.RGBA_INTEGER&&(O===s.UNSIGNED_BYTE&&(J=s.RGBA8UI),O===s.UNSIGNED_SHORT&&(J=s.RGBA16UI),O===s.UNSIGNED_INT&&(J=s.RGBA32UI),O===s.BYTE&&(J=s.RGBA8I),O===s.SHORT&&(J=s.RGBA16I),O===s.INT&&(J=s.RGBA32I)),x===s.RGB&&O===s.UNSIGNED_INT_5_9_9_9_REV&&(J=s.RGB9_E5),x===s.RGBA){const we=ee?cr:je.getTransfer(K);O===s.FLOAT&&(J=s.RGBA32F),O===s.HALF_FLOAT&&(J=s.RGBA16F),O===s.UNSIGNED_BYTE&&(J=we===nt?s.SRGB8_ALPHA8:s.RGBA8),O===s.UNSIGNED_SHORT_4_4_4_4&&(J=s.RGBA4),O===s.UNSIGNED_SHORT_5_5_5_1&&(J=s.RGB5_A1)}return(J===s.R16F||J===s.R32F||J===s.RG16F||J===s.RG32F||J===s.RGBA16F||J===s.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function y(E,x){let O;return E?x===null||x===ri||x===Fi?O=s.DEPTH24_STENCIL8:x===wn?O=s.DEPTH32F_STENCIL8:x===ds&&(O=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===ri||x===Fi?O=s.DEPTH_COMPONENT24:x===wn?O=s.DEPTH_COMPONENT32F:x===ds&&(O=s.DEPTH_COMPONENT16),O}function D(E,x){return m(E)===!0||E.isFramebufferTexture&&E.minFilter!==sn&&E.minFilter!==dn?Math.log2(Math.max(x.width,x.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?x.mipmaps.length:1}function A(E){const x=E.target;x.removeEventListener("dispose",A),I(x),x.isVideoTexture&&h.delete(x)}function T(E){const x=E.target;x.removeEventListener("dispose",T),v(x)}function I(E){const x=n.get(E);if(x.__webglInit===void 0)return;const O=E.source,K=d.get(O);if(K){const ee=K[x.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&M(E),Object.keys(K).length===0&&d.delete(O)}n.remove(E)}function M(E){const x=n.get(E);s.deleteTexture(x.__webglTexture);const O=E.source,K=d.get(O);delete K[x.__cacheKey],o.memory.textures--}function v(E){const x=n.get(E);if(E.depthTexture&&(E.depthTexture.dispose(),n.remove(E.depthTexture)),E.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(x.__webglFramebuffer[K]))for(let ee=0;ee<x.__webglFramebuffer[K].length;ee++)s.deleteFramebuffer(x.__webglFramebuffer[K][ee]);else s.deleteFramebuffer(x.__webglFramebuffer[K]);x.__webglDepthbuffer&&s.deleteRenderbuffer(x.__webglDepthbuffer[K])}else{if(Array.isArray(x.__webglFramebuffer))for(let K=0;K<x.__webglFramebuffer.length;K++)s.deleteFramebuffer(x.__webglFramebuffer[K]);else s.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&s.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&s.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let K=0;K<x.__webglColorRenderbuffer.length;K++)x.__webglColorRenderbuffer[K]&&s.deleteRenderbuffer(x.__webglColorRenderbuffer[K]);x.__webglDepthRenderbuffer&&s.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const O=E.textures;for(let K=0,ee=O.length;K<ee;K++){const J=n.get(O[K]);J.__webglTexture&&(s.deleteTexture(J.__webglTexture),o.memory.textures--),n.remove(O[K])}n.remove(E)}let C=0;function G(){C=0}function z(){const E=C;return E>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+i.maxTextures),C+=1,E}function q(E){const x=[];return x.push(E.wrapS),x.push(E.wrapT),x.push(E.wrapR||0),x.push(E.magFilter),x.push(E.minFilter),x.push(E.anisotropy),x.push(E.internalFormat),x.push(E.format),x.push(E.type),x.push(E.generateMipmaps),x.push(E.premultiplyAlpha),x.push(E.flipY),x.push(E.unpackAlignment),x.push(E.colorSpace),x.join()}function $(E,x){const O=n.get(E);if(E.isVideoTexture&&Te(E),E.isRenderTargetTexture===!1&&E.version>0&&O.__version!==E.version){const K=E.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Y(O,E,x);return}}t.bindTexture(s.TEXTURE_2D,O.__webglTexture,s.TEXTURE0+x)}function k(E,x){const O=n.get(E);if(E.version>0&&O.__version!==E.version){Y(O,E,x);return}t.bindTexture(s.TEXTURE_2D_ARRAY,O.__webglTexture,s.TEXTURE0+x)}function j(E,x){const O=n.get(E);if(E.version>0&&O.__version!==E.version){Y(O,E,x);return}t.bindTexture(s.TEXTURE_3D,O.__webglTexture,s.TEXTURE0+x)}function W(E,x){const O=n.get(E);if(E.version>0&&O.__version!==E.version){ie(O,E,x);return}t.bindTexture(s.TEXTURE_CUBE_MAP,O.__webglTexture,s.TEXTURE0+x)}const re={[lo]:s.REPEAT,[ti]:s.CLAMP_TO_EDGE,[co]:s.MIRRORED_REPEAT},ce={[sn]:s.NEAREST,[mh]:s.NEAREST_MIPMAP_NEAREST,[xs]:s.NEAREST_MIPMAP_LINEAR,[dn]:s.LINEAR,[pr]:s.LINEAR_MIPMAP_NEAREST,[ni]:s.LINEAR_MIPMAP_LINEAR},xe={[wh]:s.NEVER,[Rh]:s.ALWAYS,[Sh]:s.LESS,[hc]:s.LEQUAL,[Eh]:s.EQUAL,[Ch]:s.GEQUAL,[Th]:s.GREATER,[Ah]:s.NOTEQUAL};function ze(E,x){if(x.type===wn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===dn||x.magFilter===pr||x.magFilter===xs||x.magFilter===ni||x.minFilter===dn||x.minFilter===pr||x.minFilter===xs||x.minFilter===ni)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(E,s.TEXTURE_WRAP_S,re[x.wrapS]),s.texParameteri(E,s.TEXTURE_WRAP_T,re[x.wrapT]),(E===s.TEXTURE_3D||E===s.TEXTURE_2D_ARRAY)&&s.texParameteri(E,s.TEXTURE_WRAP_R,re[x.wrapR]),s.texParameteri(E,s.TEXTURE_MAG_FILTER,ce[x.magFilter]),s.texParameteri(E,s.TEXTURE_MIN_FILTER,ce[x.minFilter]),x.compareFunction&&(s.texParameteri(E,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(E,s.TEXTURE_COMPARE_FUNC,xe[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===sn||x.minFilter!==xs&&x.minFilter!==ni||x.type===wn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");s.texParameterf(E,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,i.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function et(E,x){let O=!1;E.__webglInit===void 0&&(E.__webglInit=!0,x.addEventListener("dispose",A));const K=x.source;let ee=d.get(K);ee===void 0&&(ee={},d.set(K,ee));const J=q(x);if(J!==E.__cacheKey){ee[J]===void 0&&(ee[J]={texture:s.createTexture(),usedTimes:0},o.memory.textures++,O=!0),ee[J].usedTimes++;const we=ee[E.__cacheKey];we!==void 0&&(ee[E.__cacheKey].usedTimes--,we.usedTimes===0&&M(x)),E.__cacheKey=J,E.__webglTexture=ee[J].texture}return O}function Y(E,x,O){let K=s.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(K=s.TEXTURE_2D_ARRAY),x.isData3DTexture&&(K=s.TEXTURE_3D);const ee=et(E,x),J=x.source;t.bindTexture(K,E.__webglTexture,s.TEXTURE0+O);const we=n.get(J);if(J.version!==we.__version||ee===!0){t.activeTexture(s.TEXTURE0+O);const he=je.getPrimaries(je.workingColorSpace),pe=x.colorSpace===kn?null:je.getPrimaries(x.colorSpace),Ye=x.colorSpace===kn||he===pe?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,x.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,x.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ye);let ne=_(x.image,!1,i.maxTextureSize);ne=$e(x,ne);const me=r.convert(x.format,x.colorSpace),Ce=r.convert(x.type);let Pe=S(x.internalFormat,me,Ce,x.colorSpace,x.isVideoTexture);ze(K,x);let ge;const qe=x.mipmaps,He=x.isVideoTexture!==!0,ot=we.__version===void 0||ee===!0,F=J.dataReady,le=D(x,ne);if(x.isDepthTexture)Pe=y(x.format===Ui,x.type),ot&&(He?t.texStorage2D(s.TEXTURE_2D,1,Pe,ne.width,ne.height):t.texImage2D(s.TEXTURE_2D,0,Pe,ne.width,ne.height,0,me,Ce,null));else if(x.isDataTexture)if(qe.length>0){He&&ot&&t.texStorage2D(s.TEXTURE_2D,le,Pe,qe[0].width,qe[0].height);for(let X=0,Z=qe.length;X<Z;X++)ge=qe[X],He?F&&t.texSubImage2D(s.TEXTURE_2D,X,0,0,ge.width,ge.height,me,Ce,ge.data):t.texImage2D(s.TEXTURE_2D,X,Pe,ge.width,ge.height,0,me,Ce,ge.data);x.generateMipmaps=!1}else He?(ot&&t.texStorage2D(s.TEXTURE_2D,le,Pe,ne.width,ne.height),F&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,ne.width,ne.height,me,Ce,ne.data)):t.texImage2D(s.TEXTURE_2D,0,Pe,ne.width,ne.height,0,me,Ce,ne.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){He&&ot&&t.texStorage3D(s.TEXTURE_2D_ARRAY,le,Pe,qe[0].width,qe[0].height,ne.depth);for(let X=0,Z=qe.length;X<Z;X++)if(ge=qe[X],x.format!==nn)if(me!==null)if(He){if(F)if(x.layerUpdates.size>0){const fe=xl(ge.width,ge.height,x.format,x.type);for(const de of x.layerUpdates){const Be=ge.data.subarray(de*fe/ge.data.BYTES_PER_ELEMENT,(de+1)*fe/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,X,0,0,de,ge.width,ge.height,1,me,Be)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,X,0,0,0,ge.width,ge.height,ne.depth,me,ge.data)}else t.compressedTexImage3D(s.TEXTURE_2D_ARRAY,X,Pe,ge.width,ge.height,ne.depth,0,ge.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else He?F&&t.texSubImage3D(s.TEXTURE_2D_ARRAY,X,0,0,0,ge.width,ge.height,ne.depth,me,Ce,ge.data):t.texImage3D(s.TEXTURE_2D_ARRAY,X,Pe,ge.width,ge.height,ne.depth,0,me,Ce,ge.data)}else{He&&ot&&t.texStorage2D(s.TEXTURE_2D,le,Pe,qe[0].width,qe[0].height);for(let X=0,Z=qe.length;X<Z;X++)ge=qe[X],x.format!==nn?me!==null?He?F&&t.compressedTexSubImage2D(s.TEXTURE_2D,X,0,0,ge.width,ge.height,me,ge.data):t.compressedTexImage2D(s.TEXTURE_2D,X,Pe,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):He?F&&t.texSubImage2D(s.TEXTURE_2D,X,0,0,ge.width,ge.height,me,Ce,ge.data):t.texImage2D(s.TEXTURE_2D,X,Pe,ge.width,ge.height,0,me,Ce,ge.data)}else if(x.isDataArrayTexture)if(He){if(ot&&t.texStorage3D(s.TEXTURE_2D_ARRAY,le,Pe,ne.width,ne.height,ne.depth),F)if(x.layerUpdates.size>0){const X=xl(ne.width,ne.height,x.format,x.type);for(const Z of x.layerUpdates){const fe=ne.data.subarray(Z*X/ne.data.BYTES_PER_ELEMENT,(Z+1)*X/ne.data.BYTES_PER_ELEMENT);t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,Z,ne.width,ne.height,1,me,Ce,fe)}x.clearLayerUpdates()}else t.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,me,Ce,ne.data)}else t.texImage3D(s.TEXTURE_2D_ARRAY,0,Pe,ne.width,ne.height,ne.depth,0,me,Ce,ne.data);else if(x.isData3DTexture)He?(ot&&t.texStorage3D(s.TEXTURE_3D,le,Pe,ne.width,ne.height,ne.depth),F&&t.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,me,Ce,ne.data)):t.texImage3D(s.TEXTURE_3D,0,Pe,ne.width,ne.height,ne.depth,0,me,Ce,ne.data);else if(x.isFramebufferTexture){if(ot)if(He)t.texStorage2D(s.TEXTURE_2D,le,Pe,ne.width,ne.height);else{let X=ne.width,Z=ne.height;for(let fe=0;fe<le;fe++)t.texImage2D(s.TEXTURE_2D,fe,Pe,X,Z,0,me,Ce,null),X>>=1,Z>>=1}}else if(qe.length>0){if(He&&ot){const X=Ee(qe[0]);t.texStorage2D(s.TEXTURE_2D,le,Pe,X.width,X.height)}for(let X=0,Z=qe.length;X<Z;X++)ge=qe[X],He?F&&t.texSubImage2D(s.TEXTURE_2D,X,0,0,me,Ce,ge):t.texImage2D(s.TEXTURE_2D,X,Pe,me,Ce,ge);x.generateMipmaps=!1}else if(He){if(ot){const X=Ee(ne);t.texStorage2D(s.TEXTURE_2D,le,Pe,X.width,X.height)}F&&t.texSubImage2D(s.TEXTURE_2D,0,0,0,me,Ce,ne)}else t.texImage2D(s.TEXTURE_2D,0,Pe,me,Ce,ne);m(x)&&p(K),we.__version=J.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function ie(E,x,O){if(x.image.length!==6)return;const K=et(E,x),ee=x.source;t.bindTexture(s.TEXTURE_CUBE_MAP,E.__webglTexture,s.TEXTURE0+O);const J=n.get(ee);if(ee.version!==J.__version||K===!0){t.activeTexture(s.TEXTURE0+O);const we=je.getPrimaries(je.workingColorSpace),he=x.colorSpace===kn?null:je.getPrimaries(x.colorSpace),pe=x.colorSpace===kn||we===he?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,x.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,x.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,pe);const Ye=x.isCompressedTexture||x.image[0].isCompressedTexture,ne=x.image[0]&&x.image[0].isDataTexture,me=[];for(let Z=0;Z<6;Z++)!Ye&&!ne?me[Z]=_(x.image[Z],!0,i.maxCubemapSize):me[Z]=ne?x.image[Z].image:x.image[Z],me[Z]=$e(x,me[Z]);const Ce=me[0],Pe=r.convert(x.format,x.colorSpace),ge=r.convert(x.type),qe=S(x.internalFormat,Pe,ge,x.colorSpace),He=x.isVideoTexture!==!0,ot=J.__version===void 0||K===!0,F=ee.dataReady;let le=D(x,Ce);ze(s.TEXTURE_CUBE_MAP,x);let X;if(Ye){He&&ot&&t.texStorage2D(s.TEXTURE_CUBE_MAP,le,qe,Ce.width,Ce.height);for(let Z=0;Z<6;Z++){X=me[Z].mipmaps;for(let fe=0;fe<X.length;fe++){const de=X[fe];x.format!==nn?Pe!==null?He?F&&t.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,fe,0,0,de.width,de.height,Pe,de.data):t.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,fe,qe,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):He?F&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,fe,0,0,de.width,de.height,Pe,ge,de.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,fe,qe,de.width,de.height,0,Pe,ge,de.data)}}}else{if(X=x.mipmaps,He&&ot){X.length>0&&le++;const Z=Ee(me[0]);t.texStorage2D(s.TEXTURE_CUBE_MAP,le,qe,Z.width,Z.height)}for(let Z=0;Z<6;Z++)if(ne){He?F&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,me[Z].width,me[Z].height,Pe,ge,me[Z].data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,qe,me[Z].width,me[Z].height,0,Pe,ge,me[Z].data);for(let fe=0;fe<X.length;fe++){const Be=X[fe].image[Z].image;He?F&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,fe+1,0,0,Be.width,Be.height,Pe,ge,Be.data):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,fe+1,qe,Be.width,Be.height,0,Pe,ge,Be.data)}}else{He?F&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,0,0,Pe,ge,me[Z]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,0,qe,Pe,ge,me[Z]);for(let fe=0;fe<X.length;fe++){const de=X[fe];He?F&&t.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,fe+1,0,0,Pe,ge,de.image[Z]):t.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+Z,fe+1,qe,Pe,ge,de.image[Z])}}}m(x)&&p(s.TEXTURE_CUBE_MAP),J.__version=ee.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function _e(E,x,O,K,ee,J){const we=r.convert(O.format,O.colorSpace),he=r.convert(O.type),pe=S(O.internalFormat,we,he,O.colorSpace),Ye=n.get(x),ne=n.get(O);if(ne.__renderTarget=x,!Ye.__hasExternalTextures){const me=Math.max(1,x.width>>J),Ce=Math.max(1,x.height>>J);ee===s.TEXTURE_3D||ee===s.TEXTURE_2D_ARRAY?t.texImage3D(ee,J,pe,me,Ce,x.depth,0,we,he,null):t.texImage2D(ee,J,pe,me,Ce,0,we,he,null)}t.bindFramebuffer(s.FRAMEBUFFER,E),Ge(x)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,K,ee,ne.__webglTexture,0,Ue(x)):(ee===s.TEXTURE_2D||ee>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,K,ee,ne.__webglTexture,J),t.bindFramebuffer(s.FRAMEBUFFER,null)}function ae(E,x,O){if(s.bindRenderbuffer(s.RENDERBUFFER,E),x.depthBuffer){const K=x.depthTexture,ee=K&&K.isDepthTexture?K.type:null,J=y(x.stencilBuffer,ee),we=x.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,he=Ue(x);Ge(x)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,he,J,x.width,x.height):O?s.renderbufferStorageMultisample(s.RENDERBUFFER,he,J,x.width,x.height):s.renderbufferStorage(s.RENDERBUFFER,J,x.width,x.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,we,s.RENDERBUFFER,E)}else{const K=x.textures;for(let ee=0;ee<K.length;ee++){const J=K[ee],we=r.convert(J.format,J.colorSpace),he=r.convert(J.type),pe=S(J.internalFormat,we,he,J.colorSpace),Ye=Ue(x);O&&Ge(x)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ye,pe,x.width,x.height):Ge(x)?a.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ye,pe,x.width,x.height):s.renderbufferStorage(s.RENDERBUFFER,pe,x.width,x.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function Ae(E,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(s.FRAMEBUFFER,E),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(x.depthTexture);K.__renderTarget=x,(!K.__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),$(x.depthTexture,0);const ee=K.__webglTexture,J=Ue(x);if(x.depthTexture.format===Ri)Ge(x)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,ee,0,J):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,ee,0);else if(x.depthTexture.format===Ui)Ge(x)?a.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,ee,0,J):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function Ie(E){const x=n.get(E),O=E.isWebGLCubeRenderTarget===!0;if(x.__boundDepthTexture!==E.depthTexture){const K=E.depthTexture;if(x.__depthDisposeCallback&&x.__depthDisposeCallback(),K){const ee=()=>{delete x.__boundDepthTexture,delete x.__depthDisposeCallback,K.removeEventListener("dispose",ee)};K.addEventListener("dispose",ee),x.__depthDisposeCallback=ee}x.__boundDepthTexture=K}if(E.depthTexture&&!x.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");Ae(x.__webglFramebuffer,E)}else if(O){x.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer[K]),x.__webglDepthbuffer[K]===void 0)x.__webglDepthbuffer[K]=s.createRenderbuffer(),ae(x.__webglDepthbuffer[K],E,!1);else{const ee=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,J=x.__webglDepthbuffer[K];s.bindRenderbuffer(s.RENDERBUFFER,J),s.framebufferRenderbuffer(s.FRAMEBUFFER,ee,s.RENDERBUFFER,J)}}else if(t.bindFramebuffer(s.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer===void 0)x.__webglDepthbuffer=s.createRenderbuffer(),ae(x.__webglDepthbuffer,E,!1);else{const K=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,ee=x.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,ee),s.framebufferRenderbuffer(s.FRAMEBUFFER,K,s.RENDERBUFFER,ee)}t.bindFramebuffer(s.FRAMEBUFFER,null)}function We(E,x,O){const K=n.get(E);x!==void 0&&_e(K.__webglFramebuffer,E,E.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),O!==void 0&&Ie(E)}function lt(E){const x=E.texture,O=n.get(E),K=n.get(x);E.addEventListener("dispose",T);const ee=E.textures,J=E.isWebGLCubeRenderTarget===!0,we=ee.length>1;if(we||(K.__webglTexture===void 0&&(K.__webglTexture=s.createTexture()),K.__version=x.version,o.memory.textures++),J){O.__webglFramebuffer=[];for(let he=0;he<6;he++)if(x.mipmaps&&x.mipmaps.length>0){O.__webglFramebuffer[he]=[];for(let pe=0;pe<x.mipmaps.length;pe++)O.__webglFramebuffer[he][pe]=s.createFramebuffer()}else O.__webglFramebuffer[he]=s.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){O.__webglFramebuffer=[];for(let he=0;he<x.mipmaps.length;he++)O.__webglFramebuffer[he]=s.createFramebuffer()}else O.__webglFramebuffer=s.createFramebuffer();if(we)for(let he=0,pe=ee.length;he<pe;he++){const Ye=n.get(ee[he]);Ye.__webglTexture===void 0&&(Ye.__webglTexture=s.createTexture(),o.memory.textures++)}if(E.samples>0&&Ge(E)===!1){O.__webglMultisampledFramebuffer=s.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(s.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let he=0;he<ee.length;he++){const pe=ee[he];O.__webglColorRenderbuffer[he]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,O.__webglColorRenderbuffer[he]);const Ye=r.convert(pe.format,pe.colorSpace),ne=r.convert(pe.type),me=S(pe.internalFormat,Ye,ne,pe.colorSpace,E.isXRRenderTarget===!0),Ce=Ue(E);s.renderbufferStorageMultisample(s.RENDERBUFFER,Ce,me,E.width,E.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+he,s.RENDERBUFFER,O.__webglColorRenderbuffer[he])}s.bindRenderbuffer(s.RENDERBUFFER,null),E.depthBuffer&&(O.__webglDepthRenderbuffer=s.createRenderbuffer(),ae(O.__webglDepthRenderbuffer,E,!0)),t.bindFramebuffer(s.FRAMEBUFFER,null)}}if(J){t.bindTexture(s.TEXTURE_CUBE_MAP,K.__webglTexture),ze(s.TEXTURE_CUBE_MAP,x);for(let he=0;he<6;he++)if(x.mipmaps&&x.mipmaps.length>0)for(let pe=0;pe<x.mipmaps.length;pe++)_e(O.__webglFramebuffer[he][pe],E,x,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+he,pe);else _e(O.__webglFramebuffer[he],E,x,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+he,0);m(x)&&p(s.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(we){for(let he=0,pe=ee.length;he<pe;he++){const Ye=ee[he],ne=n.get(Ye);t.bindTexture(s.TEXTURE_2D,ne.__webglTexture),ze(s.TEXTURE_2D,Ye),_e(O.__webglFramebuffer,E,Ye,s.COLOR_ATTACHMENT0+he,s.TEXTURE_2D,0),m(Ye)&&p(s.TEXTURE_2D)}t.unbindTexture()}else{let he=s.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(he=E.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),t.bindTexture(he,K.__webglTexture),ze(he,x),x.mipmaps&&x.mipmaps.length>0)for(let pe=0;pe<x.mipmaps.length;pe++)_e(O.__webglFramebuffer[pe],E,x,s.COLOR_ATTACHMENT0,he,pe);else _e(O.__webglFramebuffer,E,x,s.COLOR_ATTACHMENT0,he,0);m(x)&&p(he),t.unbindTexture()}E.depthBuffer&&Ie(E)}function Xe(E){const x=E.textures;for(let O=0,K=x.length;O<K;O++){const ee=x[O];if(m(ee)){const J=w(E),we=n.get(ee).__webglTexture;t.bindTexture(J,we),p(J),t.unbindTexture()}}}const Le=[],P=[];function gt(E){if(E.samples>0){if(Ge(E)===!1){const x=E.textures,O=E.width,K=E.height;let ee=s.COLOR_BUFFER_BIT;const J=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,we=n.get(E),he=x.length>1;if(he)for(let pe=0;pe<x.length;pe++)t.bindFramebuffer(s.FRAMEBUFFER,we.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+pe,s.RENDERBUFFER,null),t.bindFramebuffer(s.FRAMEBUFFER,we.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+pe,s.TEXTURE_2D,null,0);t.bindFramebuffer(s.READ_FRAMEBUFFER,we.__webglMultisampledFramebuffer),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,we.__webglFramebuffer);for(let pe=0;pe<x.length;pe++){if(E.resolveDepthBuffer&&(E.depthBuffer&&(ee|=s.DEPTH_BUFFER_BIT),E.stencilBuffer&&E.resolveStencilBuffer&&(ee|=s.STENCIL_BUFFER_BIT)),he){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,we.__webglColorRenderbuffer[pe]);const Ye=n.get(x[pe]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Ye,0)}s.blitFramebuffer(0,0,O,K,0,0,O,K,ee,s.NEAREST),l===!0&&(Le.length=0,P.length=0,Le.push(s.COLOR_ATTACHMENT0+pe),E.depthBuffer&&E.resolveDepthBuffer===!1&&(Le.push(J),P.push(J),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,P)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Le))}if(t.bindFramebuffer(s.READ_FRAMEBUFFER,null),t.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),he)for(let pe=0;pe<x.length;pe++){t.bindFramebuffer(s.FRAMEBUFFER,we.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+pe,s.RENDERBUFFER,we.__webglColorRenderbuffer[pe]);const Ye=n.get(x[pe]).__webglTexture;t.bindFramebuffer(s.FRAMEBUFFER,we.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+pe,s.TEXTURE_2D,Ye,0)}t.bindFramebuffer(s.DRAW_FRAMEBUFFER,we.__webglMultisampledFramebuffer)}else if(E.depthBuffer&&E.resolveDepthBuffer===!1&&l){const x=E.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[x])}}}function Ue(E){return Math.min(i.maxSamples,E.samples)}function Ge(E){const x=n.get(E);return E.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function Te(E){const x=o.render.frame;h.get(E)!==x&&(h.set(E,x),E.update())}function $e(E,x){const O=E.colorSpace,K=E.format,ee=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||O!==Oi&&O!==kn&&(je.getTransfer(O)===nt?(K!==nn||ee!==Cn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),x}function Ee(E){return typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement?(c.width=E.naturalWidth||E.width,c.height=E.naturalHeight||E.height):typeof VideoFrame<"u"&&E instanceof VideoFrame?(c.width=E.displayWidth,c.height=E.displayHeight):(c.width=E.width,c.height=E.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=G,this.setTexture2D=$,this.setTexture2DArray=k,this.setTexture3D=j,this.setTextureCube=W,this.rebindTextures=We,this.setupRenderTarget=lt,this.updateRenderTargetMipmap=Xe,this.updateMultisampleRenderTarget=gt,this.setupDepthRenderbuffer=Ie,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=Ge}function L0(s,e){function t(n,i=kn){let r;const o=je.getTransfer(i);if(n===Cn)return s.UNSIGNED_BYTE;if(n===Jo)return s.UNSIGNED_SHORT_4_4_4_4;if(n===$o)return s.UNSIGNED_SHORT_5_5_5_1;if(n===tc)return s.UNSIGNED_INT_5_9_9_9_REV;if(n===Ql)return s.BYTE;if(n===ec)return s.SHORT;if(n===ds)return s.UNSIGNED_SHORT;if(n===Yo)return s.INT;if(n===ri)return s.UNSIGNED_INT;if(n===wn)return s.FLOAT;if(n===Tn)return s.HALF_FLOAT;if(n===nc)return s.ALPHA;if(n===ic)return s.RGB;if(n===nn)return s.RGBA;if(n===sc)return s.LUMINANCE;if(n===rc)return s.LUMINANCE_ALPHA;if(n===Ri)return s.DEPTH_COMPONENT;if(n===Ui)return s.DEPTH_STENCIL;if(n===oc)return s.RED;if(n===Ko)return s.RED_INTEGER;if(n===ac)return s.RG;if(n===Zo)return s.RG_INTEGER;if(n===Qo)return s.RGBA_INTEGER;if(n===Xs||n===qs||n===js||n===Ys)if(o===nt)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===Xs)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===qs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Ys)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===Xs)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===qs)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===js)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Ys)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ho||n===uo||n===fo||n===po)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===ho)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===uo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===fo)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===po)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===mo||n===go||n===_o)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===mo||n===go)return o===nt?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===_o)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===vo||n===xo||n===yo||n===Mo||n===bo||n===wo||n===So||n===Eo||n===To||n===Ao||n===Co||n===Ro||n===Po||n===Io)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===vo)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===xo)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===yo)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Mo)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===bo)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===wo)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===So)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Eo)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===To)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ao)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Co)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Ro)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Po)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Io)return o===nt?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Js||n===Do||n===Lo)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===Js)return o===nt?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Do)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Lo)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===lc||n===Fo||n===Uo||n===Bo)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===Js)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Fo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Uo)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Bo)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Fi?s.UNSIGNED_INT_24_8:s[n]!==void 0?s[n]:null}return{convert:t}}class F0 extends Nt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Fe extends xt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const U0={type:"move"};class Wr{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Fe,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Fe,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new L,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new L),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Fe,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new L,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new L),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let i=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,n),p=this._getHandJoint(c,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const h=c.joints["index-finger-tip"],u=c.joints["thumb-tip"],d=h.position.distanceTo(u.position),f=.02,g=.005;c.inputState.pinching&&d>f+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&d<=f-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(i=t.getPose(e.targetRaySpace,n),i===null&&r!==null&&(i=r),i!==null&&(a.matrix.fromArray(i.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,i.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(i.linearVelocity)):a.hasLinearVelocity=!1,i.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(i.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(U0)))}return a!==null&&(a.visible=i!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Fe;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const B0=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Ni.BlurDirectionX=new Re(1,0);Ni.BlurDirectionY=new Re(0,1);const Sm={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
    ...
    `,n.textContent="GAS",document.body.appendChild(n),n.addEventListener("touchstart",r=>{r.preventDefault(),this.accelerating=!0,n.style.background="rgba(50, 200, 50, 0.9)"},{passive:!1}),n.addEventListener("touchend",r=>{r.preventDefault(),this.accelerating=!1,n.style.background="rgba(50, 200, 50, 0.6)"},{passive:!1});const i=document.createElement("div");i.style.cssText=`
      ...
      touch-action: none;
      user-select: none;
    `,i.textContent="📯",document.body.appendChild(i),i.addEventListener("touchstart",r=>{r.preventDefault(),this.triggerHorn(),i.style.background="rgba(255, 200, 50, 0.95)",i.style.transform="scale(1.1)"},{passive:!1}),i.addEventListener("touchend",r=>{r.preventDefault(),i.style.background="rgba(255, 200, 50, 0.6)",i.style.transform="scale(1.0)"},{passive:!1})}get forward(){return this.keys.ArrowUp||this.keys.KeyW||this.accelerating}get backward(){return this.keys.ArrowDown||this.keys.KeyS}get left(){return this.keys.ArrowLeft||this.keys.KeyA||this.steerAxis<-.2}get right(){return this.keys.ArrowRight||this.keys.KeyD||this.steerAxis>.2}get brake(){return this.keys.Space||this.braking}get honk(){return this.horn}}class $m{constructor(){R(this,"level",0);R(this,"spillRateMultiplier",1);R(this,"onSpill");R(this,"container");R(this,"fill");R(this,"bucketEl");R(this,"isShaking",!1);R(this,"spillFlashing",!1);if(!document.getElementById("spill-meter-styles")){const i=document.createElement("style");i.id="spill-meter-styles",i.textContent=`
    ...
    `;const t=document.createElement("div");t.textContent="📋 JOBS AVAILABLE",t.style.cssText=`
      ...
      font-weight: 900;
      letter-spacing: 1px;
    `,e.appendChild(t);const n=document.createElement("button");if(n.className="jb-close-btn",n.textContent="✕",n.setAttribute("aria-label","Close"),n.addEventListener("click",()=>this.hide()),e.appendChild(n),this.overlay.appendChild(e),this.jobs.length===0){const i=document.createElement("div");i.className="jb-no-jobs",i.textContent="You've smashed all the jobs, legend. 🏆",this.overlay.appendChild(i);return}for(const i of this.jobs){const r=document.createElement("div");r.className="jb-card";const o=document.createElement("div");o.className="jb-card-header";const a=document.createElement("div");a.className="jb-title",a.textContent=i.title,o.appendChild(a);const l=document.createElement("div");l.className="jb-pay",l.textContent=`₿ ${Zm(i.pay)}`,o.appendChild(l),r.appendChild(o);const c=document.createElement("div");c.className="jb-meta";const h=document.createElement("span");h.className="jb-badge",h.textContent=Qm[i.zone]??i.zone,c.appendChild(h);const u=document.createElement("span");if(u.className=`jb-badge${i.type==="emergency"?" jb-emergency-badge":""}`,u.textContent=eg[i.type]??i.type,c.appendChild(u),i.timeLimit>0){const _=document.createElement("span");_.className="jb-badge jb-emergency-badge",_.textContent=`⏱️ ${Math.round(i.timeLimit/60)} min limit`,c.appendChild(_)}r.appendChild(c);const d=document.createElement("div");d.className="jb-client",d.textContent=`Client: ${i.client}`,r.appendChild(d);const f=document.createElement("div");f.className="jb-desc",f.textContent=i.description,r.appendChild(f);const g=document.createElement("button");g.className="jb-accept-btn",g.textContent="ACCEPT →",g.addEventListener("click",()=>{this.onAccept(i)}),r.appendChild(g),this.overlay.appendChild(r)}}}const ng=1e8;function bi(s){return s>=1e6?`${(s/1e6).toFixed(2)}M sats`:s>=1e3?`${(s/1e3).toFixed(0)}K sats`:`${s} sats`}function ig(s){const e=Math.max(0,Math.ceil(s)),t=Math.floor(e/60),n=e%60;return`${t}:${n.toString().padStart(2,"0")}`}function sg(s){return s.charAt(0).toUpperCase()}class rg{constructor(){R(this,"btcAchieved",!1);R(this,"speedText");R(this,"moneyEl");R(this,"jobStripEl");R(this,"travelTimerEl");R(this,"flashOverlay");R(this,"timerFailOverlay");R(this,"crewPanelEl");R(this,"activeJob",null);R(this,"activePhase",1);R(this,"flashTimeout",null);R(this,"spillPenaltyTimeout",null);R(this,"currentMoney",5e5);R(this,"timerPulseInterval",null);if(!document.getElementById("hud-styles")){const r=document.createElement("style");r.id="hud-styles",r.textContent=`
...
`),o=Math.round(n*.045),a=r.length*o+24,l=n*.45-a/2,c=t*.85,h=(t-c)/2;this.roundRect(e,h,l,c,a,16),e.fill(),e.fillStyle="#fff",e.shadowColor="rgba(0,0,0,0.6)",e.shadowBlur=8,r.forEach((u,d)=>{e.fillText(u,t/2,l+22+d*o)}),e.restore()}finish(){if(this.done)return;this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.sctx&&this.scratch&&(this.revealed=Bl(this.sctx,this.scratch.width,this.scratch.height));const e=Math.round(this.revealed*100),t=Math.max(20,e),n=t/100,i=this.photo,r=og(i.id),o=gs().length,a=ag();this.showResultScreen(t,i,r,o,a,n)}showResultScreen(e,t,n,i,r,o){const a=this.ctx,l=this.canvas;if(!a||!l)return;const c=l.width,h=l.height;a.clearRect(0,0,c,h),this.imgLoaded&&this.img&&this.img.naturalWidth>0?Nl(a,this.img,c,h):(a.fillStyle="#2a2a20",a.fillRect(0,0,c,h)),this.scratch&&a.drawImage(this.scratch,0,0),a.fillStyle="rgba(0,0,0,0.65)",a.fillRect(0,0,c,h);const u=e>=85?"#5EDB7D":e>=60?"#F7C948":"#F07070";a.font=`900 ${Math.round(h*.15)}px system-ui`,a.textAlign="center",a.fillStyle=u,a.shadowColor="rgba(0,0,0,0.8)",a.shadowBlur=20,a.fillText(`${e}%`,c/2,h*.35),a.font=`bold ${Math.round(h*.04)}px system-ui`,a.fillStyle="#fff",a.shadowBlur=10,a.fillText(`📸 ${t.name}`,c/2,h*.47);let d;r?d="🏆 FULL TEM COLLECTION!":n?d="✨ NEW PHOTO UNLOCKED!":d="Already in your collection",a.font=`bold ${Math.round(h*.032)}px system-ui`,a.fillStyle=r?"#FFD700":n?"#5EDB7D":"#aaa",a.shadowBlur=8,a.fillText(d,c/2,h*.56),a.font=`${Math.round(h*.026)}px system-ui`,a.fillStyle="rgba(255,255,255,0.75)",a.shadowBlur=4,a.fillText(`Collection: ${i} / ${si.length}`,c/2,h*.64),a.shadowBlur=0;const f=r?"🏆 Full TEM Collection complete!":n?`📸 New photo unlocked: ${t.name}`:`${t.name} — already in collection`,g={score:e,qualityPct:o,message:f};setTimeout(()=>{var _;return(_=this.onComplete)==null?void 0:_.call(this,g)},2800)}unmount(){this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.rafId&&cancelAnimationFrame(this.rafId),this.canvas&&(this.canvas.removeEventListener("mousemove",this._onMouseMove),this.canvas.removeEventListener("mousedown",this._onMouseDown),this.canvas.removeEventListener("touchstart",this._onTouchStart),this.canvas.removeEventListener("touchmove",this._onTouchMove),this.canvas.removeEventListener("touchend",this._onTouchEnd),this.canvas.remove()),window.removeEventListener("mouseup",this._onMouseUp),this.canvas=null,this.ctx=null,this.scratch=null,this.sctx=null,this.container=null,this.onComplete=null,this.img=null}}const Oe=400,dt=700,fg=800,Ol=-420,Vs=140,kl=100,pg=600,mg=.5,Gt=44,Ws=22,gg=.6,_g=180,vg=-200,zl=60,xg=80,yg=.8,Mg=100,bg=1.15,is=3,wg=100,ss=200,wi=80,cn=270,Sg=[{id:"lv1",baseX:80,y:540,width:100,height:8,level:1,type:"normal"},{id:"lv2",baseX:140,y:450,width:120,height:8,level:2,type:"normal"},{id:"lv3a",baseX:80,y:360,width:100,height:8,level:3,type:"normal"},{id:"lv3b",baseX:220,y:360,width:100,height:8,level:3,type:"normal"},{id:"lv4",baseX:125,y:270,width:140,height:8,level:4,type:"moving"},{id:"lv5a",baseX:80,y:185,width:100,height:8,level:5,type:"crumbling"},{id:"lv5b",baseX:220,y:185,width:100,height:8,level:5,type:"normal"},{id:"lv6",baseX:80,y:100,width:240,height:8,level:6,type:"win"}],On={x:190,y:420,w:40,h:30};class Eg{constructor(){R(this,"canvas",null);R(this,"ctx",null);R(this,"animFrame",null);R(this,"onComplete",null);R(this,"phase","playing");R(this,"platforms",[]);R(this,"jarrad");R(this,"pigeon");R(this,"gameTime",0);R(this,"tsuyoshiSpeech","I GOT IT!");R(this,"tsuyoshiTimer",0);R(this,"resultTimer",0);R(this,"retried",!1);R(this,"movingPlatTime",0);R(this,"movingPlatX",125);R(this,"crumble5ATimer",0);R(this,"crumble5AState","solid");R(this,"crumble5ARespawn",0);R(this,"ropeAngle",0);R(this,"ropeAngVel",0);R(this,"ropeGrabbed",!1);R(this,"windCycleTimer",0);R(this,"windActive",!1);R(this,"windAlpha",0);R(this,"showGapHint",!0);R(this,"gapHintTimer",8);R(this,"shakeNoise",0);R(this,"comboPhase",0);R(this,"comboTimer",0);R(this,"comboFlashTimer",0);R(this,"vaultFlashTimer",0);R(this,"rewindFlashTimer",0);R(this,"splatParticles",[]);R(this,"frameCount",0);R(this,"prevJarradY",0);R(this,"wallDustParticles",[]);R(this,"hasShimmied",!1);R(this,"keys",{});R(this,"prevKeys",{});R(this,"keyHandler");R(this,"keyUpHandler");R(this,"mobileLeft",!1);R(this,"mobileRight",!1);R(this,"mobileJump",!1);R(this,"mobileDrop",!1);R(this,"mobileRewind",!1);R(this,"mobileRewindFired",!1);R(this,"mobileContainer",null);R(this,"lastTimestamp",0)}mount(e,t){this.onComplete=t,this.platforms=Sg.map(i=>({...i})),this.canvas=document.createElement("canvas"),this.canvas.width=Oe,this.canvas.height=dt,this.canvas.style.cssText=`
    ...
    `,t.addEventListener("click",()=>{this.stop(),e({score:75,qualityPct:.75,message:"Job done!"})}),this.overlay.appendChild(t),this.safetyTimer=setTimeout(()=>{this.active&&(this.stop(),e({score:70,qualityPct:.7,message:"Time up!"}))},6e4),setTimeout(()=>{if(this.active)try{this.trowelingGame=new ug,this.trowelingGame.mount(this.overlay,n=>{this.safetyTimer&&clearTimeout(this.safetyTimer),this.stop(),e(n)})}catch(n){console.error("TrowelingGame init failed:",n);const i=document.createElement("div");i.style.cssText=`
      ...
      cursor: pointer; font-family: system-ui, sans-serif;
      touch-action: manipulation;
    `,t.addEventListener("click",()=>{this.stop(),e({score:75,qualityPct:.75,message:"Job done!"})}),this.overlay.appendChild(t),this.safetyTimer=setTimeout(()=>{this.active&&(this.stop(),e({score:50,qualityPct:.5,message:"Time up on the scaffold!"}))},9e4),setTimeout(()=>{if(this.active)try{this.scaffoldGame=new Eg,this.scaffoldGame.mount(this.overlay,n=>{this.safetyTimer&&clearTimeout(this.safetyTimer),this.stop(),e(n)})}catch(n){console.error("ScaffoldGame init failed:",n);const i=document.createElement("div");i.style.cssText=`
          display:flex; flex-direction:column; align-items:center;
          justify-content:center; height:100%; color:#fff;
          font-family:system-ui,sans-serif; gap:24px; padding:40px;
          text-align:center;
        `,i.innerHTML=`
          ...
          <div style="font-size:16px; opacity:0.7;">Tap DONE to collect your pay</div>
        `,this.overlay.appendChild(i)}},120)}startRandom(e){Math.random()<.5?this.startTroweling(e):this.startScaffold(e)}stop(){this.safetyTimer&&(clearTimeout(this.safetyTimer),this.safetyTimer=null),this.trowelingGame&&(this.trowelingGame.unmount(),this.trowelingGame=null),this.scaffoldGame&&(this.scaffoldGame.unmount(),this.scaffoldGame=null),this.overlay.style.display="none",this.overlay.innerHTML="",this.active=!1}}class Ag{constructor(){R(this,"overlay",null)}show(){if(this.overlay){this.refresh(),this.overlay.style.display="flex";return}this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `,this.overlay.appendChild(r);const o=document.createElement("div");o.id="gallery-encourage",o.style.cssText=`
      ...
      padding: 0 20px 40px;
      box-sizing: border-box;
    `,this.overlay.appendChild(o),this.overlay.addEventListener("click",a=>{a.target===this.overlay&&this.hide()}),document.body.appendChild(this.overlay),this.refresh()}refresh(){if(!this.overlay)return;const e=gs(),t=e.length,n=si.length,i=this.overlay.querySelector("#gallery-progress-wrap");if(i){i.innerHTML="";const a=document.createElement("div");a.style.cssText=`
  ...
  `,document.body.appendChild(A),s.onUpdate(T=>{a.update(T),n.updateSuspension(T);const I=o.activeJob!==null&&o.activePhase>=2;i.setVisible(I),I?i.update(T):i.level=0,e.updateAll(T);const M=n.mesh.position.x,v=n.mesh.position.z;if(f.update(T),f.tryVisit(M,v)&&(i.level=Math.max(0,i.level-.6),g.drinkCoffee(),g.isUrgent?r.showToast("☕ Coffeed up — now find a toilet, fast!",13918762):r.showToast("☕ Coffee hit! Plaster steady, bladder loading...",13918762)),g.update(T,o.activeJob?a.speed:0),g.tryRelief(M,v)&&r.showToast("🚽 Ahhh! Relief! Ready for the next coffee ☕",2201331),g.isUrgent&&o.activeJob){const k=Date.now();k-g.lastUrgentToast>15e3&&(g.lastUrgentToast=k,r.showToast("🚽 Bursting! Find the toilet before you spill!",16733986))}i.spillRateMultiplier=g.spillMultiplier,_.update(T,M,v,m);{const k=p.clone().project(s.camera.camera),j=(k.x*.5+.5)*window.innerWidth,W=(-k.y*.5+.5)*window.innerHeight;m.setScreenPosition(j,W)}u.update(T,M,v),d.update(T,M,v);const C=u.resolveVan(M,v);if(C.hit&&(n.mesh.position.x=C.x,n.mesh.position.z=C.z,a.applyImpulse(0,0),o.activePhase>=2&&i.triggerCrash()),l.update(T,M,v),o.activeJob){const k=o.tickTravel(T);r.updateTravelTimer(o.travelTimer),k!=null&&k.failed&&(i.level=0,l.setTarget(null),r.updateTravelTimer(null),r.showTimerFail(15e4),r.setActiveJob(null,1),r.updateMoney(o.money),r.updateCrewStatus([],[],!1),e.showAllCrew(),setTimeout(()=>c.show(o.getAvailableJobs()),3500))}else r.updateTravelTimer(null);if(o.activeJob!==null)if(o.activePhase===1)r.updateJobDistance(o.distanceToWorkshop(M,v));else if(o.activePhase===2){const k=o.nextCrewNeeded();if(k){const j=e.getCrewPosition(k);r.updateJobDistance(o.distanceToPoint(M,v,j.x,j.z))}}else r.updateJobDistance(o.distanceTo(M,v));if(o.activeJob&&o.activePhase===1&&!D&&o.checkPhase1Arrival(M,v)){D=!0,o.advanceToPhase2(),i.level=0;const k=o.nextCrewNeeded();if(k){const j=e.getCrewPosition(k);l.setTarget(j)}r.showPhase1Complete(),r.setActiveJob(o.activeJob,2),r.updateCrewStatus(o.crewToPickup,o.crewPickedUp,!0),setTimeout(()=>{D=!1},2e3)}if(o.activeJob&&o.activePhase===2&&!D)for(const k of o.crewToPickup){if(o.crewPickedUp.includes(k))continue;const j=e.getCrewPosition(k);if(o.distanceToPoint(M,v,j.x,j.z)<10){D=!0,e.hideCrew(k);const re=o.pickupCrew(k);if(r.updateCrewStatus(o.crewToPickup,o.crewPickedUp,!0),re)o.advanceToPhase3(),l.setTarget(o.activeJob.position),r.showCrewPickup(k,null),r.setActiveJob(o.activeJob,3);else{const ce=o.nextCrewNeeded();if(ce){const xe=e.getCrewPosition(ce);l.setTarget(xe),r.showCrewPickup(k,ce)}}setTimeout(()=>{D=!1},1500);break}}if(o.activeJob&&o.activePhase===3&&!D&&!w.isActive()){const k=o.checkArrival(M,v);k!==null&&(D=!0,l.setTarget(null),r.setActiveJob(null,3),r.updateCrewStatus([],[],!1),w.startRandom(j=>{const W=o.completeJob(k,j.qualityPct);r.showJobComplete(k.title,W),r.updateMoney(o.money),e.showAllCrew(),D=!1,setTimeout(()=>{const re=o.getAvailableJobs();re.length>0&&c.show(re)},3500)}))}s.camera.follow(n.mesh.position,n.velocity,n.heading),r.update(a.speed,i.level);const G=o.activeJob,z=G?`P${o.activePhase}`:"idle",q=G?o.activePhase===1?Math.round(o.distanceToWorkshop(M,v)):o.activePhase===2?Math.round(o.distanceToPoint(M,v,...(()=>{const k=o.nextCrewNeeded();if(!k)return[M,v];const j=e.getCrewPosition(k);return[j.x,j.z]})())):Math.round(o.distanceTo(M,v)):0,$=G?`crew:${o.crewPickedUp.length}/${o.crewToPickup.length}`:"";A.textContent=`${z} | dist:${q} | ${$} | lock:${D} | mg:${w.isActive()}`}),setTimeout(()=>{c.show(o.getAvailableJobs())},1e3),s.start()}Og();
//# sourceMappingURL=index-29qZeGOE.js.map
