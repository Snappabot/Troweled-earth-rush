...
void main() {
	...
	`}function Bp(o){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const l=a.mapping,c=l===Rr||l===Pr,d=l===Un||l===Nn;if(c||d){let u=e.get(a);const h=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==h)return t===null&&(t=new wl(o)),u=c?t.fromEquirectangular(a,u):t.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return c&&f&&f.height>0||d&&f&&n(f)?(t===null&&(t=new wl(o)),u=c?t.fromEquirectangular(a):t.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,e.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function n(a){let l=0;const c=6;for(let d=0;d<c;d++)a[d]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function r(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:r}}function Fp(o){const e={};function t(i){if(e[i]!==void 0)return e[i];let n;switch(i){case"WEBGL_depth_texture":n=o.getExtension("WEBGL_depth_texture")||o.getExtension("MOZ_WEBGL_depth_texture")||o.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":n=o.getExtension("EXT_texture_filter_anisotropic")||o.getExtension("MOZ_EXT_texture_filter_anisotropic")||o.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":n=o.getExtension("WEBGL_compressed_texture_s3tc")||o.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":n=o.getExtension("WEBGL_compressed_texture_pvrtc")||o.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:n=o.getExtension(i)}return e[i]=n,n}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const n=t(i);return n===null&&hs("THREE.WebGLRenderer: "+i+" extension not supported."),n}}}function kp(o,e,t,i){const n={},s=new WeakMap;function r(u){const h=u.target;h.index!==null&&e.remove(h.index);for(const g in h.attributes)e.remove(h.attributes[g]);for(const g in h.morphAttributes){const x=h.morphAttributes[g];for(let m=0,p=x.length;m<p;m++)e.remove(x[m])}h.removeEventListener("dispose",r),delete n[h.id];const f=s.get(h);f&&(e.remove(f),s.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(u,h){return n[h.id]===!0||(h.addEventListener("dispose",r),n[h.id]=!0,t.memory.geometries++),h}function l(u){const h=u.attributes;for(const g in h)e.update(h[g],o.ARRAY_BUFFER);const f=u.morphAttributes;for(const g in f){const x=f[g];for(let m=0,p=x.length;m<p;m++)e.update(x[m],o.ARRAY_BUFFER)}}function c(u){const h=[],f=u.index,g=u.attributes.position;let x=0;if(f!==null){const w=f.array;x=f.version;for(let T=0,v=w.length;T<v;T+=3){const R=w[T+0],A=w[T+1],C=w[T+2];h.push(R,A,A,C,C,R)}}else if(g!==void 0){const w=g.array;x=g.version;for(let T=0,v=w.length/3-1;T<v;T+=3){const R=T+0,A=T+1,C=T+2;h.push(R,A,A,C,C,R)}}else return;const m=new(Wc(h)?Kc:Jc)(h,1);m.version=x;const p=s.get(u);p&&e.remove(p),s.set(u,m)}function d(u){const h=s.get(u);if(h){const f=u.index;f!==null&&h.version<f.version&&c(u)}else c(u);return s.get(u)}return{get:a,update:l,getWireframeAttribute:d}}function Up(o,e,t){let i;function n(h){i=h}let s,r;function a(h){s=h.type,r=h.bytesPerElement}function l(h,f){o.drawElements(i,f,s,h*r),t.update(f,i,1)}function c(h,f,g){g!==0&&(o.drawElementsInstanced(i,f,s,h*r,g),t.update(f,i,g))}function d(h,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,f,0,s,h,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,i,1)}function u(h,f,g,x){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<h.length;p++)c(h[p]/r,f[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(i,f,0,s,h,0,x,0,g);let p=0;for(let w=0;w<g;w++)p+=f[w]*x[w];t.update(p,i,1)}}this.setMode=n,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=d,this.renderMultiDrawInstances=u}function Np(o){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,r,a){switch(t.calls++,r){case o.TRIANGLES:t.triangles+=a*(s/3);break;case o.LINES:t.lines+=a*(s/2);break;case o.LINE_STRIP:t.lines+=a*(s-1);break;case o.LINE_LOOP:t.lines+=a*s;break;case o.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",r);break}}function n(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:n,update:i}}function Op(o,e,t){const i=new WeakMap,n=new st;function s(r,a,l){const c=r.morphTargetInfluences,d=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=d!==void 0?d.length:0;let h=i.get(a);if(h===void 0||h.count!==u){let _=function(){I.dispose(),i.delete(a),a.removeEventListener("dispose",_)};var f=_;h!==void 0&&h.texture.dispose();const g=a.morphAttributes.position!==void 0,x=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,p=a.morphAttributes.position||[],w=a.morphAttributes.normal||[],T=a.morphAttributes.color||[];let v=0;g===!0&&(v=1),x===!0&&(v=2),m===!0&&(v=3);let R=a.attributes.position.count*v,A=1;R>e.maxTextureSize&&(A=Math.ceil(R/e.maxTextureSize),R=e.maxTextureSize);const C=new Float32Array(R*A*4*u),I=new qc(C,R,A,u);I.type=wi,I.needsUpdate=!0;const S=v*4;for(let P=0;P<u;P++){const N=p[P],z=w[P],X=T[P],J=R*A*4*P;for(let Y=0;Y<N.count;Y++){const te=Y*S;g===!0&&(n.fromBufferAttribute(N,Y),C[J+te+0]=n.x,C[J+te+1]=n.y,C[J+te+2]=n.z,C[J+te+3]=0),x===!0&&(n.fromBufferAttribute(z,Y),C[J+te+4]=n.x,C[J+te+5]=n.y,C[J+te+6]=n.z,C[J+te+7]=0),m===!0&&(n.fromBufferAttribute(X,Y),C[J+te+8]=n.x,C[J+te+9]=n.y,C[J+te+10]=n.z,C[J+te+11]=X.itemSize===4?n.w:1)}}h={count:u,texture:I,size:new Fe(R,A)},i.set(a,h),a.addEventListener("dispose",_)}if(r.isInstancedMesh===!0&&r.morphTexture!==null)l.getUniforms().setValue(o,"morphTexture",r.morphTexture,t);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const x=a.morphTargetsRelative?1:1-g;l.getUniforms().setValue(o,"morphTargetBaseInfluence",x),l.getUniforms().setValue(o,"morphTargetInfluences",c)}l.getUniforms().setValue(o,"morphTargetsTexture",h.texture,t),l.getUniforms().setValue(o,"morphTargetsTextureSize",h.size)}return{update:s}}function zp(o,e,t,i){let n=new WeakMap;function s(l){const c=i.render.frame,d=l.geometry,u=e.get(l,d);if(n.get(u)!==c&&(e.update(u),n.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),n.get(l)!==c&&(t.update(l.instanceMatrix,o.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,o.ARRAY_BUFFER),n.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;n.get(h)!==c&&(h.update(),n.set(h,c))}return u}function r(){n=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:r}}class id extends Lt{constructor(e,t,i,n,s,r,a,l,c,d=Bn){if(d!==Bn&&d!==zn)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&d===Bn&&(i=cn),i===void 0&&d===zn&&(i=On),super(null,n,s,r,a,l,d,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:ni,this.minFilter=l!==void 0?l:ni,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const nd=new Lt,El=new id(1,1),sd=new qc,od=new Eh,rd=new ed,Al=[],Cl=[],Rl=new Float32Array(16),Pl=new Float32Array(9),Il=new Float32Array(4);function Yn(o,e,t){const i=o[0];if(i<=0||i>0)return o;const n=e*t;let s=Al[n];if(s===void 0&&(s=new Float32Array(n),Al[n]=s),e!==0){i.toArray(s,0);for(let r=1,a=0;r!==e;++r)a+=t,o[r].toArray(s,a)}return s}function _t(o,e){if(o.length!==e.length)return!1;for(let t=0,i=o.length;t<i;t++)if(o[t]!==e[t])return!1;return!0}function bt(o,e){for(let t=0,i=e.length;t<i;t++)o[t]=e[t]}function Co(o,e){let t=Cl[e];t===void 0&&(t=new Int32Array(e),Cl[e]=t);for(let i=0;i!==e;++i)t[i]=o.allocateTextureUnit();return t}function Gp(o,e){const t=this.cache;t[0]!==e&&(o.uniform1f(this.addr,e),t[0]=e)}function Hp(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;o.uniform2fv(this.addr,e),bt(t,e)}}function Vp(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(o.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(_t(t,e))return;o.uniform3fv(this.addr,e),bt(t,e)}}function Wp(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;o.uniform4fv(this.addr,e),bt(t,e)}}function Xp(o,e){const t=this.cache,i=e.elements;if(i===void 0){if(_t(t,e))return;o.uniformMatrix2fv(this.addr,!1,e),bt(t,e)}else{if(_t(t,i))return;Il.set(i),o.uniformMatrix2fv(this.addr,!1,Il),bt(t,i)}}function qp(o,e){const t=this.cache,i=e.elements;if(i===void 0){if(_t(t,e))return;o.uniformMatrix3fv(this.addr,!1,e),bt(t,e)}else{if(_t(t,i))return;Pl.set(i),o.uniformMatrix3fv(this.addr,!1,Pl),bt(t,i)}}function Yp(o,e){const t=this.cache,i=e.elements;if(i===void 0){if(_t(t,e))return;o.uniformMatrix4fv(this.addr,!1,e),bt(t,e)}else{if(_t(t,i))return;Rl.set(i),o.uniformMatrix4fv(this.addr,!1,Rl),bt(t,i)}}function jp(o,e){const t=this.cache;t[0]!==e&&(o.uniform1i(this.addr,e),t[0]=e)}function $p(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;o.uniform2iv(this.addr,e),bt(t,e)}}function Jp(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;o.uniform3iv(this.addr,e),bt(t,e)}}function Kp(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;o.uniform4iv(this.addr,e),bt(t,e)}}function Zp(o,e){const t=this.cache;t[0]!==e&&(o.uniform1ui(this.addr,e),t[0]=e)}function Qp(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(o.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(_t(t,e))return;o.uniform2uiv(this.addr,e),bt(t,e)}}function e0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(o.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(_t(t,e))return;o.uniform3uiv(this.addr,e),bt(t,e)}}function t0(o,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(o.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(_t(t,e))return;o.uniform4uiv(this.addr,e),bt(t,e)}}function i0(o,e,t){const i=this.cache,n=t.allocateTextureUnit();i[0]!==n&&(o.uniform1i(this.addr,n),i[0]=n);let s;this.type===o.SAMPLER_2D_SHADOW?(El.compareFunction=Vc,s=El):s=nd,t.setTexture2D(e||s,n)}function n0(o,e,t){const i=this.cache,n=t.allocateTextureUnit();i[0]!==n&&(o.uniform1i(this.addr,n),i[0]=n),t.setTexture3D(e||od,n)}function s0(o,e,t){const i=this.cache,n=t.allocateTextureUnit();i[0]!==n&&(o.uniform1i(this.addr,n),i[0]=n),t.setTextureCube(e||rd,n)}function o0(o,e,t){const i=this.cache,n=t.allocateTextureUnit();i[0]!==n&&(o.uniform1i(this.addr,n),i[0]=n),t.setTexture2DArray(e||sd,n)}function r0(o){switch(o){case 5126:return Gp;case 35664:return Hp;case 35665:return Vp;case 35666:return Wp;case 35674:return Xp;case 35675:return qp;case 35676:return Yp;case 5124:case 35670:return jp;case 35667:case 35671:return $p;case 35668:case 35672:return Jp;case 35669:case 35673:return Kp;case 5125:return Zp;case 36294:return Qp;case 36295:return e0;case 36296:return t0;case 35678:case 36198:case 36298:case 36306:case 35682:return i0;case 35679:case 36299:case 36307:return n0;case 35680:case 36300:case 36308:case 36293:return s0;case 36289:case 36303:case 36311:case 36292:return o0}}function a0(o,e){o.uniform1fv(this.addr,e)}function l0(o,e){const t=Yn(e,this.size,2);o.uniform2fv(this.addr,t)}function c0(o,e){const t=Yn(e,this.size,3);o.uniform3fv(this.addr,t)}function d0(o,e){const t=Yn(e,this.size,4);o.uniform4fv(this.addr,t)}function h0(o,e){const t=Yn(e,this.size,4);o.uniformMatrix2fv(this.addr,!1,t)}function u0(o,e){const t=Yn(e,this.size,9);o.uniformMatrix3fv(this.addr,!1,t)}function f0(o,e){const t=Yn(e,this.size,16);o.uniformMatrix4fv(this.addr,!1,t)}function p0(o,e){o.uniform1iv(this.addr,e)}function m0(o,e){o.uniform2iv(this.addr,e)}function g0(o,e){o.uniform3iv(this.addr,e)}function x0(o,e){o.uniform4iv(this.addr,e)}function v0(o,e){o.uniform1uiv(this.addr,e)}function y0(o,e){o.uniform2uiv(this.addr,e)}function _0(o,e){o.uniform3uiv(this.addr,e)}function b0(o,e){o.uniform4uiv(this.addr,e)}function w0(o,e,t){const i=this.cache,n=e.length,s=Co(t,n);_t(i,s)||(o.uniform1iv(this.addr,s),bt(i,s));for(let r=0;r!==n;++r)t.setTexture2D(e[r]||nd,s[r])}function M0(o,e,t){const i=this.cache,n=e.length,s=Co(t,n);_t(i,s)||(o.uniform1iv(this.addr,s),bt(i,s));for(let r=0;r!==n;++r)t.setTexture3D(e[r]||od,s[r])}function S0(o,e,t){const i=this.cache,n=e.length,s=Co(t,n);_t(i,s)||(o.uniform1iv(this.addr,s),bt(i,s));for(let r=0;r!==n;++r)t.setTextureCube(e[r]||rd,s[r])}function T0(o,e,t){const i=this.cache,n=e.length,s=Co(t,n);_t(i,s)||(o.uniform1iv(this.addr,s),bt(i,s));for(let r=0;r!==n;++r)t.setTexture2DArray(e[r]||sd,s[r])}function E0(o){switch(o){case 5126:return a0;case 35664:return l0;case 35665:return c0;case 35666:return d0;case 35674:return h0;case 35675:return u0;case 35676:return f0;case 5124:case 35670:return p0;case 35667:case 35671:return m0;case 35668:case 35672:return g0;case 35669:case 35673:return x0;case 5125:return v0;case 36294:return y0;case 36295:return _0;case 36296:return b0;case 35678:case 36198:case 36298:case 36306:case 35682:return w0;case 35679:case 36299:case 36307:return M0;case 35680:case 36300:case 36308:case 36293:return S0;case 36289:case 36303:case 36311:case 36292:return T0}}class A0{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=r0(t.type)}}class C0{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=E0(t.type)}}class R0{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const n=this.seq;for(let s=0,r=n.length;s!==r;++s){const a=n[s];a.setValue(e,t[a.id],i)}}}const lr=/(\w+)(\])?(\[|\.)?/g;function Dl(o,e){o.seq.push(e),o.map[e.id]=e}function P0(o,e,t){const i=o.name,n=i.length;for(lr.lastIndex=0;;){const s=lr.exec(i),r=lr.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&r+2===n){Dl(t,c===void 0?new A0(a,o,e):new C0(a,o,e));break}else{let u=t.map[a];u===void 0&&(u=new R0(a),Dl(t,u)),t=u}}}class uo{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let n=0;n<i;++n){const s=e.getActiveUniform(t,n),r=e.getUniformLocation(t,s.name);P0(s,r,this)}}setValue(e,t,i,n){const s=this.map[t];s!==void 0&&s.setValue(e,i,n)}setOptional(e,t,i){const n=t[i];n!==void 0&&this.setValue(e,i,n)}static upload(e,t,i,n){for(let s=0,r=t.length;s!==r;++s){const a=t[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,n)}}static seqWithValue(e,t){const i=[];for(let n=0,s=e.length;n!==s;++n){const r=e[n];r.id in t&&i.push(r)}return i}}function Ll(o,e,t){const i=o.createShader(e);return o.shaderSource(i,t),o.compileShader(i),i}const I0=37297;let D0=0;function L0(o,e){const t=o.split(`
`),i=[],n=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let r=n;r<s;r++){const a=r+1;i.push(`${a===e?">":" "} ${a}: ${t[r]}`)}return i.join(`
`)}const Bl=new He;function B0(o){je._getMatrix(Bl,je.workingColorSpace,o);const e=`mat3( ${Bl.elements.map(t=>t.toFixed(4))} )`;switch(je.getTransfer(o)){case Eo:return[e,"LinearTransferOETF"];case it:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",o),[e,"LinearTransferOETF"]}}function Fl(o,e,t){const i=o.getShaderParameter(e,o.COMPILE_STATUS),n=o.getShaderInfoLog(e).trim();if(i&&n==="")return"";const s=/ERROR: 0:(\d+)/.exec(n);if(s){const r=parseInt(s[1]);return t.toUpperCase()+`

`+n+`

`+L0(o.getShaderSource(e),r)}else return n}function F0(o,e){const t=B0(e);return[`vec4 ${o}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function k0(o,e){let t;switch(e){case Ec:t="Linear";break;case Ac:t="Reinhard";break;case Cc:t="Cineon";break;case xa:t="ACESFilmic";break;case Rc:t="AgX";break;case Pc:t="Neutral";break;case th:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+o+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Qs=new D;function U0(){je.getLuminanceCoefficients(Qs);const o=Qs.x.toFixed(4),e=Qs.y.toFixed(4),t=Qs.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function N0(o){return[o.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",o.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(us).join(`
`)}function O0(o){const e=[];for(const t in o){const i=o[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function z0(o,e){const t={},i=o.getProgramParameter(e,o.ACTIVE_ATTRIBUTES);for(let n=0;n<i;n++){const s=o.getActiveAttrib(e,n),r=s.name;let a=1;s.type===o.FLOAT_MAT2&&(a=2),s.type===o.FLOAT_MAT3&&(a=3),s.type===o.FLOAT_MAT4&&(a=4),t[r]={type:s.type,location:o.getAttribLocation(e,r),locationSize:a}}return t}function us(o){return o!==""}function kl(o,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Ul(o,e){return o.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const G0=/^[ \t]*#include +<([\w\d./]+)>/gm;function aa(o){return o.replace(G0,V0)}const H0=new Map;function V0(o,e){let t=We[e];if(t===void 0){const i=H0.get(e);if(i!==void 0)t=We[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return aa(t)}const W0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Nl(o){return o.replace(W0,X0)}function X0(o,e,t,i){let n="";for(let s=parseInt(e);s<parseInt(t);s++)n+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return n}function Ol(o){let e=`precision ${o.precision} float;
...
#define LOW_PRECISION`),e}function q0(o){let e="SHADOWMAP_TYPE_BASIC";return o.shadowMapType===Sc?e="SHADOWMAP_TYPE_PCF":o.shadowMapType===Tc?e="SHADOWMAP_TYPE_PCF_SOFT":o.shadowMapType===yi&&(e="SHADOWMAP_TYPE_VSM"),e}function Y0(o){let e="ENVMAP_TYPE_CUBE";if(o.envMap)switch(o.envMapMode){case Un:case Nn:e="ENVMAP_TYPE_CUBE";break;case To:e="ENVMAP_TYPE_CUBE_UV";break}return e}function j0(o){let e="ENVMAP_MODE_REFLECTION";if(o.envMap)switch(o.envMapMode){case Nn:e="ENVMAP_MODE_REFRACTION";break}return e}function $0(o){let e="ENVMAP_BLENDING_NONE";if(o.envMap)switch(o.combine){case ga:e="ENVMAP_BLENDING_MULTIPLY";break;case Qd:e="ENVMAP_BLENDING_MIX";break;case eh:e="ENVMAP_BLENDING_ADD";break}return e}function J0(o){const e=o.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function K0(o,e,t,i){const n=o.getContext(),s=t.defines;let r=t.vertexShader,a=t.fragmentShader;const l=q0(t),c=Y0(t),d=j0(t),u=$0(t),h=J0(t),f=N0(t),g=O0(s),x=n.createProgram();let m,p,w=t.glslVersion?"#version "+t.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}}Vn.BlurDirectionX=new Fe(1,0);Vn.BlurDirectionY=new Fe(0,1);const hg={name:"OutputShader",uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
      ...
      z-index: 100;
      touch-action: none;
    `,document.body.appendChild(e),this.joystickManager=zg.create({zone:e,mode:"static",position:{left:"75px",bottom:"75px"},color:"rgba(255, 255, 255, 0.6)",size:120,restOpacity:.5}),this.joystickManager.on("move",(s,r)=>{r.vector&&(this.steerAxis=r.vector.x)}),this.joystickManager.on("end",()=>{this.steerAxis=0});const t=document.createElement("div");t.style.cssText=`
      position: fixed;
      bottom: 30px;
      right: 30px;
      width: 90px;
...
`),r=Math.round(i*.045),a=s.length*r+24,l=i*.45-a/2,c=t*.85,d=(t-c)/2;this.roundRect(e,d,l,c,a,16),e.fill(),e.fillStyle="#fff",e.shadowColor="rgba(0,0,0,0.6)",e.shadowBlur=8,s.forEach((u,h)=>{e.fillText(u,t/2,l+22+h*r)}),e.restore()}finish(){if(this.done)return;this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.sctx&&this.scratch&&(this.revealed=lc(this.sctx,this.scratch.width,this.scratch.height));const e=Math.round(this.revealed*100),t=Math.max(20,e),i=t/100,n=this.photo,s=Jg(n.id),r=Rs().length,a=_d();this.showResultScreen(t,n,s,r,a,i)}showResultScreen(e,t,i,n,s,r){const a=this.ctx,l=this.canvas;if(!a||!l)return;const c=l.width,d=l.height;a.clearRect(0,0,c,d),this.imgLoaded&&this.img&&this.img.naturalWidth>0?cc(a,this.img,c,d):(a.fillStyle="#2a2a20",a.fillRect(0,0,c,d)),this.scratch&&a.drawImage(this.scratch,0,0),a.fillStyle="rgba(0,0,0,0.65)",a.fillRect(0,0,c,d);const u=e>=85?"#5EDB7D":e>=60?"#F7C948":"#F07070";a.font=`900 ${Math.round(d*.15)}px system-ui`,a.textAlign="center",a.fillStyle=u,a.shadowColor="rgba(0,0,0,0.8)",a.shadowBlur=20,a.fillText(`${e}%`,c/2,d*.35),a.font=`bold ${Math.round(d*.04)}px system-ui`,a.fillStyle="#fff",a.shadowBlur=10,a.fillText(`📸 ${t.name}`,c/2,d*.47);let h;s?h="🏆 FULL TEM COLLECTION!":i?h="✨ NEW PHOTO UNLOCKED!":h="Already in your collection",a.font=`bold ${Math.round(d*.032)}px system-ui`,a.fillStyle=s?"#FFD700":i?"#5EDB7D":"#aaa",a.shadowBlur=8,a.fillText(h,c/2,d*.56),a.font=`${Math.round(d*.026)}px system-ui`,a.fillStyle="rgba(255,255,255,0.75)",a.shadowBlur=4,a.fillText(`Collection: ${n} / ${ln.length}`,c/2,d*.64),a.shadowBlur=0;const f=s?"🏆 Full TEM Collection complete!":i?`📸 New photo unlocked: ${t.name}`:`${t.name} — already in collection`,g={score:e,qualityPct:r,message:f};setTimeout(()=>{var x;return(x=this.onComplete)==null?void 0:x.call(this,g)},2800)}unmount(){this.done=!0,this.timerInterval&&clearInterval(this.timerInterval),this.rafId&&cancelAnimationFrame(this.rafId),this.canvas&&(this.canvas.removeEventListener("mousemove",this._onMouseMove),this.canvas.removeEventListener("mousedown",this._onMouseDown),this.canvas.removeEventListener("touchstart",this._onTouchStart),this.canvas.removeEventListener("touchmove",this._onTouchMove),this.canvas.removeEventListener("touchend",this._onTouchEnd),this.canvas.remove()),window.removeEventListener("mouseup",this._onMouseUp),this.canvas=null,this.ctx=null,this.scratch=null,this.sctx=null,this.container=null,this.onComplete=null,this.img=null}}const et=5,po=8,Qt=po*et,ix=[-8,8],nx=20,no=5.5,dc=14,hc=11,uc=4,sx=-30,An=.4;class ox{constructor(){b(this,"overlay");b(this,"renderer");b(this,"scene");b(this,"camera");b(this,"rafId",0);b(this,"lastTs",0);b(this,"px",0);b(this,"py",0);b(this,"vx",0);b(this,"vy",0);b(this,"onGround",!1);b(this,"jumpsLeft",2);b(this,"climbPole",null);b(this,"swingBar",null);b(this,"swingAngle",0);b(this,"swingOmega",0);b(this,"char");b(this,"charGroup");b(this,"facingRight",!0);b(this,"platforms",[]);b(this,"poles",[]);b(this,"swingBars",[]);b(this,"heartsEl");b(this,"timerEl");b(this,"lives",3);b(this,"timer",120);b(this,"gameOver",!1);b(this,"delivered",!1);b(this,"keys",{left:!1,right:!1,up:!1,down:!1});b(this,"jumpTap",!1);b(this,"onCompleteFn")}start(e){this.onCompleteFn=e,this._createOverlay(),this._createScene(),this._buildBackground(),this._buildLevel(),this._buildHUD(),this._buildControls(),this.px=0,this.py=.5,this.lastTs=performance.now(),this.rafId=requestAnimationFrame(t=>this._loop(t))}_createOverlay(){this.overlay=document.createElement("div"),this.overlay.style.cssText=`
    ...
    `,t.addEventListener("click",()=>{this.stop(),e({score:75,qualityPct:.75,message:"Job done!"})}),this.overlay.appendChild(t),this.safetyTimer=setTimeout(()=>{this.active&&(this.stop(),e({score:70,qualityPct:.7,message:"Time up!"}))},6e4),setTimeout(()=>{if(this.active)try{this.trowelingGame=new tx,this.trowelingGame.mount(this.overlay,i=>{this.safetyTimer&&clearTimeout(this.safetyTimer),this.stop(),e(i)})}catch(i){console.error("TrowelingGame init failed:",i);const n=document.createElement("div");n.style.cssText=`
          display:flex; flex-direction:column; align-items:center;
      ...
      cursor: pointer; font-family: system-ui, sans-serif;
      touch-action: manipulation;
    `,t.addEventListener("click",()=>{this.stop(),e({score:75,qualityPct:.75,message:"Job done!"})}),this.overlay.appendChild(t),this.safetyTimer=setTimeout(()=>{this.active&&(this.stop(),e({score:50,qualityPct:.5,message:"Time up on the scaffold!"}))},9e4),setTimeout(()=>{if(this.active)try{this.scaffoldGame=new ox,this.scaffoldGame.mount(this.overlay,i=>{this.safetyTimer&&clearTimeout(this.safetyTimer),this.stop(),e(i)})}catch(i){console.error("ScaffoldGame init failed:",i);const n=document.createElement("div");n.style.cssText=`
          display:flex; flex-direction:column; align-items:center;
          justify-content:center; height:100%; color:#fff;
          font-family:system-ui,sans-serif; gap:24px; padding:40px;
          text-align:center;
    ...
    `;try{this.certDataUrl=ax({btcAchieved:bd()});const l=document.createElement("img");l.src=this.certDataUrl,l.style.cssText=`
...
The van remembers nothing. Drive carefully.`],yx=["One wall. One chance. The render decides everything.","A surface waiting to become something real.","From bare substrate to finished art — this is the job.",`The craft doesn't care about the deadline.
...
Don't prove them wrong.`,"This isn't a wall. It's a surface waiting to breathe."];function Ji(o){return o[Math.floor(Math.random()*o.length)]}const Cn="./",bi={theme:`${Cn}audio/theme.aac`,theme2:`${Cn}audio/theme2.aac`,credits:`${Cn}audio/credits.m4a`,radio1:`${Cn}audio/radio1.m4a`,radio2:`${Cn}audio/radio2.m4a`,radio3:`${Cn}audio/radio3.m4a`},Ki=[{id:"tem-fm",name:"TEM FM",freq:"88.3",tagline:"Melbourne's Most Refined",songs:["★ Troweled Earth (The Anthem) [LIVE]","Fresh Plaster Dreams","Tadelakt Sunrise","Ochre & Ochre","Marbellino Midnight","Render Slowly (feat. Phil)"],dj:["TEM FM — opening tonight with the anthem. Turn it up.","That was Troweled Earth — The Anthem. Written on site, finished in the van.","You're listening to TEM FM. Don't spill.","Smooth surfaces. Smoother sounds. TEM FM 88.3.","That was a certified classic. Like a three-coat stucco system.","Blood red clay to concrete's cold embrace... TEM FM."],bpm:68,rootHz:220,vibe:"ambient",color:"#C8A86A",audioFile:bi.theme},{id:"connie-gold",name:"CONNIE'S GOLD",freq:"103.7",tagline:"For the Craft, Darling",songs:["Quando Quando Quando (In the Van)","Bella Ciao Bella Render","Volare Trowel","Arrivederci Deadline","O Sole Mio Stucco"],dj:["Ehhhh — welcome to Connie's Gold! Ha ha ha ha!","You're listening to the best station. Connie said so. She's right.","Connie's Gold 103.7 — music to plaster by, darling.","Next up: another classic. Just like our Antique Stucco. Ha!"],bpm:92,rootHz:261.63,vibe:"italian",color:"#E8A050",audioFile:bi.radio1},{id:"brunswick-beats",name:"BRUNSWICK BEATS",freq:"99.9",tagline:"Lo-Fi for Lo-Fi People",songs:["study playlist #47","plaster & chill","waiting for jarrad (again)","lost my trowel","bladder full, waypoint far"],dj:["Brunswick Beats. For people who get it.","That was a vibe. This is also a vibe. 99.9.","We don't talk. We just play the music. Brunswick Beats.","Jarrad submitted this playlist. He says it slaps. It does."],bpm:80,rootHz:196,vibe:"lofi",color:"#8B9EC8",audioFile:bi.radio2},{id:"the-scaffold",name:"THE SCAFFOLD",freq:"107.1",tagline:"Tune In, Fall Off",songs:["30% Penalty (Acoustic)","Epstein Was Right (Radio Edit)","Topknot Thunder","Hard Hat? Never Heard of Her","Five Floors No Fear"],dj:["THE SCAFFOLD. 107.1. You WILL survive the jump.","That riff goes harder than Tsuyoshi vaulting the van door.","Tune in. Fall off. THE SCAFFOLD.","Jarrad called in. Said he's been waiting fifteen minutes. Legend."],bpm:140,rootHz:164.81,vibe:"rock",color:"#C1666B"},{id:"fabio-pizza",name:"FABIO'S PIZZA RADIO",freq:"92.5",tagline:"Music for Real Men",songs:['Ehhhh (12" Extended Mix)',"San Marzano Morning","La Dolce Trowel","One Slice, Two Slice","Thin Base, Wood Fire (feat. Fabio)"],dj:["Fabio's Pizza Radio — ehhhh. That is all.","You're listening to 92.5. The pizza is coming. Be patient. Ehhhh.","That song — like a perfect margherita. Simple. Honest. Ehhhh.","Fabio's Pizza Radio. For men with trowels and good taste."],bpm:108,rootHz:246.94,vibe:"italian",color:"#D4602A",audioFile:bi.radio3},{id:"tem-talk",name:"TEM TALK",freq:"91.1",tagline:"Conversations From the Site",songs:["★ The Troweled Earth Podcast [LIVE]","Deep Dive: Blood Red Clay vs Venetian","Interview: Matt on the Warlord Method","Ask Connie — Running a Crew in Melbourne","Five Years of Tadelakt with Tsuyoshi"],dj:["TEM Talk 91.1 — real conversations from the trade.","You're listening to Melbourne's only plastering podcast. TEM Talk.","That was a conversation worth replaying. 91.1 FM.","Next up: more from the TEM crew. Stick around."],bpm:70,rootHz:180,vibe:"ambient",color:"#90B0C0",audioFile:bi.theme2}];class _x{constructor(){b(this,"ctx",null);b(this,"masterGain");b(this,"scheduleAhead",.1);b(this,"scheduleInterval",.05);b(this,"nextBeatTime",0);b(this,"beatCount",0);b(this,"currentStation",null);b(this,"nodes",[]);b(this,"schedulerTimer",0);b(this,"compressor");b(this,"realAudioEl",null);b(this,"realAudioActive",!1)}init(){try{return this.ctx=new(window.AudioContext||window.webkitAudioContext),this.compressor=this.ctx.createDynamicsCompressor(),this.compressor.threshold.value=-18,this.compressor.ratio.value=4,this.masterGain=this.ctx.createGain(),this.masterGain.gain.value=.18,this.masterGain.connect(this.compressor),this.compressor.connect(this.ctx.destination),!0}catch{return!1}}setVolume(e){this.masterGain&&(this.masterGain.gain.value=e),this.realAudioEl&&(this.realAudioEl.volume=Math.min(1,e*4))}play(e){var t;if(this.stop(),this.currentStation=e,this.beatCount=0,e.audioFile){const i=Math.min(1,(((t=this.masterGain)==null?void 0:t.gain.value)??.18)*4.5),n=new Audio;n.src=e.audioFile,n.loop=!0,n.volume=i;const s=n.play();s!==void 0?s.then(()=>{this.realAudioEl=n,this.realAudioActive=!0}).catch(()=>{this.realAudioActive=!1,this._startGenerative()}):(this.realAudioEl=n,this.realAudioActive=!0)}else this._startGenerative()}_startGenerative(){!this.ctx||!this.currentStation||(this.ctx.state==="suspended"&&this.ctx.resume(),this.nextBeatTime=this.ctx.currentTime+.05,this.schedulerTimer=window.setInterval(()=>this._schedule(),this.scheduleInterval*1e3))}stop(){clearInterval(this.schedulerTimer),this.nodes.forEach(e=>{var t;try{(t=e.stop)==null||t.call(e),e.disconnect()}catch{}}),this.nodes=[],this.currentStation=null,this.realAudioEl&&(this.realAudioEl.pause(),this.realAudioEl.src="",this.realAudioEl=null),this.realAudioActive=!1}_schedule(){if(!this.ctx||!this.currentStation)return;const e=this.ctx.currentTime+this.scheduleAhead;for(;this.nextBeatTime<e;){this._scheduleBeat(this.nextBeatTime,this.beatCount,this.currentStation);const t=this.currentStation.bpm/60;this.nextBeatTime+=1/t,this.beatCount++}}_scheduleBeat(e,t,i){const n=Math.floor(t/4),s=t%4,r=i.rootHz;switch(i.vibe){case"ambient":this._ambientBeat(e,t,r);break;case"lofi":this._lofiBeat(e,s,r);break;case"rock":this._rockBeat(e,s,n,r);break;case"italian":this._italianBeat(e,s,n,r);break;case"electronic":this._electronicBeat(e,s,r);break}}_ambientBeat(e,t,i){if(this.ctx&&(t%4===0&&[i,i*1.25,i*1.5,i*2].forEach((s,r)=>{const a=this.ctx.createOscillator(),l=this.ctx.createGain(),c=this.ctx.createBiquadFilter();a.type="sine",a.frequency.value=s*.5,c.type="lowpass",c.frequency.value=800,l.gain.setValueAtTime(0,e),l.gain.linearRampToValueAtTime(.06-r*.01,e+.4),l.gain.linearRampToValueAtTime(0,e+3.5),a.connect(c),c.connect(l),l.connect(this.masterGain),a.start(e),a.stop(e+4),this.nodes.push(a,l)}),t%8===5)){const n=this.ctx.createOscillator(),s=this.ctx.createGain();n.type="triangle",n.frequency.value=i*4,s.gain.setValueAtTime(.04,e),s.gain.exponentialRampToValueAtTime(.001,e+.8),n.connect(s),s.connect(this.masterGain),n.start(e),n.stop(e+.9),this.nodes.push(n,s)}}_lofiBeat(e,t,i){if(!this.ctx)return;(t===0||t===2)&&this._kick(e,i*.5),(t===1||t===3)&&this._snare(e,.04),this._hihat(e,.025);const n=[i*.5,i*.5,i*.5*.75,i*.5*.9];this._bass(e,n[t],.25)}_rockBeat(e,t,i,n){if(!this.ctx)return;(t===0||t===2)&&this._kick(e,n*.4),(t===1||t===3)&&this._snare(e,.07),this._hihat(e,.05);const s=[n*.5,n*.5,n*.5*.8,n*.5];this._distBass(e,s[t%4]),t===0&&i%2===0&&[n,n*1.5,n*2].forEach(r=>{const a=this.ctx.createOscillator(),l=this.ctx.createGain();a.type="sawtooth",a.frequency.value=r,l.gain.setValueAtTime(.035,e),l.gain.linearRampToValueAtTime(0,e+.5),a.connect(l),l.connect(this.masterGain),a.start(e),a.stop(e+.55),this.nodes.push(a,l)})}_italianBeat(e,t,i,n){if(this.ctx&&(t===0&&this._bass(e,n*.5,.3),(t===1||t===2||t===3)&&this._bass(e,n*.75,.12),t===0&&this._kick(e,n*.5),t===0||t===2)){const s=[n,n*1.122,n*1.26,n*1.498,n*1.682],r=s[i%s.length],a=this.ctx.createOscillator(),l=this.ctx.createGain();a.type="triangle",a.frequency.value=r;const c=this.ctx.createOscillator(),d=this.ctx.createGain();c.frequency.value=5.5,d.gain.value=3,c.connect(d),d.connect(a.frequency),l.gain.setValueAtTime(.04,e),l.gain.linearRampToValueAtTime(0,e+.8),a.connect(l),l.connect(this.masterGain),c.start(e),a.start(e),c.stop(e+.9),a.stop(e+.9),this.nodes.push(a,c,l,d)}}_electronicBeat(e,t,i){this.ctx&&((t===0||t===2)&&this._kick(e,i*.5),(t===1||t===3)&&this._snare(e,.05),this._hihat(e,.03),t===0&&this._bass(e,i*.5,.25),t===2&&this._bass(e,i*.375,.2))}_kick(e,t){if(!this.ctx)return;const i=this.ctx.createOscillator(),n=this.ctx.createGain();i.frequency.setValueAtTime(t,e),i.frequency.exponentialRampToValueAtTime(20,e+.12),n.gain.setValueAtTime(.5,e),n.gain.exponentialRampToValueAtTime(.001,e+.25),i.connect(n),n.connect(this.masterGain),i.start(e),i.stop(e+.3),this.nodes.push(i,n)}_snare(e,t){if(!this.ctx)return;const i=Math.floor(this.ctx.sampleRate*.18),n=this.ctx.createBuffer(1,i,this.ctx.sampleRate),s=n.getChannelData(0);for(let c=0;c<i;c++)s[c]=Math.random()*2-1;const r=this.ctx.createBufferSource();r.buffer=n;const a=this.ctx.createBiquadFilter();a.type="bandpass",a.frequency.value=1800,a.Q.value=.8;const l=this.ctx.createGain();l.gain.setValueAtTime(t,e),l.gain.exponentialRampToValueAtTime(.001,e+.18),r.connect(a),a.connect(l),l.connect(this.masterGain),r.start(e),r.stop(e+.2),this.nodes.push(r,l)}_hihat(e,t){if(!this.ctx)return;const i=Math.floor(this.ctx.sampleRate*.06),n=this.ctx.createBuffer(1,i,this.ctx.sampleRate),s=n.getChannelData(0);for(let c=0;c<i;c++)s[c]=Math.random()*2-1;const r=this.ctx.createBufferSource();r.buffer=n;const a=this.ctx.createBiquadFilter();a.type="highpass",a.frequency.value=7e3;const l=this.ctx.createGain();l.gain.setValueAtTime(t,e),l.gain.exponentialRampToValueAtTime(.001,e+.06),r.connect(a),a.connect(l),l.connect(this.masterGain),r.start(e),r.stop(e+.08),this.nodes.push(r,l)}_bass(e,t,i){if(!this.ctx)return;const n=this.ctx.createOscillator(),s=this.ctx.createBiquadFilter(),r=this.ctx.createGain();n.type="sawtooth",n.frequency.value=t,s.type="lowpass",s.frequency.value=350,r.gain.setValueAtTime(i,e),r.gain.exponentialRampToValueAtTime(.001,e+.35),n.connect(s),s.connect(r),r.connect(this.masterGain),n.start(e),n.stop(e+.4),this.nodes.push(n,r)}_distBass(e,t){if(!this.ctx)return;const i=this.ctx.createOscillator(),n=this.ctx.createWaveShaper(),s=this.ctx.createGain();i.type="sawtooth",i.frequency.value=t;const r=new Float32Array(256);for(let a=0;a<256;a++){const l=a*2/256-1;r[a]=Math.max(-.6,Math.min(.6,l*3))}n.curve=r,s.gain.setValueAtTime(.08,e),s.gain.exponentialRampToValueAtTime(.001,e+.3),i.connect(n),n.connect(s),s.connect(this.masterGain),i.start(e),i.stop(e+.35),this.nodes.push(i,s)}}class bx{constructor(){b(this,"container");b(this,"stationIdx",0);b(this,"on",!1);b(this,"songIdx",0);b(this,"djIdx",0);b(this,"songTimer",0);b(this,"djTimer",0);b(this,"nameEl");b(this,"songEl");b(this,"djEl");b(this,"iconEl");b(this,"freqEl");b(this,"engine",new _x);b(this,"engineReady",!1);b(this,"volumeSlider");b(this,"rafId",0);b(this,"lastUpdateTs",0);b(this,"_volOpen",!1);this._buildUI(),this.lastUpdateTs=performance.now(),this._tick()}_buildUI(){this.container=document.createElement("div"),this.container.style.cssText=`
    ...
    `,s.addEventListener("click",()=>this._finish(e)),this.overlay.appendChild(this.canvas),this.overlay.appendChild(n),this.overlay.appendChild(t),this.overlay.appendChild(i),this.overlay.appendChild(this.textLayer),this.overlay.appendChild(s),document.body.appendChild(this.overlay),this._genBuildings(),this._startScene(oo[0]);let r=Sx;for(let c=1;c<oo.length;c++){const d=oo[c];this._after(r,()=>this._startScene(d)),r+=d.durationMs??Mx}this._after(r,()=>this._showTitle(e));let a=performance.now();const l=c=>{if(this.done)return;const d=Math.min((c-a)/1e3,.05);a=c,this.sceneT+=d,this._update(d),this._draw(),this.rafId=requestAnimationFrame(l)};this.rafId=requestAnimationFrame(l)}_startScene(e){this.done||(this.currentScene=e,this.sceneT=0,this.panX=0,this.particles=[],this.camShake=e.id==="matt"||e.id==="jose"?.5:0,this._updateText(e))}_updateText(e){if(!this.textLayer)return;const t=e.id==="melbourne";this.textLayer.innerHTML=`
    ...
    `,t.addEventListener("click",()=>this._finish(e));const i=document.createElement("div");i.id="credits-scroller",i.style.cssText=`
      ...
      padding:0 32px;
      box-sizing:border-box;
    `;let n=0;Cx.forEach(u=>{const h=document.createElement("div"),f=u.size||14;h.textContent=u.text,h.style.cssText=`
    ...
    `,document.head.appendChild(e)}}const Px="./",Ix=`${Px}tem-logo-white.jpg`;class Dx{constructor(){b(this,"overlay");b(this,"scrollTimer",0);b(this,"ctx",null);b(this,"masterGain",null);b(this,"themeAudio",null)}show(e){return new Promise(t=>{this._build(t,e)})}_build(e,t){this._injectStyles(),this.overlay=document.createElement("div"),this.overlay.id="start-menu",this.overlay.style.cssText=`
      ...
      font-family: system-ui, -apple-system, sans-serif;
      overflow:hidden;
    `;const i=document.createElement("div");i.className="sm-lyrics-back";const n=document.createElement("div");n.id="sm-lyrics-inner";const s=[..._c,..._c];s.forEach(h=>{const f=document.createElement("div");f.className="sm-lyric-line",f.textContent=h,n.appendChild(f)}),i.appendChild(n),this.overlay.appendChild(i);const r=document.createElement("div");r.className="sm-gradient",this.overlay.appendChild(r);const a=document.createElement("div");a.className="sm-content",a.innerHTML=`
      <img src="${Ix}" alt="Troweled Earth" class="sm-logo-img"
    ...
    `,document.head.appendChild(e)}}class Lx{constructor(e,t,i){b(this,"btn");b(this,"panel");b(this,"radioSlot");b(this,"moneySlot");b(this,"_open",!1);this._build(e,t,i)}_build(e,t,i){this.btn=document.createElement("button"),this.btn.textContent="☰",this.btn.style.cssText=`
    ...
    `,g.textContent="🚐 ROLL OUT",g.disabled=!0,h.appendChild(f),h.appendChild(g),n.appendChild(h),g.addEventListener("click",()=>{const x=[...this._selected].filter(m=>m!=="jose");Bx(x),this.hide(),i([...this._selected])}),document.body.appendChild(n),this._el=n}hide(){var e;(e=this._el)==null||e.remove(),this._el=null}_makeCard(e,t,i){const n=document.createElement("div");n.dataset.id=e.id,n.style.cssText=`
    ...
    `,document.head.appendChild(e)}}class Yx{constructor(){b(this,"_el",null);b(this,"_timer",null)}show(e,t,i){this.hide();const n=document.createElement("div");n.id="battle-screen-ov",n.style.cssText=`
    ...
    `,e.innerHTML=`THEY WON THE CONTRACT 😤<br>
      <span style="font-size:0.5em;color:#ffaaaa;letter-spacing:1px;">Better luck next time, mate.</span>`,!document.getElementById("cw-flash-style")){const t=document.createElement("style");t.id="cw-flash-style",t.textContent="@keyframes cw-flash-in{from{opacity:0;transform:scale(0.8)}to{opacity:1;transform:scale(1)}}",document.head.appendChild(t)}document.body.appendChild(e),setTimeout(()=>{e.remove(),this.end()},2e3)}}const Mc=[{id:"perth_plasterers",name:"Perth Plasterers",tagline:"They drove 3000km just to lose.",color:"#FF4444",difficulty:.45,speed:.55,members:[{name:"Barry",skinTone:"#D4B090",hairColor:"#444444",hairStyle:"buzz",accentColor:"#FF4444"},{name:"Dazza",skinTone:"#E8C8A0",hairColor:"#8B4513",hairStyle:"short",accentColor:"#FF4444"},{name:"Shazza",skinTone:"#FDDBB4",hairColor:"#C4832A",hairStyle:"long",accentColor:"#FF4444"}]},{id:"sydney_stucco",name:"Sydney Stucco",tagline:"Fancy tools, slow hands.",color:"#4488FF",difficulty:.6,speed:.65,members:[{name:"Blake",skinTone:"#E0B090",hairColor:"#1a0e00",hairStyle:"slicked",accentColor:"#4488FF"},{name:"Jaxon",skinTone:"#D4A070",hairColor:"#2a1800",hairStyle:"bun",accentColor:"#4488FF"},{name:"Tiffany",skinTone:"#F5DEB3",hairColor:"#C8A060",hairStyle:"ponytail",accentColor:"#4488FF"}]},{id:"brisbane_brushmen",name:"Brisbane Brushmen",tagline:"Rough as guts, twice as slow.",color:"#FF8C00",difficulty:.35,speed:.42,members:[{name:"Cobber",skinTone:"#D4A060",hairColor:"#888888",hairStyle:"bald",accentColor:"#FF8C00"},{name:"Mozzie",skinTone:"#C89050",hairColor:"#2a1000",hairStyle:"afro",accentColor:"#FF8C00"},{name:"Bazza",skinTone:"#E0C090",hairColor:"#5a3010",hairStyle:"short",accentColor:"#FF8C00"}]},{id:"melbourne_mafia",name:"Melbourne Mafia",tagline:"They know this city. So does Jose.",color:"#9B59B6",difficulty:.8,speed:.82,members:[{name:"Dante",skinTone:"#B07040",hairColor:"#1a0e00",hairStyle:"slick",accentColor:"#9B59B6"},{name:"Viktor",skinTone:"#C08060",hairColor:"#333333",hairStyle:"buzz",accentColor:"#9B59B6"},{name:"Rosa",skinTone:"#E8C0A0",hairColor:"#4a2010",hairStyle:"long",accentColor:"#9B59B6"}]}];function $x(){return Mc[Math.floor(Math.random()*Mc.length)]}const Jx={Matt:`Matt folds himself into the back. "Took your time." He's already on his phone.`,Jose:'Jose appears from nowhere, bucket in hand. "Vámonos — I was getting bored."',Jarrad:`Jarrad adjusts his hard hat. "I've been standing here fifteen minutes." He has.`,Phil:`Phil sips the last of his tea, unhurried. "Right then. Let's go." He fastens his seatbelt twice.`,Tsuyoshi:"Tsuyoshi vaults in without opening the door. His mohawk grazes the roof lining.",Fabio:`Fabio loads in, trowel over his shoulder. "You're late. Ehhhh —" he waves it off. "I found a pizza place nearby. Very acceptable."`};async function Kx(){await mg();const o=await new Ex().play();await new Dx().show(o);const e=new xg;await e.init();const t=new wg(e.scene);t.spawnCrewAtCityPositions();const i=new Gg,n=new Mg(e.scene),s=new Hg,r=new $g,a=new vx,l=new Mo,c=new Rg(n,i,de=>{l.activePhase>=2&&s.triggerBump(de)},e.collisionWorld,()=>{l.activePhase>=2&&s.triggerCrash()}),d=new ha(e.scene),u=new fa,h=new Yx,f=new jx,g=new qg(de=>{g.hide(),u.show(de.title,de.pay,W=>{const Z=Math.round(de.pay*Fx()),ye=Ux(),ae=()=>{a.show(`📋 ${de.title}`,`Client: ${de.client}

${de.description}

💰 Pay: ${Z.toLocaleString()} sats${Z!==de.pay?" ✦ crew bonus!":""}

🏭 Head to the TEM workshop to collect supplies.`,()=>{if(de.pay=Z,l.acceptJob(de),d.setTarget(Mo.WORKSHOP_POS),r.setActiveJob(de,1),r.updateCrewStatus([],[],!1),V=0,kx())re=1/0,le=1/0;else{const ne=20+Math.random()*60+ye,pe=ne+20+Math.random()*50;Math.random()>.5?(re=ne,le=pe):(le=ne,re=pe)}he=null,Le=null},Ji(yx))};de.isContested?J.show(ne=>{const pe=$x();z=de.title,h.show(bc(),pe,()=>{f.start(pe),ae()}),setTimeout(()=>h.injectLeaderboard(de.title),50)}):ae()})});s.onSpill=de=>{l.money=Math.max(0,l.money-de),r.updateMoney(l.money),r.showSpillPenalty(de)};const x=new fx(e.scene),m=new ua(e.scene),p=new px,w=new nn(e.scene),T=new ms(e.scene),v=new xx,R=new D(nn.POS.x,6,nn.POS.z),A=new rx,C=new cx,I=new Ms,S=new qx,_=new bx,P=new Lx(()=>C.show(),()=>{if(g.isVisible())g.hide();else{const de=[...l.getAvailableJobs(),...l.getContestedJobs()];g.show(de)}},()=>S.show(de=>{de>0&&(l.money+=de*1e3,r.updateMoney(l.money),r.showToast(`🎨 Formula cracked! +${(de*1e3).toLocaleString()} sats`,4513160))}));P.mountMoneyPanel(r.getMoneyPanel()),P.mountRadio(_.getEl());let N=!1,z="",X=0;const J=new Hx,Y={x:-60,z:-100},te={x:100,z:60};let V=0,re=-1,le=-1,he=null,Le=null;e.onUpdate(de=>{const W=n.mesh.position.x,Z=n.mesh.position.z;if(a.isActive){(i.forward||i.brake)&&a.tryResume(),t.updateAll(de),w.update(de,W,Z,v),T.update(de,W,Z,v),e.camera.follow(n.mesh.position,n.velocity,n.heading);{const ne=R.clone().project(e.camera.camera),pe=(ne.x*.5+.5)*window.innerWidth,De=(-ne.y*.5+.5)*window.innerHeight;v.setScreenPosition(pe,De)}return}c.update(de),n.updateSuspension(de),f.isActive()&&f.update(de);const ye=l.activeJob!==null&&l.activePhase>=2;if(s.setVisible(ye),ye?s.update(de):s.level=0,t.updateAll(de),m.update(de),m.tryVisit(W,Z)&&he!=="coffee"&&(s.level=Math.max(0,s.level-.6),p.drinkCoffee(),p.isUrgent?r.showToast("☕ Coffeed up — now find a toilet, fast!",13918762):r.showToast("☕ Coffee hit! Plaster steady, bladder loading...",13918762)),p.update(de,l.activeJob?c.speed:0),p.tryRelief(W,Z)&&he!=="toilet"&&r.showToast("🚽 Ahhh! Relief! Ready for the next coffee ☕",2201331),p.isUrgent&&l.activeJob){const ne=Date.now();ne-p.lastUrgentToast>15e3&&(p.lastUrgentToast=ne,r.showToast("🚽 Bursting! Find the toilet before you spill!",16733986))}s.spillRateMultiplier=p.spillMultiplier,w.update(de,W,Z,v)&&R.set(nn.POS.x,6,nn.POS.z),T.update(de,W,Z,v)&&R.set(ms.POS.x,6,ms.POS.z);const ae=t.checkProximityDialogue(W,Z);ae&&(R.set(ae.pos.x,6,ae.pos.z),v.show(zi[ae.name],ae.line));{const ne=R.clone().project(e.camera.camera),pe=(ne.x*.5+.5)*window.innerWidth,De=(-ne.y*.5+.5)*window.innerHeight;v.setScreenPosition(pe,De)}if(x.update(de,W,Z),d.update(de,W,Z),l.activeJob){const ne=l.tickTravel(de);r.updateTravelTimer(l.travelTimer),ne!=null&&ne.failed&&(s.level=0,he=null,Le=null,re=-1,le=-1,d.setTarget(null),r.updateTravelTimer(null),r.showTimerFail(15e4),r.setActiveJob(null,1),r.updateMoney(l.money),r.updateCrewStatus([],[],!1),t.showAllCrew(),setTimeout(()=>{f.end();const pe=[...l.getAvailableJobs(),...l.getContestedJobs()];g.show(pe)},3500))}else r.updateTravelTimer(null);if(l.activeJob!==null)if(l.activePhase===1)r.updateJobDistance(l.distanceToWorkshop(W,Z));else if(l.activePhase===2){const ne=l.nextCrewNeeded();if(ne){const pe=t.getCrewPosition(ne);r.updateJobDistance(l.distanceToPoint(W,Z,pe.x,pe.z))}}else r.updateJobDistance(l.distanceTo(W,Z));if(l.activeJob&&!he&&!N&&(V+=de,re>0&&V>=re?(re=-1,he="coffee",Le=d.currentTarget,d.setTarget(Y),r.showToast("☕ Gagging for a coffee — hit the cafe NOW!",13918762)):le>0&&V>=le&&(le=-1,he="toilet",p.level=.88,p.isUrgent=!0,Le=d.currentTarget,d.setTarget(te),r.showToast("🚽 Bursting! Find the toilet before you ruin the plastering!",16733986))),l.activeJob&&he&&!N){const ne=he==="coffee"?Y:te,pe=W-ne.x,De=Z-ne.z;if(Math.sqrt(pe*pe+De*De)<14){N=!0;const qe=he;he=null;const Oe=Le;Le=null,qe==="coffee"?(p.drinkCoffee(),a.show("☕ Coffee Break!",`You grab a flat white. The barista nods — they know the order.

Bladder's loading... don't take too long.

Back on the road.`,()=>{d.setTarget(Oe),N=!1},Ji(xr))):(p.level=0,p.isUrgent=!1,p.caffeinated=!1,a.show("🚽 Phew — Crisis Averted!",`Barely made it. Not a word to the crew.

Back on the road.`,()=>{d.setTarget(Oe),N=!1},Ji(xr)))}}if(l.activeJob&&l.activePhase===1&&!he&&!N&&l.checkPhase1Arrival(W,Z)){N=!0,s.level=0,T.playLaugh();const ne=l.crewToPickup.join(" + ");a.show("📦 Supplies Loaded!",`Connie's cackle echoes through the factory as the buckets go in.

Now go pick up the crew:
👷 ${ne}

They're scattered around the city. Your waypoint will guide you.`,()=>{l.advanceToPhase2();const pe=l.nextCrewNeeded();if(pe){const De=t.getCrewPosition(pe);d.setTarget(De)}r.showPhase1Complete(),r.setActiveJob(l.activeJob,2),r.updateCrewStatus(l.crewToPickup,l.crewPickedUp,!0),N=!1},Ji(gr))}if(l.activeJob&&l.activePhase===2&&!he&&!N)for(const ne of l.crewToPickup){if(l.crewPickedUp.includes(ne))continue;const pe=t.getCrewPosition(ne);if(l.distanceToPoint(W,Z,pe.x,pe.z)<10){N=!0,t.hideCrew(ne);const qe=l.pickupCrew(ne);r.updateCrewStatus(l.crewToPickup,l.crewPickedUp,!0);const Oe=Jx[ne]??`${ne} hops in.`;if(qe)a.show(`🚐 ${ne} aboard — Full crew!`,`${Oe}

Full crew loaded. Everyone's in (sort of).

Head to the job site now. Your waypoint is set.`,()=>{l.advanceToPhase3(),d.setTarget(l.activeJob.position),r.showCrewPickup(ne,null),r.setActiveJob(l.activeJob,3),N=!1},Ji(gr));else{const rt=l.nextCrewNeeded(),F=l.crewToPickup.filter(mt=>!l.crewPickedUp.includes(mt)).join(", ");a.show(`🧑‍🔧 ${ne} aboard!`,`${Oe}

Still need to collect:
👷 ${F}`,()=>{if(rt){const mt=t.getCrewPosition(rt);d.setTarget(mt),r.showCrewPickup(ne,rt)}r.updateCrewStatus(l.crewToPickup,l.crewPickedUp,!0),N=!1},Ji(xr))}break}}if(l.activeJob&&l.activePhase===3&&!he&&!N&&!A.isActive()){const ne=l.checkArrival(W,Z);ne!==null&&(N=!0,d.setTarget(null),a.show(`🏗️ ${ne.title}`,`${ne.client} is waiting.

${ne.description}

Time to get to work. Show them what TEM does.`,()=>{r.setActiveJob(null,3),r.updateCrewStatus([],[],!1),_.setVisible(!1),X=Date.now(),A.startRandom(pe=>{if(_.setVisible(!0),f.isActive()){f.setPlayerProgress(1),f.end();const qe=(Date.now()-X)/1e3;Nx({player_name:Sd()??"TEM Crew",job_title:z.replace(/^⚔️\s*/,"").trim(),crew_ids:bc(),completion_time_s:Math.round(qe),payout:Math.max(0,ne.pay)})}const De=l.completeJob(ne,pe.qualityPct);De<0?r.showPenalty(ne.title,Math.abs(De)):r.showJobComplete(ne.title,De),r.updateMoney(l.money),t.showAllCrew(),he=null,Le=null,re=-1,le=-1,N=!1,_d()&&!Ms.isUnlocked()?setTimeout(()=>I.trigger(),2e3):setTimeout(()=>{const qe=[...l.getAvailableJobs(),...l.getContestedJobs()];qe.length>0&&g.show(qe)},3500)})},Ji(gr)))}e.camera.follow(n.mesh.position,n.velocity,n.heading),r.update(c.speed,s.level)}),setTimeout(()=>{const de=[...l.getAvailableJobs(),...l.getContestedJobs()];g.show(de)},1e3),e.start()}Kx().catch(o=>{console.error("Game init failed:",o),document.body.style.background="#000";const e=document.createElement("div");e.style.cssText=`
...
//# sourceMappingURL=index-472ecgSa.js.map
