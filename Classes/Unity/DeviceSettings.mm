...
UNITY_EXPORT extern "C" int UnityDeviceHasCutout()
{
    switch (UnityDeviceGeneration())
    {
        ...
        case deviceiPhone17: case deviceiPhoneAir:    case deviceiPhone17Pro: case deviceiPhone17ProMax: case deviceiPhone17e:
            return 1;
        default:
            return 0;
    }
...
{
    if (strncmp(UnityDeviceModel(), "iPad", 4) != 0)
        return 0;
