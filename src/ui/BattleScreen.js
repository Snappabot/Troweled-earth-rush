...
export class BattleScreen {
    ...
    _makeCrewPanel(label, crewIds, color, _isRival) {
    ...
    // ── Rival hair drawing ─────────────────────────────────────────────────────
    _drawRivalHair(ctx, style, color, cx, hy, hr, size) {
        ctx.fillStyle = color;
