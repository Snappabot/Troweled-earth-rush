...
export class GameMenu {
    ...
    moneySlot;
    _open = false;
    constructor(onPhoto, onJobs, onMixer) {
        this._build(onPhoto, onJobs, onMixer);
    }
    _build(onPhoto, onJobs, onMixer) {
    ...
    `;
      ...
      `;
        ...
        document.addEventListener('pointerdown', (e) => {
            if (this._open && !this.panel.contains(e.target) && e.target !== this.btn) {
                this._close();
            }
        }, { passive: true });
    }
