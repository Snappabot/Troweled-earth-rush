...
const CREW_DIALOGUE: Record<string, string[]> = {
  ...
  Jarrad: [
    ...
    "Jose has a whole spiritual identity built around being mysterious. He's from Footscray.",
    ...
    "Jose lights a cigar every time he has a feeling. That man is constantly having feelings.",
