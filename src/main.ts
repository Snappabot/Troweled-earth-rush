...
async function main() {
  ...
  exitVanBtn.style.cssText = `position:fixed;top:10px;left:10px;z-index:5000;padding:8px 14px;background:rgba(0,0,0,0.85);color:#FFD700;border:2px solid #FFD700;border-radius:8px;font-size:13px;font-weight:700;letter-spacing:1px;cursor:pointer;touch-action:manipulation;`;
  ...
  getInVanBtn.style.cssText = `position:fixed;top:10px;left:10px;z-index:5000;padding:8px 14px;background:rgba(0,0,0,0.85);color:#E8A830;border:2px solid #E8A830;border-radius:8px;font-size:13px;font-weight:700;letter-spacing:1px;cursor:pointer;touch-action:manipulation;display:none;`;
